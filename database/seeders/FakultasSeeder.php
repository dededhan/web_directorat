...
class FakultasSeeder extends Seeder
{
    public function run()
    {
        ...
        $fakultasData = [
            ...
            ['id' => 4, 'name' => 'Fakultas Ilmu Sosial dan Hukum', 'abbreviation' => 'FIS', 'created_at' => $now, 'updated_at' => $now],
            ...
            ['id' => 7, 'name' => 'Fakultas Ekonomi dan Bisnis', 'abbreviation' => 'FE', 'created_at' => $now, 'updated_at' => $now],
            ['id' => 8, 'name' => 'Fakultas Psikologi', 'abbreviation' => 'FPPsi', 'created_at' => $now, 'updated_at' => $now],
