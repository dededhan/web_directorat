...
Route::prefix('subdirektorat-inovasi')->name('subdirektorat-inovasi.')->group(function () {
    ...
    Route::view('/innovation-challange', 'subdirektorat-inovasi.proposal_hub.index')->name('innovation_challange.index');
...
// Redirect old typo URLs to correct spelling
Route::redirect('/subdirektorat-inovasi/inovation-chalangge', '/subdirektorat-inovasi/innovation-challange', 301);
Route::redirect('/subdirektorat-inovasi/inovation-challenge', '/subdirektorat-inovasi/innovation-challange', 301);
