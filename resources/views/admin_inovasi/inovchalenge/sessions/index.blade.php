    ...
    <div class="bg-gradient-to-br from-gray-50 to-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
                ...
                <a href="{{ route('admin_inovasi.inovchalenge.sessions.create') }}"
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100">
                ...
                <div class="bg-gradient-to-r from-teal-500 to-teal-600 px-6 py-4 rounded-t-2xl">
                    <h2 class="text-white font-semibold text-lg">
                        ...
                        <span
                            class="ml-2 bg-white/20 text-white text-sm px-3 py-0.5 rounded-full">{{ $sessions->total() }}</span>
                    </h2>
                </div>
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        @if ($session->deskripsi)
                                            <div class="text-xs text-gray-400 mt-1 line-clamp-1">{{ $session->deskripsi }}
                                            </div>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 text-sm text-gray-500">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center gap-1">
                                            ...
                                            {{-- Hapus --}}
                                            <form method="POST"
                                                action="{{ route('admin_inovasi.inovchalenge.sessions.destroy', $session) }}"
                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-16 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-sm text-gray-400 mt-1">Buat sesi baru untuk memulai Innovation
                                                Challenge</p>
                                            <a href="{{ route('admin_inovasi.inovchalenge.sessions.create') }}"
                    ...
                    @forelse ($sessions as $session)
                        <div class="p-4 hover:bg-gray-50">
                            <div class="flex items-start justify-between">
                                ...
                                @if ($session->status === 'active')
                                    <span
                                        class="px-2 py-0.5 text-xs font-semibold rounded-full bg-green-100 text-green-800">Active</span>
                                @elseif($session->status === 'closed')
                                    <span
                                        class="px-2 py-0.5 text-xs font-semibold rounded-full bg-red-100 text-red-800">Closed</span>
                                @else
                                    <span
                                        class="px-2 py-0.5 text-xs font-semibold rounded-full bg-yellow-100 text-yellow-800">Draft</span>
                                @endif
                            </div>
