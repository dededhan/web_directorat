        ...
        <div class="flex flex-wrap gap-3 items-center justify-between">
            ...
            <div class="flex gap-3">
                ...
                @if(in_array($katsinov->status, ['draft', 'submitted', 'assigned']))
                    <div class="relative">
                        ...
                        <div id="formMenu" class="hidden absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-xl z-50 py-2">
                            <a href="{{ route('admin_inovasi.katsinov-v2.form-inovasi', $katsinov->id) }}" 
                               class="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-50 transition">
                                📝 Form Judul Inovasi
                            </a>
                            <a href="{{ route('admin_inovasi.katsinov-v2.form-lampiran', $katsinov->id) }}" 
                               class="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-50 transition">
                                📎 Form Lampiran
                            </a>
                            <a href="{{ route('admin_inovasi.katsinov-v2.form-informasi-dasar', $katsinov->id) }}" 
                               class="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-50 transition">
                                📋 Form Informasi Dasar
                            </a>
                            <a href="{{ route('admin_inovasi.katsinov-v2.form-berita-acara', $katsinov->id) }}" 
                               class="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-50 transition">
                                📄 Form Berita Acara
                            </a>
                            <a href="{{ route('admin_inovasi.katsinov-v2.form-record-hasil', $katsinov->id) }}" 
                               class="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-50 transition">
                                📊 Form Record Hasil
                            </a>
                        </div>
                ...
                @if(in_array($katsinov->status, ['submitted', 'assigned', 'in_review', 'completed']))
                    <a href="{{ route('admin_inovasi.katsinov-v2.print', $katsinov->id) }}" 
                       target="_blank"
    ...
    <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg shadow-lg p-8 mb-6 border border-blue-200">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3">
                ...
                @endif
                <a href="{{ route('admin_inovasi.katsinov-v2.summary', $katsinov->id) }}" 
