                        ...
                        <tr class="hover:bg-gray-50 transition duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center gap-2">
                                    ...
                                    {{-- Laporan Validator button (Admin_Inovasi only, completed status) --}}
                                    @if(Auth::user()->role === 'admin_inovasi' && $katsinov->status === 'completed')
                                        <a href="{{ route('admin_inovasi.katsinov-v2.validator-report', $katsinov->id) }}" 
                                           class="text-purple-600 hover:text-purple-900" title="Laporan Validator">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/>
                                            </svg>
                                        </a>
                                        <a href="{{ route('admin_inovasi.katsinov-v2.validator-summary', $katsinov->id) }}" 
                                           class="text-blue-600 hover:text-blue-900" title="Summary Validator">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    @if($katsinov->status === 'completed')
                                        ...
                                        <a href="{{ route('admin_inovasi.katsinov-v2.download-report', $katsinov->id) }}" 
