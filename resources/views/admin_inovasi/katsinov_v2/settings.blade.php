...
<div class="p-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route($routeUpdate ?? 'admin_inovasi.katsinov-v2.settings.update') }}" method="POST">
            @csrf
            @method('PUT')
            ...
            @php
                $routeUpdate = (Auth::user()->role === 'admin_inovasi') 
                    ? 'admin_inovasi.katsinov-v2.settings.update' 
                    : 'admin.katsinov-v2.settings.update';
                $routeIndex = (Auth::user()->role === 'admin_inovasi') 
                    ? 'admin_inovasi.katsinov-v2.index' 
            ...
            <div class="mt-8 pt-6 border-t border-gray-200">
                ...
                <div class="flex items-center justify-between">
                    <a href="{{ route($routeIndex ?? 'admin_inovasi.katsinov-v2.index') }}" 
