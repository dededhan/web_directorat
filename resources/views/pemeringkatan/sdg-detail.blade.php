        ...
        <section class="sdg-header py-8 bg-white">
            <div class="container mx-auto px-6">
                ...
                <div class="flex justify-center gap-2 mb-8 flex-wrap">
                    @for ($i = 1; $i <= 17; $i++)
                        <a href="{{ route('the-ir.sdg.show', $i) }}" class="transform hover:scale-110 transition-transform">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex gap-3 mb-6">
                            @foreach ($years as $year)
                                <a href="{{ route('the-ir.sdg.show', ['id' => $sdg->number, 'year' => $year]) }}" 
                    ...
                    @else
                        <div class="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                            ...
                            @if($selectedYear)
                                ...
                                <a href="{{ route('the-ir.sdg.show', $sdg->number) }}" class="text-blue-600 hover:text-blue-800">
