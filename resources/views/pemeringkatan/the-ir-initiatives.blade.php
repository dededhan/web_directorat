        ...
        <section class="py-16 bg-white">
            <div class="container mx-auto px-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                    <a href="{{ route('the-ir.sdg.show', 1) }}" class="transform hover:scale-105 active:scale-95 transition-transform duration-300 cursor-pointer">
                        <img src="{{ asset('images/sdgs/sdg-01.jpg') }}" alt="SDG 1 - No Poverty" class="w-full shadow-md hover:shadow-xl rounded-lg">
                    </a>
                    <a href="{{ route('the-ir.sdg.show', 2) }}" class="transform hover:scale-105 active:scale-95 transition-transform duration-300 cursor-pointer">
                        <img src="{{ asset('images/sdgs/sdg-02.jpg') }}" alt="SDG 2 - Zero Hunger" class="w-full shadow-md hover:shadow-xl rounded-lg">
                    </a>
                    <a href="{{ route('the-ir.sdg.show', 3) }}" class="transform hover:scale-105 active:scale-95 transition-transform duration-300 cursor-pointer">
                    ...
                    <a href="{{ route('the-ir.sdg.show', 4) }}" class="transform hover:scale-105 active:scale-95 transition-transform duration-300 cursor-pointer">
                        <img src="{{ asset('images/sdgs/sdg-04.jpg') }}" alt="SDG 4 - Quality Education" class="w-full shadow-md hover:shadow-xl rounded-lg">
                    </a>
                    <a href="{{ route('the-ir.sdg.show', 5) }}" class="transform hover:scale-105 active:scale-95 transition-transform duration-300 cursor-pointer">
                        <img src="{{ asset('images/sdgs/sdg-05.jpg') }}" alt="SDG 5 - Gender Equality" class="w-full shadow-md hover:shadow-xl rounded-lg">
                    </a>
                    <a href="{{ route('the-ir.sdg.show', 6) }}" class="transform hover:scale-105 active:scale-95 transition-transform duration-300 cursor-pointer">
                    ...
                    <a href="{{ route('the-ir.sdg.show', 7) }}" class="transform hover:scale-105 active:scale-95 transition-transform duration-300 cursor-pointer">
                    ...
                    <a href="{{ route('the-ir.sdg.show', 8) }}" class="transform hover:scale-105 active:scale-95 transition-transform duration-300 cursor-pointer">
                    ...
                    <a href="{{ route('the-ir.sdg.show', 9) }}" class="transform hover:scale-105 active:scale-95 transition-transform duration-300 cursor-pointer">
                    ...
                    <a href="{{ route('the-ir.sdg.show', 10) }}" class="transform hover:scale-105 active:scale-95 transition-transform duration-300 cursor-pointer">
                        <img src="{{ asset('images/sdgs/sdg-10.jpg') }}" alt="SDG 10 - Reduced Inequalities" class="w-full shadow-md hover:shadow-xl rounded-lg">
                    </a>
                    <a href="{{ route('the-ir.sdg.show', 11) }}" class="transform hover:scale-105 active:scale-95 transition-transform duration-300 cursor-pointer">
                    ...
                    <a href="{{ route('the-ir.sdg.show', 12) }}" class="transform hover:scale-105 active:scale-95 transition-transform duration-300 cursor-pointer">
                    ...
                    <a href="{{ route('the-ir.sdg.show', 13) }}" class="transform hover:scale-105 active:scale-95 transition-transform duration-300 cursor-pointer">
                        <img src="{{ asset('images/sdgs/sdg-13.jpg') }}" alt="SDG 13 - Climate Action" class="w-full shadow-md hover:shadow-xl rounded-lg">
                    </a>
                    <a href="{{ route('the-ir.sdg.show', 14) }}" class="transform hover:scale-105 active:scale-95 transition-transform duration-300 cursor-pointer">
                        <img src="{{ asset('images/sdgs/sdg-14.jpg') }}" alt="SDG 14 - Life Below Water" class="w-full shadow-md hover:shadow-xl rounded-lg">
                    </a>
                    <a href="{{ route('the-ir.sdg.show', 15) }}" class="transform hover:scale-105 active:scale-95 transition-transform duration-300 cursor-pointer">
                        <img src="{{ asset('images/sdgs/sdg-15.jpg') }}" alt="SDG 15 - Life on Land" class="w-full shadow-md hover:shadow-xl rounded-lg">
                    </a>
                    <a href="{{ route('the-ir.sdg.show', 16) }}" class="transform hover:scale-105 active:scale-95 transition-transform duration-300 cursor-pointer">
                    ...
                    <a href="{{ route('the-ir.sdg.show', 17) }}" class="transform hover:scale-105 active:scale-95 transition-transform duration-300 cursor-pointer">
