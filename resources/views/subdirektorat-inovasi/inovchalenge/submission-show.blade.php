...
<head>
    ...
    <title>Detail Submission | Innovation Challenge</title>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div>
                ...
                <div class="flex items-center gap-2 mt-1">
                    ...
                    <span
                        ...
                        <i class="fas fa-eye mr-1 text-[8px]"></i> Read-Only ({{ $roleLabel }})
                    </span>
                </div>
            </div>
        ...
        <div class="mb-6 p-4 bg-indigo-50 border border-indigo-200 rounded-xl flex items-center gap-3 text-indigo-700">
            ...
            <div>
                ...
                <p class="text-xs mt-0.5 text-indigo-600">Anda tergabung sebagai anggota tim ({{ $roleLabel }}). Anda
                    dapat melihat semua data tetapi tidak dapat mengedit atau mengisi formulir tahapan.</p>
            </div>
        </div>
                    ...
                    <div class="p-5 space-y-3">
                        ...
                        <div class="pt-2">
                            @if ($st->status !== 'belum_diisi')
                                <a href="{{ route('inovchalenge.role.submissions.tahap', [$submission, $tahap->id]) }}"
