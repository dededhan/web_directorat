    ...
    <div class="mx-auto max-w-7xl px-5 py-10 sm:px-8 lg:px-12 lg:py-16">
            ...
            <div class="grid gap-10 lg:grid-cols-[1.25fr_.75fr] lg:items-end">
                <div>
                    ...
                    <div class="mt-8 flex flex-col gap-3 sm:flex-row">
                        ...
                        @if(auth()->check())
                            <a href="{{ route('hackaton.dashboard') }}" class="inline-flex min-h-12 items-center justify-center border-2 border-gray-950 bg-white px-6 py-3 text-base font-black text-gray-950 hover:bg-gray-100">Buka dashboard</a>
                        @else
                            <button type="button" class="login inline-flex min-h-12 items-center justify-center border-2 border-gray-950 bg-white px-6 py-3 text-base font-black text-gray-950 hover:bg-gray-100 cursor-pointer">Masuk peserta</button>
                        @endif
                    </div>
                </div>
        ...
        <section id="tentang" class="scroll-mt-8 border-b-2 border-gray-950 py-12 lg:py-16">
            <div class="grid gap-8 lg:grid-cols-[.7fr_1.3fr]">
                <h2 class="text-4xl font-black leading-tight text-gray-950">Tentang Hackathon DeepTech</h2>
                <div>
                    <p class="text-lg leading-relaxed text-gray-700">Hackathon DeepTech UNJ merupakan wadah bagi civitas akademika dan mitra untuk berkolaborasi, merumuskan masalah, serta mengembangkan prototipe solusi berbasis inovasi. Peserta akan mengikuti rangkaian kegiatan sesuai ketentuan event yang dibuka oleh Direktorat Inovasi dan Hilirisasi.</p>
