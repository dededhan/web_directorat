...
@section('content')
    ...
    <div class="table-data">
        <div class="order">
            ...
            <form id="form-informasi-dasar" action="{{ route('subdirektorat-inovasi.dosen.katsinov-v2.form-informasi-dasar.store', $katsinov->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="subsection mb-4">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="tel" class="form-control" name="fax" value="{{ !is_null($informasi)? $informasi->fax : '' }}">
                                </div>
                            </div>
                        </div>
