...
<div class="container-fluid p-6">
            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('subdirektorat-inovasi.dosen.katsinov-v2.index') }}">KATSINOV V2</a></li>
                        <li class="breadcrumb-item active">Summary</li>
                    </ol>
                </nav>
            </div>
            <div>
                <a href="{{ route('subdirektorat-inovasi.dosen.katsinov-v2.show', $katsinov->id) }}" class="btn btn-secondary">
    ...
    <div class="card mb-4 shadow-sm">
        <div class="card-body text-center">
            <a href="{{ route('subdirektorat-inovasi.dosen.katsinov-v2.show', $katsinov->id) }}" class="btn btn-secondary me-2">
                <i class='bx bx-arrow-back'></i> Back to Detail
            </a>
            
            @if(in_array(Auth::user()->role, ['admin_direktorat', 'admin_inovasi', 'validator']))
                <a href="{{ route('subdirektorat-inovasi.dosen.katsinov-v2.full-report', $katsinov->id) }}" class="btn btn-warning me-2">
                    <i class='bx bx-file-find'></i> Laporan Form Katsinov
                </a>
            @endif
            
            <a href="{{ route('subdirektorat-inovasi.dosen.katsinov-v2.print-summary', $katsinov->id) }}" target="_blank" class="btn btn-info me-2">
                <i class='bx bx-printer'></i> Print Summary
            </a>
            @if($katsinov->status === 'completed')
                <a href="{{ route('subdirektorat-inovasi.dosen.katsinov-v2.certificate', $katsinov->id) }}" target="_blank" class="btn btn-success">
