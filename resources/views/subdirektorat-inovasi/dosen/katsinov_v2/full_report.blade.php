...
<div class="container-fluid p-6">
            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('subdirektorat-inovasi.dosen.katsinov-v2.show', $katsinov->id) }}">Detail</a></li>
                            ...
                            <table class="table table-sm table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('subdirektorat-inovasi/dosen/katsinov-v2/' . $katsinov->id . '/lampiran/' . $item->id . '/preview') }}" 
    ...
    <div class="card shadow-sm">
        <div class="card-body text-center">
            ...
            <a href="{{ route('subdirektorat-inovasi.dosen.katsinov-v2.show', $katsinov->id) }}" class="btn btn-secondary btn-lg">
