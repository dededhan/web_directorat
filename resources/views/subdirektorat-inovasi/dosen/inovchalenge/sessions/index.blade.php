            ...
            @empty
                <div class="col-span-full">
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-12 text-center">
                        <div class="w-20 h-20 bg-gradient-to-br from-teal-100 to-teal-200 rounded-2xl flex items-center justify-center mx-auto mb-4">
                            <i class="fas fa-inbox text-3xl text-teal-500"></i>
                        </div>
                        <h3 class="text-lg font-semibold text-gray-700">Belum ada sesi aktif</h3>
                        <p class="text-sm text-gray-400 mt-1">Silakan tunggu admin membuka sesi Innovation Challenge.</p>
                    </div>
                </div>
            @endforelse
        </div>
