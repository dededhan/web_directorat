        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2 mt-1">
                        ...
                        <span
                            ...
                            <i class="fas fa-eye mr-1 text-[8px]"></i> Read-Only (Anggota)
                        </span>
                    </div>
                </div>
            ...
            <div class="mb-6 p-4 bg-indigo-50 border border-indigo-200 rounded-xl flex items-center gap-3 text-indigo-700">
                ...
                <div>
                    ...
                    <p class="text-xs mt-0.5 text-indigo-600">Anda tergabung sebagai anggota tim. Anda dapat melihat semua
                        data tetapi tidak dapat mengedit atau mengisi formulir tahapan.</p>
                </div>
            </div>
            ...
            @else
                <div class="mb-6 p-4 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-500">
                    <i class="fas fa-info-circle mr-1"></i> Identitas Tim belum diisi oleh Ketua.
                </div>
            @endif
                                    ...
                                    <div class="min-w-0">
                                        <p class="text-sm font-medium text-gray-900 truncate">
                                            ...
                                            @if ($member->user_id === auth()->id())
                                                <span class="text-[10px] text-indigo-500 font-bold">(Anda)</span>
                                            @endif
                                        </p>
            ...
            {{-- 3-Tahap Cards (Read-Only – no action buttons to edit/fill) --}}
                ...
                @foreach ($submission->submissionTahap->sortBy(fn($st) => $st->tahap->tahap_ke) as $st)
                    ...
                    <div
                        ...
                        <div class="p-5 space-y-3">
                            ...
                            {{-- Action: always read-only view --}}
                            <div class="pt-2">
                                @if ($st->status !== 'belum_diisi')
                                    <a href="{{ route('subdirektorat-inovasi.dosen.inovchalenge.team.tahap', [$submission, $tahap->id]) }}"
