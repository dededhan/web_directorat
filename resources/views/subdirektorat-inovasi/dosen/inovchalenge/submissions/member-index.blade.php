                            ...
                            <div class="p-4 rounded-xl border-2 border-amber-200 bg-amber-50/50">
                                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                    ...
                                    <div class="flex gap-2 flex-shrink-0">
                                        <form method="POST"
                                            action="{{ route('subdirektorat-inovasi.dosen.inovchalenge.invitations.approve', $membership) }}">
                                            @csrf @method('PATCH')
                                            <button type="submit"
                                        ...
                                        <form method="POST"
                                            action="{{ route('subdirektorat-inovasi.dosen.inovchalenge.invitations.reject', $membership) }}"
