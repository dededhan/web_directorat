        ...
        <header class="mb-10">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="mt-2 text-gray-600 text-base">Semua proposal penelitian & pengabdian yang telah Anda buat atau ajukan.</p>
                </div>
                    ...
                    <div class="border-b border-gray-100 last:border-b-0 p-4 hover:bg-gray-50 transition-colors">
                        ...
                        <div x-data="{ open: false }" class="relative">
                            ...
                            <div x-show="open"
                                ...
                                <div class="py-1">
                                    @if ($submission->status == 'draft')
                                    <a href="{{ route('subdirektorat-inovasi.dosen.equity.proposal.createPengajuan', $submission->id) }}" class="flex items-center w-full px-4 py-3 text-sm text-gray-700 hover:bg-teal-50 hover:text-teal-700 transition-colors">
                                        <i class='bx bx-edit-alt mr-3 text-lg text-teal-600'></i> Lanjutkan Pengisian
                                    </a>
                                    @endif
                                    ...
                                    <a href="{{ route('subdirektorat-inovasi.dosen.equity.proposal.tahapan', $submission->id) }}" class="flex items-center w-full px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                                        <i class='bx bx-line-chart mr-3 text-lg text-purple-500'></i>Tahapan Proposal
                                    </a>
                                    @if ($submission->status == 'draft')
                                    <div class="border-t my-1 border-gray-100"></div>
                ...
                @empty
                    <div class="text-center py-16 px-4">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-gray-500 text-sm mb-6 text-center max-w-xs">Mulailah dengan mengajukan proposal penelitian atau pengabdian baru.</p>
                            <a href="{{ route('subdirektorat-inovasi.dosen.equity.usulkan-proposal.index') }}" class="inline-flex items-center px-4 py-2.5 bg-gradient-to-r from-teal-500 to-teal-600 text-white font-semibold rounded-xl hover:from-teal-600 hover:to-teal-700 transform hover:scale-105 transition-all duration-200 shadow-md hover:shadow-lg">
                                <i class='bx bx-plus-circle mr-2 text-lg'></i>
                                Usulkan Proposal Baru
                            </a>
