...
@section('contentdosen')
    ...
    <div class="table-data">
        <div class="order">
            ...
            <form method="POST" action="{{ route('subdirektorat-inovasi.dosen.lampiran.store', $id) }}"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    @if (isset($lampiran['aspek_teknologi']['proposal']))
                                        <div class="mt-2">
                                            <div
                                                class="alert alert-success d-flex align-items-center justify-content-between py-2">
                                                <div>
                                                    <i class='bx bx-check-circle me-2'></i>
                                                    <strong>File:</strong>
                                                    {{ basename($lampiran['aspek_teknologi']['proposal']->path) }}
                                                </div>
                                                <div>
                                                    <a href="{{ route('subdirektorat-inovasi.dosen.document.view', $lampiran['aspek_teknologi']['proposal']->id) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    @if (isset($lampiran['aspek_teknologi']['jadwal']))
                                        <div class="mt-2">
                                            ...
                                            <a href="{{ route('subdirektorat-inovasi.dosen.document.view', $lampiran['aspek_teknologi']['jadwal']->id) }}"
                                                target="_blank" class="document-preview">
                                                Lihat Dokumen
                                            </a>
            ...
            'test_evaluasi' => 'Hasil test dan evaluasi',
                                            ...
                                            <div class="mt-2">
                                                <div
                                                    ...
                                                    <div>
                                                        <i class='bx bx-check-circle me-2'></i>
                                                        <strong>File:</strong>
                                                        {{ basename($lampiran['aspek_teknologi'][$key]->path) }}
                                                    </div>
                                                    <div>
                                                        <a href="{{ route('subdirektorat-inovasi.dosen.document.view', $lampiran['aspek_teknologi'][$key]->id) }}"
                                                            target="_blank" class="btn btn-sm btn-info me-2">
                                                            <i class='bx bx-show'></i> Lihat
                                                        </a>
                                                        <button type="button" class="btn btn-sm btn-danger"
                        ...
                        <div class="subsection">
                            ...
                            <div class="row">
                                        ...
                                        <div class="mt-2">
                                            <div
                                                ...
                                                <div>
                                                    <i class='bx bx-check-circle me-2'></i>
                                                    <strong>File:</strong>
                                                    {{ basename($lampiran['aspek_teknologi']['dokumen_ilmiah']->path) }}
                                                </div>
                                                <div>
                                                    <a href="{{ route('subdirektorat-inovasi.dosen.document.view', $lampiran['aspek_teknologi']['dokumen_ilmiah']->id) }}"
                                                        target="_blank" class="btn btn-sm btn-info me-2">
                                                        <i class='bx bx-show'></i> Lihat
                                                    </a>
                                                    <button type="button" class="btn btn-sm btn-danger"
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Kekayaan Intelektual: paten, lisensi, desain industri,
                                        dll</label>
                                        ...
                                        <div class="mt-2">
                                            <div
                                                ...
                                                <div>
                                                    <i class='bx bx-check-circle me-2'></i>
                                                    <strong>File:</strong>
                                                    {{ basename($lampiran['aspek_teknologi']['dokumen_haki']->path) }}
                                                </div>
                                                <div>
                                                    <a href="{{ route('subdirektorat-inovasi.dosen.document.view', $lampiran['aspek_teknologi']['dokumen_haki']->id) }}"
                                                        target="_blank" class="btn btn-sm btn-info me-2">
                                                        <i class='bx bx-show'></i> Lihat
                                                    </a>
                                                    <button type="button" class="btn btn-sm btn-danger"
                                        ...
                                        <div class="mt-2">
                                            <div
                                                ...
                                                <div>
                                                    <i class='bx bx-check-circle me-2'></i>
                                                    <strong>File:</strong>
                                                    {{ basename($lampiran['aspek_pasar'][$key]->path) }}
                                                </div>
                                                <div>
                                                    <a href="{{ route('subdirektorat-inovasi.dosen.document.view', $lampiran['aspek_pasar'][$key]->id) }}"
                                                        target="_blank" class="btn btn-sm btn-info me-2">
                                                        <i class='bx bx-show'></i> Lihat
                                                    </a>
                                                    <button type="button" class="btn btn-sm btn-danger"
                                        ...
                                        <div class="mt-2">
                                            <div
                                                ...
                                                <div>
                                                    <i class='bx bx-check-circle me-2'></i>
                                                    <strong>File:</strong>
                                                    {{ basename($lampiran['aspek_organisasi'][$key]->path) }}
                                                </div>
                                                <div>
                                                    <a href="{{ route('subdirektorat-inovasi.dosen.document.view', $lampiran['aspek_organisasi'][$key]->id) }}"
                                                        target="_blank" class="btn btn-sm btn-info me-2">
                                                        <i class='bx bx-show'></i> Lihat
                                                    </a>
                                                    <button type="button" class="btn btn-sm btn-danger"
                                        ...
                                        <div class="mt-2">
                                            <div
                                                ...
                                                <div>
                                                    <i class='bx bx-check-circle me-2'></i>
                                                    <strong>File:</strong>
                                                    {{ basename($lampiran['aspek_mitra'][$key]->path) }}
                                                </div>
                                                <div>
                                                    <a href="{{ route('subdirektorat-inovasi.dosen.document.view', $lampiran['aspek_mitra'][$key]->id) }}"
                                                        target="_blank" class="btn btn-sm btn-info me-2">
                                                        <i class='bx bx-show'></i> Lihat
                                                    </a>
                                                    <button type="button" class="btn btn-sm btn-danger"
                                        ...
                                        <div class="mt-2">
                                            <div
                                                ...
                                                <div>
                                                    <i class='bx bx-check-circle me-2'></i>
                                                    <strong>File:</strong>
                                                    {{ basename($lampiran['aspek_risiko'][$key]->path) }}
                                                </div>
                                                <div>
                                                    <a href="{{ route('subdirektorat-inovasi.dosen.document.view', $lampiran['aspek_risiko'][$key]->id) }}"
                                                        target="_blank" class="btn btn-sm btn-info me-2">
                                                        <i class='bx bx-show'></i> Lihat
                                                    </a>
                                                    <button type="button" class="btn btn-sm btn-danger"
                                        ...
                                        <div class="mt-2">
                                            <div
                                                ...
                                                <div>
                                                    <i class='bx bx-check-circle me-2'></i>
                                                    <strong>File:</strong>
                                                    {{ basename($lampiran['aspek_manufaktur'][$key]->path) }}
                                                </div>
                                                <div>
                                                    <a href="{{ route('subdirektorat-inovasi.dosen.document.view', $lampiran['aspek_manufaktur'][$key]->id) }}"
                                                        target="_blank" class="btn btn-sm btn-info me-2">
                                                        <i class='bx bx-show'></i> Lihat
                                                    </a>
                                                    <button type="button" class="btn btn-sm btn-danger"
                                        ...
                                        <div class="mt-2">
                                            <div
                                                ...
                                                <div>
                                                    <i class='bx bx-check-circle me-2'></i>
                                                    <strong>File:</strong>
                                                    {{ basename($lampiran['aspek_investasi'][$key]->path) }}
                                                </div>
                                                <div>
                                                    <a href="{{ route('subdirektorat-inovasi.dosen.document.view', $lampiran['aspek_investasi'][$key]->id) }}"
                                                        target="_blank" class="btn btn-sm btn-info me-2">
                                                        <i class='bx bx-show'></i> Lihat
                                                    </a>
                                                    <button type="button" class="btn btn-sm btn-danger"
