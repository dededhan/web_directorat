        ...
        <header class="mb-8">
            <nav class="text-sm text-gray-500 mb-3" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex items-center space-x-2">
                    ...
                    <li><i class='bx bx-chevron-right text-base text-gray-400'></i></li>
                    <li><a href="{{ route('subdirektorat-inovasi.dosen.hibah_modul.sesi') }}" class="hover:text-teal-600 transition-colors duration-200">Sesi</a></li>
                    <li><i class='bx bx-chevron-right text-base text-gray-400'></i></li>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-gray-600 text-base">Sesi: <span class="font-semibold text-teal-600">{{ $sesi->nama_sesi }}</span></p>
                </div>
        ...
        <form action="{{ route('subdirektorat-inovasi.dosen.hibah_modul.store', $sesi->id) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="sdgs" id="sdgs" value="{{ old('sdgs') }}" 
                                   class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all"
                                   placeholder="4, 8, 17">
                            <p class="text-xs text-gray-500 mt-2">Pisahkan dengan koma</p>
                        </div>
            ...
            <div class="px-6 lg:px-8 py-5 bg-gray-50 border-t-2 border-gray-100">
                <div class="flex flex-col sm:flex-row items-center justify-end gap-3">
                    <a href="{{ route('subdirektorat-inovasi.dosen.hibah_modul.sesi') }}" class="w-full sm:w-auto px-6 py-3 border-2 border-gray-300 text-gray-700 font-semibold rounded-xl hover:bg-gray-100 hover:border-gray-400 transition-all text-center">
