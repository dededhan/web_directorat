...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100" x-data="presentingForm()">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form action="{{ route('subdirektorat-inovasi.dosen.presenting.store', $session->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="p-6 lg:p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="lembaga_penyelenggara" id="lembaga_penyelenggara" required 
                               ...
                               value="{{ old('lembaga_penyelenggara') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="negara_pelaksanaan" id="negara_pelaksanaan" required
                                ...
                                <option value="Malaysia" {{ old('negara_pelaksanaan', 'Indonesia') === 'Malaysia' ? 'selected' : '' }}>Malaysia</option>
                                <option value="Singapore" {{ old('negara_pelaksanaan', 'Indonesia') === 'Singapore' ? 'selected' : '' }}>Singapore</option>
                                <option value="Thailand" {{ old('negara_pelaksanaan', 'Indonesia') === 'Thailand' ? 'selected' : '' }}>Thailand</option>
                                <option value="Philippines" {{ old('negara_pelaksanaan', 'Indonesia') === 'Philippines' ? 'selected' : '' }}>Philippines</option>
                                <option value="United States" {{ old('negara_pelaksanaan', 'Indonesia') === 'United States' ? 'selected' : '' }}>United States</option>
                                <option value="United Kingdom" {{ old('negara_pelaksanaan', 'Indonesia') === 'United Kingdom' ? 'selected' : '' }}>United Kingdom</option>
                                <option value="Other" {{ old('negara_pelaksanaan', 'Indonesia') === 'Other' ? 'selected' : '' }}>Other</option>
                            </select>
                ...
                <div class="p-6 lg:p-8 space-y-6">
                    <div>
                        ...
                        <textarea name="judul_artikel" id="judul_artikel" required rows="3"
                                  class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-teal-500 focus:ring-2 focus:ring-teal-200 transition-all duration-200 text-gray-900 placeholder-gray-400 shadow-sm" 
                                  placeholder="Masukkan judul artikel">{{ old('judul_artikel') }}</textarea>
            ...
            <div class="flex items-center justify-end space-x-3">
                ...
                <button type="submit" 
                    ...
                    <i class='bx bx-save text-lg mr-2'></i> Simpan Pengajuan
                </button>
            </div>
        </form>
    </div>
