            ...
            <div class="p-6 lg:p-8 space-y-8">
                ...
                <div class="border-t-2 border-gray-100 pt-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <a href="{{ asset('storage/' . $report->submission->manuscript_path) }}" target="_blank" class="flex items-center p-4 bg-gradient-to-br from-teal-50 to-teal-100 border-2 border-teal-200 rounded-xl hover:from-teal-100 hover:to-teal-200 transition-all duration-200 group">
                        ...
                        <a href="{{ $report->submission->manuscript_link }}" target="_blank" class="flex items-center p-4 bg-gradient-to-br from-indigo-50 to-indigo-100 border-2 border-indigo-200 rounded-xl hover:from-indigo-100 hover:to-indigo-200 transition-all duration-200 group">
