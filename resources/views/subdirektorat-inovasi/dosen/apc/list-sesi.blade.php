        ...
        <header class="mb-10">
            <nav class="text-sm text-gray-500 mb-3" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex items-center space-x-2">
                    ...
                    <li class="font-medium text-gray-800">Pilih Sesi APC</li>
                </ol>
            </nav>
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 class="text-2xl lg:text-3xl font-bold text-gray-800">Usulkan Proposal APC</h1>
                    <p class="mt-2 text-gray-600 text-base">Pilih salah satu sesi pendanaan yang tersedia untuk mengajukan proposal Anda.</p>
                </div>
            </div>
        </header>
            ...
            @forelse ($sessions as $session)
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl hover:border-gray-200 transition-all duration-300 overflow-hidden flex flex-col">
                    ...
                    <div class="p-6 lg:p-8 flex-grow">
                        ...
                        <div class="mt-6 border-t-2 border-gray-100 pt-6 grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                            <div class="flex items-center p-4 bg-gray-50 rounded-xl border border-gray-200">
                                <div class="w-10 h-10 bg-gradient-to-br from-green-100 to-green-200 rounded-lg flex items-center justify-center mr-4">
                                    <i class='bx bx-money text-green-500 text-xl'></i>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 font-bold uppercase tracking-wide">Dana Maksimal</p>
                                    <p class="font-semibold text-gray-800 text-base">Rp {{ number_format($session->dana, 0, ',', '.') }}</p>
                                </div>
                            </div>
                            <div class="flex items-center p-4 bg-gray-50 rounded-xl border border-gray-200">
                                ...
                                <div>
                                    <p class="text-xs text-gray-500 font-bold uppercase tracking-wide">Batas Akhir Pengajuan</p>
                    ...
                    <div class="bg-gray-50/70 px-6 lg:px-8 py-5 border-t border-gray-100">
                        @if ($isSessionOpen)
                            <a href="{{ route('subdirektorat-inovasi.dosen.apc.form', $session->id) }}" 
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                    <div class="text-center py-20 px-6">
                        <div class="flex flex-col items-center">
                            ...
                            <h3 class="font-bold text-xl text-gray-800 mb-2">Tidak Ada Sesi Pendanaan Tersedia</h3>
                            <p class="text-gray-500 max-w-md">Saat ini belum ada sesi pendanaan Article Processing Cost (APC) yang dibuka. Silakan periksa kembali nanti.</p>
                        </div>
                    </div>
                </div>
            @endforelse
