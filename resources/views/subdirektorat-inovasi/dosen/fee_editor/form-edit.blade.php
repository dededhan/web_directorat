...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {{-- Main Form --}}
        <form action="{{ route('subdirektorat-inovasi.dosen.fee_editor.update', $report->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="p-6 lg:p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <select name="peran" 
                            ...
                            <option value="Editor-in-Chief" {{ old('peran', $report->peran) == 'Editor-in-Chief' ? 'selected' : '' }}>Editor-in-Chief</option>
                            <option value="Associate Editor" {{ old('peran', $report->peran) == 'Associate Editor' ? 'selected' : '' }}>Associate Editor</option>
                            <option value="Section Editor" {{ old('peran', $report->peran) == 'Section Editor' ? 'selected' : '' }}>Section Editor</option>
                            <option value="Editorial Board Member" {{ old('peran', $report->peran) == 'Editorial Board Member' ? 'selected' : '' }}>Editorial Board Member</option>
                        </select>
                        @error('peran')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-teal-500 focus:ring-2 focus:ring-teal-200 transition-all duration-200 text-gray-900 placeholder-gray-400 shadow-sm" 
                                   placeholder="2023"
                                   value="{{ old('penugasan_awal', $report->penugasan_awal) }}">
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-teal-500 focus:ring-2 focus:ring-teal-200 transition-all duration-200 text-gray-900 placeholder-gray-400 shadow-sm" 
                                   placeholder="2025"
                                   value="{{ old('penugasan_akhir', $report->penugasan_akhir) }}">
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-teal-500 focus:ring-2 focus:ring-teal-200 transition-all duration-200 text-gray-900 placeholder-gray-400 shadow-sm" 
                               placeholder="https://..."
                               value="{{ old('link_laman_resmi', $report->link_laman_resmi) }}">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden mb-6">
                ...
                <div class="p-6 lg:p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">Upload file PDF (Maks. 10MB) - Kosongkan jika tidak ingin mengubah</p>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">Upload screenshot dashboard OJS/editorial system (PDF/JPG/PNG, Maks. 10MB) - Kosongkan jika tidak ingin mengubah</p>
