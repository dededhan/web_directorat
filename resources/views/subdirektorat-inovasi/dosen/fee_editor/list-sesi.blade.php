        ...
        <header class="mb-10">
            <nav class="text-sm text-gray-500 mb-3" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex items-center space-x-2">
                    ...
                    <li class="font-medium text-gray-800">Pilih Sesi Insentif Editor</li>
                </ol>
            </nav>
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 class="text-2xl lg:text-3xl font-bold text-gray-800">Usulkan Laporan Insentif Editor</h1>
            ...
            @forelse ($sessions as $session)
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl hover:border-gray-200 transition-all duration-300 overflow-hidden flex flex-col">
                    ...
                    <div class="bg-gray-50/70 px-6 lg:px-8 py-5 border-t border-gray-100">
                        @if ($isSessionOpen)
                            <a href="{{ route('subdirektorat-inovasi.dosen.fee_editor.form', $session->id) }}" 
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                    <div class="text-center py-20 px-6">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-gray-500 max-w-md">Saat ini belum ada sesi Insentif Editor yang dibuka. Silakan periksa kembali nanti.</p>
                        </div>
                    </div>
                </div>
            @endforelse
