        ...
        <header class="mb-8">
            <nav class="text-sm text-gray-500 mb-3" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex items-center space-x-2">
                    ...
                    <li><a href="{{ route('subdirektorat-inovasi.dosen.fee_editor.manajemen') }}" class="hover:text-teal-600 transition-colors duration-200">Manajemen Laporan</a></li>
                    <li><i class='bx bx-chevron-right text-base text-gray-400'></i></li>
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('subdirektorat-inovasi.dosen.fee_editor.manajemen') }}" class="inline-flex items-center px-4 py-2 bg-white border-2 border-gray-200 text-gray-700 font-semibold rounded-xl hover:bg-gray-50 transition-all shadow-sm">
            ...
            <div class="p-6 lg:p-8 space-y-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 text-sm">
                    <div class="lg:col-span-2">
                        ...
                        <p class="text-gray-800 font-semibold leading-relaxed">{{ $report->nama_jurnal }}</p>
                    </div>
                    <div class="lg:col-span-2">
                    ...
                    <div class="lg:col-span-2">
                        <label class="block text-xs font-bold uppercase text-gray-500 mb-2">Peran dalam Jurnal</label>
                        <p class="text-gray-800 font-medium">{{ $report->peran }}</p>
                    </div>
                    <div>
                        <label class="block text-xs font-bold uppercase text-gray-500 mb-2">Periode Penugasan</label>
                        <p class="text-gray-800">{{ $report->penugasan_awal }} - {{ $report->penugasan_akhir }}</p>
                    </div>
                    <div class="lg:col-span-2">
                        <label class="block text-xs font-bold uppercase text-gray-500 mb-2">Link Laman Resmi Jurnal</label>
                        <a href="{{ $report->link_laman_resmi }}" target="_blank" class="text-teal-600 hover:text-teal-800 hover:underline break-all text-sm">{{ $report->link_laman_resmi }}</a>
                    </div>
                    <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        <a href="{{ asset('storage/' . $report->bukti_undangan_path) }}" target="_blank" class="flex items-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-200 rounded-xl hover:from-blue-100 hover:to-blue-200 transition-all duration-200 group">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">Surat Undangan Editor</p>
                            </div>
                        </a>
                        <a href="{{ asset('storage/' . $report->bukti_aktivitas_path) }}" target="_blank" class="flex items-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-200 rounded-xl hover:from-purple-100 hover:to-purple-200 transition-all duration-200 group">
                            <i class='bx bx-screenshot text-purple-500 text-2xl mr-3 group-hover:scale-110 transition-transform'></i>
                            <div>
                                <p class="font-semibold text-gray-800 text-sm">Bukti Aktivitas</p>
                                <p class="text-xs text-gray-500">Screenshot Dashboard</p>
                            </div>
                        </a>
                    </div>
                </div>
