        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <header class="mb-10">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h1 class="text-2xl lg:text-3xl font-bold text-gray-800">Manajemen Laporan Insentif Editor</h1>
                        <p class="mt-2 text-gray-600 text-base">Semua laporan Insentif Editor yang telah Anda
                            ajukan.</p>
                    </div>
                                                    ...
                                                    <div x-data="{ open: false }" class="relative inline-block text-left">
                                                        ...
                                                        <div x-show="open" 
                                                            ...
                                                            <div class="py-1" role="menu">
                                                                <a href="{{ route('subdirektorat-inovasi.dosen.fee_editor.details', $report) }}" class="flex items-center w-full px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors"><i class='bx bx-show-alt mr-3 text-lg text-blue-500'></i>Lihat Detail</a>
                            ...
                            @foreach ($reports as $report)
                                <div class="border-b border-gray-100 last:border-b-0 p-4 hover:bg-gray-50 transition-colors">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        <a href="{{ route('subdirektorat-inovasi.dosen.fee_editor.details', $report) }}" class="flex items-center justify-center w-full px-4 py-2 bg-teal-50 border-2 border-teal-200 rounded-xl text-sm font-medium text-teal-700 hover:bg-teal-100 hover:border-teal-300 transition-all">
                                            <i class='bx bx-show-alt mr-2'></i> Lihat Detail
                                        </a>
                                        @if ($isSessionOpen && in_array($report->status, ['diajukan', 'ditolak']))
                                            <a href="{{ route('subdirektorat-inovasi.dosen.fee_editor.edit', $report) }}" class="flex items-center justify-center w-full px-4 py-2 bg-yellow-50 border-2 border-yellow-200 rounded-xl text-sm font-medium text-yellow-700 hover:bg-yellow-100 hover:border-yellow-300 transition-all">
                                                <i class='bx bx-edit-alt mr-2'></i> Edit
                                            </a>
                                            <button @click="showDeleteModal = true; deleteUrl = '{{ route('subdirektorat-inovasi.dosen.fee_editor.destroy', $report) }}'" class="flex items-center justify-center w-full px-4 py-2 bg-red-50 border-2 border-red-200 rounded-xl text-sm font-medium text-red-700 hover:bg-red-100 hover:border-red-300 transition-all">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                        <div class="text-center py-20 px-6">
                            <div class="flex flex-col items-center">
                                ...
                                <h3 class="font-bold text-xl text-gray-800 mb-2">Anda Belum Memiliki Laporan Insentif Editor</h3>
