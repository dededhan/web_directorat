...
<div x-data="{
        ...
        inovChallengeOpen: {{ request()->routeIs('dosen.inov_challenge.*') ? 'true' : 'false' }},
        ...
        <nav class="flex-1 space-y-3 py-6 px-4 overflow-y-auto">
            ...
            <div class="pt-3">
                ...
                <button @click="feeReviewerOpen = !feeReviewerOpen" 
                        ...
                        :disabled="{{ $isProfileIncomplete ? 'true' : 'false' }}"
                        @if($isProfileIncomplete) title="Harap lengkapi profil Anda terlebih dahulu." @endif>
                    <div class="flex items-center space-x-4"><i class='bx bxs-award text-2xl flex-shrink-0'></i><span x-show="open || mobileOpen" class="font-medium">Insentif Reviewer</span></div>
                    <div x-show="open || mobileOpen" class="flex items-center"><i class='bx bx-chevron-down text-2xl transition-transform' :class="{'rotate-180': feeReviewerOpen}"></i></div>
                </button>
                <div x-show="feeReviewerOpen && (open || mobileOpen)" x-collapse class="mt-2 ml-3 space-y-1">
                    <a href="{{ route('subdirektorat-inovasi.dosen.fee_reviewer.manajemen') }}" class="flex items-center space-x-4 rounded-lg p-3 text-sm transition-colors {{ request()->routeIs('subdirektorat-inovasi.dosen.fee_reviewer.manajemen') ? 'bg-teal-600 font-semibold text-white shadow-md' : 'hover:bg-gray-700' }} ml-4"><i class='bx bxs-folder-open text-2xl flex-shrink-0'></i><span>Manajemen Pengajuan</span></a>
                    <a href="{{ route('subdirektorat-inovasi.dosen.fee_reviewer.list-sesi') }}" class="flex items-center space-x-4 rounded-lg p-3 text-sm transition-colors {{ request()->routeIs('subdirektorat-inovasi.dosen.fee_reviewer.list-sesi') || request()->routeIs('subdirektorat-inovasi.dosen.fee_reviewer.form') ? 'bg-teal-600 font-semibold text-white shadow-md' : 'hover:bg-gray-700' }} ml-4"><i class='bx bxs-file-plus text-2xl flex-shrink-0'></i><span>Ajukan Insentif</span></a>
                </div>
                <button @click="feeEditorOpen = !feeEditorOpen" 
                        ...
                        :disabled="{{ $isProfileIncomplete ? 'true' : 'false' }}"
                        @if($isProfileIncomplete) title="Harap lengkapi profil Anda terlebih dahulu." @endif>
                    <div class="flex items-center space-x-4"><i class='bx bxs-edit text-2xl flex-shrink-0'></i><span x-show="open || mobileOpen" class="font-medium">Insentif Editor</span></div>
                    <div x-show="open || mobileOpen" class="flex items-center"><i class='bx bx-chevron-down text-2xl transition-transform' :class="{'rotate-180': feeEditorOpen}"></i></div>
                </button>
                <div x-show="feeEditorOpen && (open || mobileOpen)" x-collapse class="mt-2 ml-3 space-y-1">
                    <a href="{{ route('subdirektorat-inovasi.dosen.fee_editor.manajemen') }}" class="flex items-center space-x-4 rounded-lg p-3 text-sm transition-colors {{ request()->routeIs('subdirektorat-inovasi.dosen.fee_editor.manajemen') ? 'bg-teal-600 font-semibold text-white shadow-md' : 'hover:bg-gray-700' }} ml-4"><i class='bx bxs-folder-open text-2xl flex-shrink-0'></i><span>Manajemen Pengajuan</span></a>
                    <a href="{{ route('subdirektorat-inovasi.dosen.fee_editor.list-sesi') }}" class="flex items-center space-x-4 rounded-lg p-3 text-sm transition-colors {{ request()->routeIs('subdirektorat-inovasi.dosen.fee_editor.list-sesi') || request()->routeIs('subdirektorat-inovasi.dosen.fee_editor.form') ? 'bg-teal-600 font-semibold text-white shadow-md' : 'hover:bg-gray-700' }} ml-4"><i class='bx bxs-file-plus text-2xl flex-shrink-0'></i><span>Ajukan Insentif</span></a>
                </div>
                <button @click="presentingOpen = !presentingOpen" 
                        ...
                        :disabled="{{ $isProfileIncomplete ? 'true' : 'false' }}"
                        @if($isProfileIncomplete) title="Harap lengkapi profil Anda terlebih dahulu." @endif>
                    <div class="flex items-center space-x-4"><i class='bx bxs-slideshow text-2xl flex-shrink-0'></i><span x-show="open || mobileOpen" class="font-medium">Bantuan Presentasi</span></div>
                    <div x-show="open || mobileOpen" class="flex items-center"><i class='bx bx-chevron-down text-2xl transition-transform' :class="{'rotate-180': presentingOpen}"></i></div>
                </button>
                <div x-show="presentingOpen && (open || mobileOpen)" x-collapse class="mt-2 ml-3 space-y-1">
                    <a href="{{ route('subdirektorat-inovasi.dosen.presenting.manajemen') }}" class="flex items-center space-x-4 rounded-lg p-3 text-sm transition-colors {{ request()->routeIs('subdirektorat-inovasi.dosen.presenting.manajemen') ? 'bg-teal-600 font-semibold text-white shadow-md' : 'hover:bg-gray-700' }} ml-4"><i class='bx bxs-folder-open text-2xl flex-shrink-0'></i><span>Manajemen Pengajuan</span></a>
                    <a href="{{ route('subdirektorat-inovasi.dosen.presenting.list-sesi') }}" class="flex items-center space-x-4 rounded-lg p-3 text-sm transition-colors {{ request()->routeIs('subdirektorat-inovasi.dosen.presenting.list-sesi') || request()->routeIs('subdirektorat-inovasi.dosen.presenting.form') ? 'bg-teal-600 font-semibold text-white shadow-md' : 'hover:bg-gray-700' }} ml-4"><i class='bx bxs-file-plus text-2xl flex-shrink-0'></i><span>Ajukan Bantuan</span></a>
                </div>
                <button @click="matchmakingOpen = !matchmakingOpen" 
                        ...
                        :disabled="{{ $isProfileIncomplete ? 'true' : 'false' }}"
                        @if($isProfileIncomplete) title="Harap lengkapi profil Anda terlebih dahulu." @endif>
                    <div class="flex items-center space-x-4"><i class='bx bx-user-voice text-2xl flex-shrink-0'></i><span x-show="open || mobileOpen" class="font-medium">Matchmaking Research</span></div>
                ...
                <button @click="studentExchangeOpen = !studentExchangeOpen" 
                        ...
                        :disabled="{{ $isProfileIncomplete ? 'true' : 'false' }}"
                        @if($isProfileIncomplete) title="Harap lengkapi profil Anda terlebih dahulu." @endif>
                    <div class="flex items-center space-x-4"><i class='bx bxs-plane-alt text-2xl flex-shrink-0'></i><span x-show="open || mobileOpen" class="font-medium">Student Exchange</span></div>
                    <div x-show="open || mobileOpen" class="flex items-center"><i class='bx bx-chevron-down text-2xl transition-transform' :class="{'rotate-180': studentExchangeOpen}"></i></div>
                </button>
            ...
            <div class="pt-3">
                ...
                <button @click="inovChallengeOpen = !inovChallengeOpen" 
                        class="flex w-full items-center rounded-lg p-3 transition-colors hover:bg-gray-700 group {{ $isProfileIncomplete ? 'opacity-50 cursor-not-allowed' : '' }}" 
                        :class="open || mobileOpen ? 'justify-between' : 'justify-center'"
                        :disabled="{{ $isProfileIncomplete ? 'true' : 'false' }}"
                        @if($isProfileIncomplete) title="Harap lengkapi profil Anda terlebih dahulu." @endif>
                    ...
                    <div x-show="open || mobileOpen" class="flex items-center"><i class='bx bx-chevron-down text-2xl transition-transform' :class="{'rotate-180': inovChallengeOpen}"></i></div>
                </button>
                <div x-show="inovChallengeOpen && (open || mobileOpen)" x-collapse class="mt-2 ml-3 space-y-1">
                    <a href="{{ route('dosen.inov_challenge.index') }}" class="flex items-center space-x-4 rounded-lg p-3 text-sm transition-colors {{ request()->routeIs('dosen.inov_challenge.index') ? 'bg-teal-600 font-semibold text-white shadow-md' : 'hover:bg-gray-700' }} ml-4"><i class='bx bxs-dashboard text-2xl flex-shrink-0'></i><span>Dashboard</span></a>
                    <a href="{{ route('dosen.inov_challenge.sessions.index') }}" class="flex items-center space-x-4 rounded-lg p-3 text-sm transition-colors {{ request()->routeIs('dosen.inov_challenge.sessions.*') ? 'bg-teal-600 font-semibold text-white shadow-md' : 'hover:bg-gray-700' }} ml-4"><i class='bx bxs-calendar-event text-2xl flex-shrink-0'></i><span>Sesi Aktif</span></a>
                    <a href="{{ route('dosen.inov_challenge.submissions.index') }}" class="flex items-center space-x-4 rounded-lg p-3 text-sm transition-colors {{ request()->routeIs('dosen.inov_challenge.submissions.*') ? 'bg-teal-600 font-semibold text-white shadow-md' : 'hover:bg-gray-700' }} ml-4"><i class='bx bxs-file-doc text-2xl flex-shrink-0'></i><span>Submission Saya</span></a>
                </div>
            </div>
        </nav>
