        ...
        <header class="mb-10">
            <nav class="text-sm text-gray-500 mb-3" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex items-center space-x-2">
                    ...
                    <li><i class='bx bx-chevron-right text-base text-gray-400'></i></li>
                    <li class="font-medium text-gray-800">Sesi Student Exchange</li>
                </ol>
            </nav>
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 class="text-2xl lg:text-3xl font-bold text-gray-800">Sesi Student Exchange</h1>
                    <p class="mt-2 text-gray-600 text-base">Pilih sesi yang tersedia untuk mengajukan proposal pertukaran mahasiswa Anda.</p>
                </div>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center text-sm text-gray-600">
                                ...
                                <span class="ml-2 font-semibold {{ $daysLeft <= 7 ? 'text-red-600' : 'text-gray-800' }}">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                <div class="text-center py-20 px-6">
                    <div class="flex flex-col items-center">
                        ...
                        <p class="text-gray-500 mb-2">Saat ini belum ada sesi student exchange yang dibuka.</p>
