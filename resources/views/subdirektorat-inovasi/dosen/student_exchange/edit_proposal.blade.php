...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100" x-data="proposalFormData()">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <header class="mb-8">
            <nav class="text-sm text-gray-500 mb-3" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex items-center space-x-2">
                    ...
                    <li><i class='bx bx-chevron-right text-base text-gray-400'></i></li>
                    <li><a href="{{ route('subdirektorat-inovasi.dosen.student_exchange.show', $proposal->id) }}" class="hover:text-teal-600">Detail</a></li>
                    <li><i class='bx bx-chevron-right text-base text-gray-400'></i></li>
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl lg:text-3xl font-bold text-gray-800">Edit Proposal Student Exchange</h1>
                    <p class="mt-2 text-gray-600">Sesi: <span class="font-semibold text-teal-600">{{ $proposal->sesi->nama_sesi }}</span></p>
                </div>
        ...
        <form action="{{ route('subdirektorat-inovasi.dosen.student_exchange.update', $proposal->id) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            @csrf
            @method('PUT')
            ...
            <div class="bg-gradient-to-r from-teal-500 to-teal-600 px-6 lg:px-8 py-5">
                <h2 class="text-xl lg:text-2xl font-bold text-white flex items-center">
                    <i class='bx bx-edit mr-3 text-2xl'></i> Edit Formulir Proposal
                </h2>
            </div>
            ...
            <div class="p-6 lg:p-8 space-y-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="judul_kegiatan" value="{{ old('judul_kegiatan', $proposal->judul_kegiatan) }}" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all" placeholder="Masukkan judul kegiatan pertukaran mahasiswa">
                    ...
                    <div>
                        ...
                        <textarea name="ringkasan_kegiatan" rows="5" required maxlength="300" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all" placeholder="Tuliskan ringkasan kegiatan (maksimal 300 karakter)">{{ old('ringkasan_kegiatan', $proposal->ringkasan_kegiatan) }}</textarea>
                    ...
                    <div>
                        ...
                        <select name="jenis_kegiatan" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all">
                            ...
                            <option value="inbound" {{ old('jenis_kegiatan', $proposal->jenis_kegiatan) == 'inbound' ? 'selected' : '' }}>Inbound (Mahasiswa Asing ke UNJ)</option>
                            <option value="outbound" {{ old('jenis_kegiatan', $proposal->jenis_kegiatan) == 'outbound' ? 'selected' : '' }}>Outbound (Mahasiswa UNJ ke Luar Negeri)</option>
                        </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" name="jumlah_peserta" value="{{ old('jumlah_peserta', $proposal->jumlah_peserta) }}" min="1" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all" placeholder="Jumlah mahasiswa peserta">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">SKS <span class="text-red-500">*</span></label>
                            <input type="number" name="sks" value="{{ old('sks', $proposal->sks) }}" min="1" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all" placeholder="Total SKS">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="date" name="tanggal_online" value="{{ old('tanggal_online', $proposal->tanggal_online ? $proposal->tanggal_online->format('Y-m-d') : '') }}" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Tanggal Onsite</label>
                            <input type="date" name="tanggal_onsite" value="{{ old('tanggal_onsite', $proposal->tanggal_onsite ? $proposal->tanggal_onsite->format('Y-m-d') : '') }}" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all">
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_mitra" value="{{ old('nama_mitra', $mitra->nama_mitra ?? '') }}" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all" placeholder="Nama institusi mitra">
                    </div>

                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Negara <span class="text-red-500">*</span></label>
                        <input type="text" name="negara" value="{{ old('negara', $mitra->negara ?? '') }}" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all" placeholder="Negara asal institusi">
                    </div>

                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Nama PIC <span class="text-red-500">*</span></label>
                        <input type="text" name="nama_pic" value="{{ old('nama_pic', $mitra->nama_pic ?? '') }}" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all" placeholder="Nama person in charge">
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Nomor Kontak PIC <span class="text-red-500">*</span></label>
                            <input type="text" name="nomor_kontak_pic" value="{{ old('nomor_kontak_pic', $mitra->nomor_kontak_pic ?? '') }}" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all" placeholder="+62xxx">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Email PIC <span class="text-red-500">*</span></label>
                            <input type="email" name="email_pic" value="{{ old('email_pic', $mitra->email_pic ?? '') }}" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all" placeholder="email@example.com">
                        </div>
                    </div>

                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Dokumen Kesediaan Mitra (PDF)</label>
                        @if($mitra && $mitra->kesediaan_mitra_path)
                        <div class="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm text-blue-800 font-semibold">File saat ini: {{ basename($mitra->kesediaan_mitra_path) }}</span>
                            </div>
                            <a href="{{ Storage::url($mitra->kesediaan_mitra_path) }}" target="_blank" class="text-blue-600 hover:text-blue-800 text-sm font-semibold">
                                <i class='bx bx-download mr-1'></i>Unduh
                            </a>
                        </div>
                        <p class="text-xs text-gray-600 mb-2">Upload file baru untuk mengganti file yang ada</p>
                        @endif
                        <input type="file" name="kesediaan_mitra" accept=".pdf" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg flex items-center justify-between">
                            <div class="flex items-center">
                                <i class='bx bxs-file-pdf text-red-500 text-2xl mr-2'></i>
                                <span class="text-sm text-blue-800 font-semibold">{{ basename($proposal->nama_mahasiswa_path) }}</span>
                            </div>
                            <a href="{{ Storage::url($proposal->nama_mahasiswa_path) }}" target="_blank" class="text-blue-600 hover:text-blue-800 text-sm font-semibold">
                                <i class='bx bx-download mr-1'></i>Unduh
                            </a>
                        </div>
                        @endif
                        <input type="file" name="nama_mahasiswa" accept=".pdf" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg flex items-center justify-between">
                            <div class="flex items-center">
                                <i class='bx bxs-file-pdf text-red-500 text-2xl mr-2'></i>
                                <span class="text-sm text-blue-800 font-semibold">{{ basename($proposal->mata_kuliah_path) }}</span>
                            </div>
                            <a href="{{ Storage::url($proposal->mata_kuliah_path) }}" target="_blank" class="text-blue-600 hover:text-blue-800 text-sm font-semibold">
                                <i class='bx bx-download mr-1'></i>Unduh
                            </a>
                        </div>
                        @endif
                        <input type="file" name="mata_kuliah" accept=".pdf" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mb-3 p-3 bg-blue-50 border border-blue-200 rounded-lg flex items-center justify-between">
                            <div class="flex items-center">
                                <i class='bx bxs-file-pdf text-red-500 text-2xl mr-2'></i>
                                <span class="text-sm text-blue-800 font-semibold">{{ basename($proposal->rab_path) }}</span>
                            </div>
                            <a href="{{ Storage::url($proposal->rab_path) }}" target="_blank" class="text-blue-600 hover:text-blue-800 text-sm font-semibold">
                                <i class='bx bx-download mr-1'></i>Unduh
                            </a>
                        </div>
                        @endif
                        <input type="file" name="rab" accept=".pdf" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-3 pt-6 border-t">
                    ...
                    <a href="{{ route('subdirektorat-inovasi.dosen.student_exchange.show', $proposal->id) }}" class="flex-1 inline-flex items-center justify-center px-6 py-3 bg-gray-200 text-gray-700 font-semibold rounded-xl hover:bg-gray-300 transition-all">
...
<script>
    function proposalFormData() {
        return {
            selectedSdgsFokus: @json($proposal->sdgs_fokus ?? []),
            selectedSdgsPendukung: @json($proposal->sdgs_pendukung ?? []),
            sdgFokusDropdownOpen: false,
            sdgPendukungDropdownOpen: false,
            anggotaList: {!! json_encode($proposal->anggota->map(function($a) { 
                return [
