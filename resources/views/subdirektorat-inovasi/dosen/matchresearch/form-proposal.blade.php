...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100" x-data="logbookForm({ respondens: {{ json_encode($respondents) }} })">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form action="{{ route('subdirektorat-inovasi.dosen.matchresearch.report.store', $submission->id) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
            
            {{-- Bagian Unggahan Dokumen Inti --}}
            <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                ...
                <div class="space-y-4">
                    <div>
                        <label for="proposal_path" class="block text-sm font-medium text-gray-700 mb-2">Proposal Final (Unggah PDF, maks 5MB)</label>
                        <input type="file" name="proposal_path" id="proposal_path" class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:font-semibold file:bg-teal-50 file:text-teal-700 hover:file:bg-teal-100">
                    ...
                    <div>
                        <label for="article_path" class="block text-sm font-medium text-gray-700 mb-2">Artikel (Unggah PDF, maks 5MB)</label>
                        <input type="file" name="article_path" id="article_path" class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:font-semibold file:bg-teal-50 file:text-teal-700 hover:file:bg-teal-100">
            ...
            {{-- Detail Jurnal dan Proses Submit --}}
            <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="submit_proof_path" class="block text-sm font-medium text-gray-700 mb-2">Bukti Submit (PDF/Image, maks 2MB)</label>
                        <input type="file" name="submit_proof_path" id="submit_proof_path" class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:font-semibold file:bg-violet-50 file:text-violet-700 hover:file:bg-violet-100">
                     ...
                     <div>
                        <label for="review_proof_path" class="block text-sm font-medium text-gray-700 mb-2">Bukti Under Review (PDF/Image, maks 2MB)</label>
                        <input type="file" name="review_proof_path" id="review_proof_path" class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:font-semibold file:bg-violet-50 file:text-violet-700 hover:file:bg-violet-100">
             ...
             {{-- Detail Perjalanan dan Responden --}}
            <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <label for="travel_proof_path" class="block text-sm font-medium text-gray-700 mb-2">Bukti Perjalanan (Tiket, Visa, dll. Maks 2MB)</label>
                        <input type="file" name="travel_proof_path" id="travel_proof_path" class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:font-semibold file:bg-sky-50 file:text-sky-700 hover:file:bg-sky-100">
            ...
            <div class="flex justify-end gap-4">
                ...
                <button type="submit" name="action" value="submit_final" class="px-8 py-3 bg-teal-600 text-white font-semibold rounded-xl hover:bg-teal-700">Kirim Laporan Final</button>
            </div>
        </form>
    </div>
</div>
...
function logbookForm(initialData) {
    return {
        respondens: initialData.respondens || [{ name: '' }, { name: '' }],
        addResponden() {
        ...
        removeResponden(index) {
            ...
            if (this.respondens.length > 2) {
                ...
                alert('Minimal harus ada 2 responden.');
            }
        }
    }
}
