                                                        ...
                                                        <div x-show="open" 
                                                            ...
                                                            <div class="py-1" role="menu">
                                                                ...
                                                                @if ($isSessionOpen && in_array($report->status, ['diajukan', 'ditolak']))
                                                                    ...
                                                                    <button @click="showDeleteModal = true; deleteUrl = '{{ route('subdirektorat-inovasi.dosen.fee_reviewer.destroy', $report) }}'; open = false" class="flex items-center w-full px-4 py-3 text-sm text-red-600 hover:bg-red-50 transition-colors"><i class='bx bx-trash mr-3 text-lg'></i>Hapus Laporan</button>
