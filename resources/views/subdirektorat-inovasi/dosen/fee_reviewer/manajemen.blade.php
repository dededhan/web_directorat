                                                    ...
                                                    <div x-data="{ open: false }" class="relative inline-block text-left">
                                                        ...
                                                        <div x-show="open" 
                                                            ...
                                                            <div class="py-1" role="menu">
                                                                <a href="{{ route('subdirektorat-inovasi.dosen.fee_reviewer.details', $report) }}" class="flex items-center w-full px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors"><i class='bx bx-show-alt mr-3 text-lg text-blue-500'></i>Lihat Detail</a>
                                                                @if ($isSessionOpen && in_array($report->status, ['diajukan', 'ditolak']))
                                                                    <a href="{{ route('subdirektorat-inovasi.dosen.fee_reviewer.edit', $report) }}" class="flex items-center w-full px-4 py-3 text-sm text-gray-700 hover:bg-yellow-50 hover:text-yellow-700 transition-colors"><i class='bx bx-edit-alt mr-3 text-lg text-yellow-600'></i>Edit Laporan</a>
                                                                    <div class="border-t my-1 border-gray-100"></div>
                                                                    <button type="button" @click.stop="showDeleteModal = true; deleteUrl = '{{ route('subdirektorat-inovasi.dosen.fee_reviewer.destroy', $report) }}'; open = false" class="flex items-center w-full px-4 py-3 text-sm text-red-600 hover:bg-red-50 transition-colors text-left"><i class='bx bx-trash mr-3 text-lg'></i>Hapus Laporan</button>
                            ...
                            @foreach ($reports as $report)
                                <div class="border-b border-gray-100 last:border-b-0 p-4 hover:bg-gray-50 transition-colors">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        <a href="{{ route('subdirektorat-inovasi.dosen.fee_reviewer.details', $report) }}" class="flex items-center justify-center w-full px-4 py-2 bg-teal-50 border-2 border-teal-200 rounded-xl text-sm font-medium text-teal-700 hover:bg-teal-100 hover:border-teal-300 transition-all">
                                            <i class='bx bx-show-alt mr-2'></i> Lihat Detail
                                        </a>
                                        @if ($isSessionOpen && in_array($report->status, ['diajukan', 'ditolak']))
                                            <a href="{{ route('subdirektorat-inovasi.dosen.fee_reviewer.edit', $report) }}" class="flex items-center justify-center w-full px-4 py-2 bg-yellow-50 border-2 border-yellow-200 rounded-xl text-sm font-medium text-yellow-700 hover:bg-yellow-100 hover:border-yellow-300 transition-all">
                                                <i class='bx bx-edit-alt mr-2'></i> Edit
                                            </a>
                                            <button @click="showDeleteModal = true; deleteUrl = '{{ route('subdirektorat-inovasi.dosen.fee_reviewer.destroy', $report) }}'" class="flex items-center justify-center w-full px-4 py-2 bg-red-50 border-2 border-red-200 rounded-xl text-sm font-medium text-red-700 hover:bg-red-100 hover:border-red-300 transition-all">
