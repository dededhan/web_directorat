...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <header class="mb-10">
            <nav class="text-sm text-gray-500 mb-3" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex items-center space-x-2">
                    ...
                    <li><i class='bx bx-chevron-right text-base text-gray-400'></i></li>
                    <li class="font-medium text-gray-800">Edit Laporan</li>
                </ol>
            </nav>
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 class="text-2xl lg:text-3xl font-bold text-gray-800">Edit Laporan Insentif Reviewer</h1>
                    <p class="mt-2 text-gray-600 text-base">Anda mengedit laporan untuk sesi: <strong class="text-teal-700">{{ $report->session->nama_sesi }}</strong></p>
                </div>
            </div>
        </header>
        ...
        {{-- Main Form --}}
        <form action="{{ route('subdirektorat-inovasi.dosen.fee_reviewer.update', $report) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="p-6 lg:p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('judul_artikel', $report->judul_artikel) }}">
                        @error('judul_artikel')
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('nama_jurnal', $report->nama_jurnal) }}">
                        @error('nama_jurnal')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('link_scimagojr', $report->link_scimagojr) }}">
                    ...
                    <div>
                        ...
                        <input type="date" 
                               ...
                               value="{{ old('tanggal_review', $report->tanggal_review) }}">
                ...
                <div class="p-6 lg:p-8 space-y-6">
                    ...
                    <div>
                        <label for="bukti_undangan" class="block text-sm font-bold text-gray-700 mb-2 flex items-center">
                            ...
                            Bukti Surat Undangan Reviewer atau Email dari Editor Jurnal
                        </label>
                        @if($report->bukti_undangan_path)
                            <div class="mb-3 p-3 bg-green-50 border border-green-200 rounded-lg flex items-center justify-between">
                                ...
                                <a href="{{ asset("storage/" . $report->bukti_undangan_path) }}" target="_blank" class="text-sm text-blue-600 hover:text-blue-800 underline flex items-center">
                        ...
                        <p class="text-xs text-gray-500 mt-1">Upload file baru jika ingin mengganti (PDF, max 10MB)</p>
                    ...
                    <div>
                        <label for="bukti_hasil_review" class="block text-sm font-bold text-gray-700 mb-2 flex items-center">
                            ...
                            Bukti Hasil Review / Laporan Review (File Review)
                        </label>
                        @if($report->bukti_hasil_review_path)
                            <div class="mb-3 p-3 bg-green-50 border border-green-200 rounded-lg flex items-center justify-between">
                                ...
                                <a href="{{ asset("storage/" . $report->bukti_hasil_review_path) }}" target="_blank" class="text-sm text-blue-600 hover:text-blue-800 underline flex items-center">
                                    <i class='bx bx-download mr-1'></i>
                                    Lihat File
                                </a>
                            </div>
                    ...
                    <div>
                        <label for="bukti_pengiriman_tepat_waktu" class="block text-sm font-bold text-gray-700 mb-2 flex items-center">
                            ...
                            Bukti Reviewer Mengirimkan Review Sesuai Tenggat Waktu
                        </label>
                        @if($report->bukti_pengiriman_tepat_waktu_path)
                            <div class="mb-3 p-3 bg-green-50 border border-green-200 rounded-lg flex items-center justify-between">
                                ...
                                <a href="{{ asset("storage/" . $report->bukti_pengiriman_tepat_waktu_path) }}" target="_blank" class="text-sm text-blue-600 hover:text-blue-800 underline flex items-center">
                                    <i class='bx bx-download mr-1'></i>
                                    Lihat File
                                </a>
                            </div>
                    ...
                    <div>
                        ...
                        @if($report->bukti_lain_path)
                            <div class="mb-3 p-3 bg-green-50 border border-green-200 rounded-lg flex items-center justify-between">
                                ...
                                <a href="{{ asset("storage/" . $report->bukti_lain_path) }}" target="_blank" class="text-sm text-blue-600 hover:text-blue-800 underline flex items-center">
                                    <i class='bx bx-download mr-1'></i>
                                    Lihat File
                                </a>
                            </div>
                        ...
                        <input type="file" 
                               ...
                               accept=".pdf"
                               class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-teal-500 focus:ring-2 focus:ring-teal-200 transition-all duration-200 text-gray-900 shadow-sm file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-teal-50 file:text-teal-700 hover:file:bg-teal-100">
                        <p class="text-xs text-gray-500 mt-1">Upload file baru jika ingin mengganti (Screenshot sistem jurnal, dll. max 10MB)</p>
                        @error('bukti_lain')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        @if($report->surat_pernyataan_path)
                            <div class="mb-3 p-3 bg-green-50 border border-green-200 rounded-lg flex items-center justify-between">
                                ...
                                <a href="{{ asset("storage/" . $report->surat_pernyataan_path) }}" target="_blank" class="text-sm text-blue-600 hover:text-blue-800 underline flex items-center">
                                    <i class='bx bx-download mr-1'></i>
                                    Lihat File
                                </a>
                            </div>
