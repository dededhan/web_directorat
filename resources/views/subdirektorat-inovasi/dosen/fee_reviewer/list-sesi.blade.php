        ...
        <header class="mb-10">
            <nav class="text-sm text-gray-500 mb-3" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex items-center space-x-2">
                    ...
                    <li class="font-medium text-gray-800">Pilih Sesi Fee Reviewer</li>
                </ol>
            </nav>
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 class="text-2xl lg:text-3xl font-bold text-gray-800">Usulkan Laporan Fee Reviewer</h1>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                    <div class="text-center py-20 px-6">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-gray-500 max-w-md">Saat ini belum ada sesi Fee Reviewer yang dibuka. Silakan periksa kembali nanti.</p>
                        </div>
                    </div>
                </div>
            @endforelse
