                                    ...
                                    <div class="collapse" id="subforms-{{ $katsinov->id }}">
                                        <div class="card card-body subform-container">
                                            ...
                                            <div class="subform-buttons">
                                                ...
                                                <a href="{{ route('subdirektorat-inovasi.validator.informasi.index', ['katsinov_id' => $katsinov->id]) }}" class="btn btn-primary btn-sm">
                                                    <i class='bx bx-info-circle'></i> Form Informasi Dasar
                                                </a>
                                                <a href="{{ route('subdirektorat-inovasi.validator.berita.index', ['katsinov_id' => $katsinov->id]) }}" class="btn btn-primary btn-sm">
                                                    <i class='bx bx-news'></i> Form Berita Acara
                                                </a>
                                                <a href="{{ route('subdirektorat-inovasi.validator.record.index', ['katsinov_id' => $katsinov->id]) }}" class="btn btn-primary btn-sm">
                                                    <i class='bx bx-bar-chart-alt-2'></i> Form Record Hasil
                                                </a>
                                                <a href="{{ route('subdirektorat-inovasi.validator.lampiran.index', ['katsinov_id' => $katsinov->id]) }}" class="btn btn-primary btn-sm">
