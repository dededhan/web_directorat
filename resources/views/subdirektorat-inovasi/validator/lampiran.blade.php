...
<div class="table-data">
    <div class="order">
        ...
        <form method="POST" action="{{ route('subdirektorat-inovasi.validator.lampiran.store', $id) }}" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                @if(isset($lampiran['aspek_teknologi']['proposal']))
                                    <div class="mt-2">
                                        ...
                                        <a href="{{ route('subdirektorat-inovasi.validator.document.view', $lampiran['aspek_teknologi']['proposal']->id) }}" 
                                            target="_blank" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                @if(isset($lampiran['aspek_teknologi']['jadwal']))
                                    <div class="mt-2">
                                        <span>File terupload:</span>
                                        <a href="{{ route('subdirektorat-inovasi.validator.document.view', $lampiran['aspek_teknologi']['jadwal']->id) }}" 
                                            target="_blank" 
                                            class="document-preview">
                                            Lihat Dokumen
                                        </a>
                            ...
                            @foreach([
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    @if(isset($lampiran['aspek_teknologi'][$key]))
                                        <div class="mt-2">
                                            <span>File terupload:</span>
                                            <a href="{{ route('subdirektorat-inovasi.validator.document.view', $lampiran['aspek_teknologi'][$key]->id) }}" 
                                                target="_blank" 
                                                class="document-preview">
                                                Lihat Dokumen
                                            </a>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                @if(isset($lampiran['aspek_teknologi']['dokumen_ilmiah']))
                                    <div class="mt-2">
                                        <span>File terupload:</span>
                                        <a href="{{ route('subdirektorat-inovasi.validator.document.view', $lampiran['aspek_teknologi']['dokumen_ilmiah']->id) }}" 
                                            target="_blank" 
                                            class="document-preview">
                                            Lihat Dokumen
                                        </a>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                @if(isset($lampiran['aspek_teknologi']['dokumen_haki']))
                                    <div class="mt-2">
                                        <span>File terupload:</span>
                                        <a href="{{ route('subdirektorat-inovasi.validator.document.view', $lampiran['aspek_teknologi']['dokumen_haki']->id) }}" 
                                            target="_blank" 
                                            class="document-preview">
                                            Lihat Dokumen
                                        </a>
                        ...
                        @foreach([
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                @if(isset($lampiran['aspek_pasar'][$key]))
                                    <div class="mt-2">
                                        <span>File terupload:</span>
                                        <a href="{{ route('subdirektorat-inovasi.validator.document.view', $lampiran['aspek_pasar'][$key]->id) }}" 
                                            target="_blank" 
                                            class="document-preview">
                                            Lihat Dokumen
                                        </a>
                    ...
                    @foreach([
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @if(isset($lampiran['aspek_organisasi'][$key]))
                                <div class="mt-2">
                                    <span>File terupload:</span>
                                    <a href="{{ route('subdirektorat-inovasi.validator.document.view', $lampiran['aspek_organisasi'][$key]->id) }}" 
                                        target="_blank" 
                                        class="document-preview">
                                        Lihat Dokumen
                                    </a>
                    ...
                    @foreach([
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @if(isset($lampiran['aspek_mitra'][$key]))
                                <div class="mt-2">
                                    <span>File terupload:</span>
                                    <a href="{{ route('subdirektorat-inovasi.validator.document.view', $lampiran['aspek_mitra'][$key]->id) }}" 
                                        target="_blank" 
                                        class="document-preview">
                                        Lihat Dokumen
                                    </a>
                    ...
                    @foreach([
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @if(isset($lampiran['aspek_risiko'][$key]))
                                <div class="mt-2">
                                    <span>File terupload:</span>
                                    <a href="{{ route('subdirektorat-inovasi.validator.document.view', $lampiran['aspek_risiko'][$key]->id) }}" 
                                        target="_blank" 
                                        class="document-preview">
                                        Lihat Dokumen
                                    </a>
                    ...
                    @foreach([
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @if(isset($lampiran['aspek_manufaktur'][$key]))
                                <div class="mt-2">
                                    <span>File terupload:</span>
                                    <a href="{{ route('subdirektorat-inovasi.validator.document.view', $lampiran['aspek_manufaktur'][$key]->id) }}" 
                                        target="_blank" 
                                        class="document-preview">
                                        Lihat Dokumen
                                    </a>
                    ...
                    @foreach([
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @if(isset($lampiran['aspek_investasi'][$key]))
                                <div class="mt-2">
                                    <span>File terupload:</span>
                                    <a href="{{ route('subdirektorat-inovasi.validator.document.view', $lampiran['aspek_investasi'][$key]->id) }}" 
                                        target="_blank" 
                                        class="document-preview">
                                        Lihat Dokumen
                                    </a>
