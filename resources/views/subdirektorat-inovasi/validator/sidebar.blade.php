...
<section id="sidebar">
    ...
    <div class="brand">
        ...
        <i class="logo-icon"></i>
        <span class="text">Dashboard Validator</span>
    </div>
    ...
    <nav class="side-navigation">
        ...
        <div class="menu-section">
            ...
            <ul class="side-menu">
                <li class="{{ request()->routeIs('subdirektorat-inovasi.validator.dashboard') ? 'active' : '' }}">
                    <a href="{{ route('subdirektorat-inovasi.validator.dashboard') }}">
        ...
        <div class="menu-section">
            ...
            <ul class="side-menu">
                ...
                <li class="{{ request()->routeIs('subdirektorat-inovasi.validator.form') ? 'active' : '' }}">
                    <a href="{{ route('subdirektorat-inovasi.validator.form') }}">
        ...
        <div class="menu-section">
            ...
            <ul class="side-menu">
                <li class="{{ request()->routeIs('subdirektorat-inovasi.validator.SDGs.program_kegiatan') ? 'active' : '' }}">
                    <a href="{{ route('subdirektorat-inovasi.validator.SDGs.program_kegiatan') }}">
                        <i class='bx bxs-graduation'></i>
                        <span class="text">Program</span>
                    </a>
                </li>
                <li class="{{ request()->routeIs('subdirektorat-inovasi.validator.SDGs.publikasi_riset') ? 'active' : '' }}">
                    <a href="{{ route('subdirektorat-inovasi.validator.SDGs.publikasi_riset') }}">
                        <i class='bx bxs-graduation'></i>
