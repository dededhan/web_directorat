                    ...
                    <div class="card-body">
                        <div class="indicators-wrapper">
                            ...
                            <div class="indicator-card" data-indicator="1">
                                ...
                                <div class="mt-3">
                                    @include('subdirektorat-inovasi.validator.indikator1')
                                </div>
                            </div>
                            ...
                            <div class="indicator-card" data-indicator="2">
                                <h4 class="indicator-header"></h4>
                                <div class="mt-3">
                                    @include('subdirektorat-inovasi.validator.indikator2')
                                </div>
                            </div>
                            ...
                            <div class="indicator-card" data-indicator="3">
                                <h4 class="indicator-header"></h4>
                                <div class="mt-3">
                                    @include('subdirektorat-inovasi.validator.indikator3')
                                </div>
                            </div>
                            ...
                            <div class="indicator-card" data-indicator="4">
                                <h4 class="indicator-header"></h4>
                                <div class="mt-3">
                                    @include('subdirektorat-inovasi.validator.indikator4')
                                </div>
                            </div>
                            ...
                            <div class="indicator-card" data-indicator="5">
                                <h4 class="indicator-header"></h4>
                                <div class="mt-3">
                                    @include('subdirektorat-inovasi.validator.indikator5')
                                </div>
                            </div>
                            ...
                            <div class="indicator-card" data-indicator="6">
                                <h4 class="indicator-header"></h4>
                                <div class="mt-3">
                                    @include('subdirektorat-inovasi.validator.indikator6')
                                </div>
                            </div>
                        </div>
                    </div>
