        ...
        <div class="content position-relative">
            ...
            ">
                ...
                <tr class="row-t">
                    ...
                    <td><input type="radio" name="indikator1_row1" class="radio-input" value="0" @checked($indicatorOne->isNotEmpty() && $indicatorOne[0]->score == 0)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row1" class="radio-input" value="1" @checked($indicatorOne->isNotEmpty() && $indicatorOne[0]->score == 1)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row1" class="radio-input" value="2" @checked($indicatorOne->isNotEmpty() && $indicatorOne[0]->score == 2)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row1" class="radio-input" value="3" @checked($indicatorOne->isNotEmpty() && $indicatorOne[0]->score == 3)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row1" class="radio-input" value="4" @checked($indicatorOne->isNotEmpty() && $indicatorOne[0]->score == 4)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row1" class="radio-input" value="5" @checked($indicatorOne->isNotEmpty() && $indicatorOne[0]->score == 5)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                ...
                <tr class="row-t">
                    ...
                    <td class="aspect-cell">T</td>
                    <td><input type="radio" name="indikator1_row2" class="radio-input" value="0" @checked($indicatorOne->isNotEmpty() && $indicatorOne[1]->score == 0)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row2" class="radio-input" value="1" @checked($indicatorOne->isNotEmpty() && $indicatorOne[1]->score == 1)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row2" class="radio-input" value="2" @checked($indicatorOne->isNotEmpty() && $indicatorOne[1]->score == 2)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row2" class="radio-input" value="3" @checked($indicatorOne->isNotEmpty() && $indicatorOne[1]->score == 3)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row2" class="radio-input" value="4" @checked($indicatorOne->isNotEmpty() && $indicatorOne[1]->score == 4)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row2" class="radio-input" value="5" @checked($indicatorOne->isNotEmpty() && $indicatorOne[1]->score == 5)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                ...
                <tr class="row-t">
                    ...
                    <td class="aspect-cell">T</td>
                    <td><input type="radio" name="indikator1_row3" class="radio-input" value="0" @checked($indicatorOne->isNotEmpty() && $indicatorOne[2]->score == 0)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row3" class="radio-input" value="1" @checked($indicatorOne->isNotEmpty() && $indicatorOne[2]->score == 1)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row3" class="radio-input" value="2" @checked($indicatorOne->isNotEmpty() && $indicatorOne[2]->score == 2)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row3" class="radio-input" value="3" @checked($indicatorOne->isNotEmpty() && $indicatorOne[2]->score == 3)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row3" class="radio-input" value="4" @checked($indicatorOne->isNotEmpty() && $indicatorOne[2]->score == 4)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row3" class="radio-input" value="5" @checked($indicatorOne->isNotEmpty() && $indicatorOne[2]->score == 5)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                ...
                <tr class="row-t">
                    ...
                    <td class="aspect-cell">T</td>
                    <td><input type="radio" name="indikator1_row4" class="radio-input" value="0" @checked($indicatorOne->isNotEmpty() && $indicatorOne[3]->score == 0)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row4" class="radio-input" value="1" @checked($indicatorOne->isNotEmpty() && $indicatorOne[3]->score == 1)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row4" class="radio-input" value="2" @checked($indicatorOne->isNotEmpty() && $indicatorOne[3]->score == 2)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row4" class="radio-input" value="3" @checked($indicatorOne->isNotEmpty() && $indicatorOne[3]->score == 3)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row4" class="radio-input" value="4" @checked($indicatorOne->isNotEmpty() && $indicatorOne[3]->score == 4)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row4" class="radio-input" value="5" @checked($indicatorOne->isNotEmpty() && $indicatorOne[3]->score == 5)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                ...
                <tr class="row-t">
                    ...
                    <td class="aspect-cell">T</td>
                    <td><input type="radio" name="indikator1_row5" class="radio-input" value="0" @checked($indicatorOne->isNotEmpty() && $indicatorOne[4]->score == 0)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row5" class="radio-input" value="1" @checked($indicatorOne->isNotEmpty() && $indicatorOne[4]->score == 1)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row5" class="radio-input" value="2" @checked($indicatorOne->isNotEmpty() && $indicatorOne[4]->score == 2)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row5" class="radio-input" value="3" @checked($indicatorOne->isNotEmpty() && $indicatorOne[4]->score == 3)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row5" class="radio-input" value="4" @checked($indicatorOne->isNotEmpty() && $indicatorOne[4]->score == 4)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row5" class="radio-input" value="5" @checked($indicatorOne->isNotEmpty() && $indicatorOne[4]->score == 5)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                ...
                <tr class="row-m">
                    ...
                    <td><input type="radio" name="indikator1_row6" class="radio-input" value="0" @checked($indicatorOne->isNotEmpty() && $indicatorOne[5]->score == 0)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row6" class="radio-input" value="1" @checked($indicatorOne->isNotEmpty() && $indicatorOne[5]->score == 1)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row6" class="radio-input" value="2" @checked($indicatorOne->isNotEmpty() && $indicatorOne[5]->score == 2)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row6" class="radio-input" value="3" @checked($indicatorOne->isNotEmpty() && $indicatorOne[5]->score == 3)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row6" class="radio-input" value="4" @checked($indicatorOne->isNotEmpty() && $indicatorOne[5]->score == 4)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row6" class="radio-input" value="5" @checked($indicatorOne->isNotEmpty() && $indicatorOne[5]->score == 5)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                ...
                <tr class="row-m">
                    ...
                    <td class="aspect-cell">M</td>
                    <td><input type="radio" name="indikator1_row7" class="radio-input" value="0" @checked($indicatorOne->isNotEmpty() && $indicatorOne[6]->score == 0)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row7" class="radio-input" value="1" @checked($indicatorOne->isNotEmpty() && $indicatorOne[6]->score == 1)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row7" class="radio-input" value="2" @checked($indicatorOne->isNotEmpty() && $indicatorOne[6]->score == 2)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row7" class="radio-input" value="3" @checked($indicatorOne->isNotEmpty() && $indicatorOne[6]->score == 3)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row7" class="radio-input" value="4" @checked($indicatorOne->isNotEmpty() && $indicatorOne[6]->score == 4)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row7" class="radio-input" value="5" @checked($indicatorOne->isNotEmpty() && $indicatorOne[6]->score == 5)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                ...
                <tr class="row-m">
                    ...
                    <td class="aspect-cell">M</td>
                    <td><input type="radio" name="indikator1_row8" class="radio-input" value="0" @checked($indicatorOne->isNotEmpty() && $indicatorOne[7]->score == 0)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row8" class="radio-input" value="1" @checked($indicatorOne->isNotEmpty() && $indicatorOne[7]->score == 1)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row8" class="radio-input" value="2" @checked($indicatorOne->isNotEmpty() && $indicatorOne[7]->score == 2)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row8" class="radio-input" value="3" @checked($indicatorOne->isNotEmpty() && $indicatorOne[7]->score == 3)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row8" class="radio-input" value="4" @checked($indicatorOne->isNotEmpty() && $indicatorOne[7]->score == 4)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row8" class="radio-input" value="5" @checked($indicatorOne->isNotEmpty() && $indicatorOne[7]->score == 5)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                ...
                <tr class="row-o">
                    ...
                    <td><input type="radio" name="indikator1_row9" class="radio-input" value="0" @checked($indicatorOne->isNotEmpty() && $indicatorOne[8]->score == 0)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row9" class="radio-input" value="1" @checked($indicatorOne->isNotEmpty() && $indicatorOne[8]->score == 1)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row9" class="radio-input" value="2" @checked($indicatorOne->isNotEmpty() && $indicatorOne[8]->score == 2)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row9" class="radio-input" value="3" @checked($indicatorOne->isNotEmpty() && $indicatorOne[8]->score == 3)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row9" class="radio-input" value="4" @checked($indicatorOne->isNotEmpty() && $indicatorOne[8]->score == 4)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row9" class="radio-input" value="5" @checked($indicatorOne->isNotEmpty() && $indicatorOne[8]->score == 5)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                ...
                <tr class="row-o">
                    ...
                    <td class="aspect-cell">O</td>
                    <td><input type="radio" name="indikator1_row10" class="radio-input" value="0" @checked($indicatorOne->isNotEmpty() && $indicatorOne[9]->score == 0)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row10" class="radio-input" value="1" @checked($indicatorOne->isNotEmpty() && $indicatorOne[9]->score == 1)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row10" class="radio-input" value="2" @checked($indicatorOne->isNotEmpty() && $indicatorOne[9]->score == 2)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row10" class="radio-input" value="3" @checked($indicatorOne->isNotEmpty() && $indicatorOne[9]->score == 3)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row10" class="radio-input" value="4" @checked($indicatorOne->isNotEmpty() && $indicatorOne[9]->score == 4)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row10" class="radio-input" value="5" @checked($indicatorOne->isNotEmpty() && $indicatorOne[9]->score == 5)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                ...
                <tr class="row-o">
                    ...
                    <td class="aspect-cell">O</td>
                    <td><input type="radio" name="indikator1_row11" class="radio-input" value="0" @checked($indicatorOne->isNotEmpty() && $indicatorOne[10]->score == 0)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row11" class="radio-input" value="1" @checked($indicatorOne->isNotEmpty() && $indicatorOne[10]->score == 1)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row11" class="radio-input" value="2" @checked($indicatorOne->isNotEmpty() && $indicatorOne[10]->score == 2)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row11" class="radio-input" value="3" @checked($indicatorOne->isNotEmpty() && $indicatorOne[10]->score == 3)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row11" class="radio-input" value="4" @checked($indicatorOne->isNotEmpty() && $indicatorOne[10]->score == 4)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row11" class="radio-input" value="5" @checked($indicatorOne->isNotEmpty() && $indicatorOne[10]->score == 5)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                ...
                <tr class="row-o">
                    ...
                    <td class="aspect-cell">O</td>
                    <td><input type="radio" name="indikator1_row12" class="radio-input" value="0" @checked($indicatorOne->isNotEmpty() && $indicatorOne[11]->score == 0)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row12" class="radio-input" value="1" @checked($indicatorOne->isNotEmpty() && $indicatorOne[11]->score == 1)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row12" class="radio-input" value="2" @checked($indicatorOne->isNotEmpty() && $indicatorOne[11]->score == 2)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row12" class="radio-input" value="3" @checked($indicatorOne->isNotEmpty() && $indicatorOne[11]->score == 3)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row12" class="radio-input" value="4" @checked($indicatorOne->isNotEmpty() && $indicatorOne[11]->score == 4)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row12" class="radio-input" value="5" @checked($indicatorOne->isNotEmpty() && $indicatorOne[11]->score == 5)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                ...
                <tr class="row-mf">
                    ...
                    <td><input type="radio" name="indikator1_row13" class="radio-input" value="0" @checked($indicatorOne->isNotEmpty() && $indicatorOne[12]->score == 0)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row13" class="radio-input" value="1" @checked($indicatorOne->isNotEmpty() && $indicatorOne[12]->score == 1)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row13" class="radio-input" value="2" @checked($indicatorOne->isNotEmpty() && $indicatorOne[12]->score == 2)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row13" class="radio-input" value="3" @checked($indicatorOne->isNotEmpty() && $indicatorOne[12]->score == 3)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row13" class="radio-input" value="4" @checked($indicatorOne->isNotEmpty() && $indicatorOne[12]->score == 4)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator1_row13" class="radio-input" value="5" @checked($indicatorOne->isNotEmpty() && $indicatorOne[12]->score == 5)@if(request()->routeIs('subdirektorat-inovasi.validator.show')) disabled @endif></td>
