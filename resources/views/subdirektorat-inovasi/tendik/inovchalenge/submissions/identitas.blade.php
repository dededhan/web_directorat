                ...
                <div class="p-6">
                                    ...
                                    @else
                                        ...
                                        @else
                                            ...
                                            <button type="button"
                                                ...
                                                }, '{{ route('subdirektorat-inovasi.tendik.inovchalenge.members.update', [$submission, $member]) }}')"
                    ...
                    <div class="border-t border-gray-100 pt-6">
                        ...
                        <div x-show="isEditMode || {{ $currentCount < $maxAnggota ? 'true' : 'false' }}">
                            ...
                            <form method="POST"
                                :action="isEditMode ? editActionUrl : '{{ route('subdirektorat-inovasi.tendik.inovchalenge.members.store', $submission) }}'">
                                @csrf
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p x-show="tipeAnggota && tipeAnggota !== 'tendik' && !isEditMode"
                                    ...
                                    {{-- Auto-fill for tendik: Unit Kerja from profile.institusi --}}
