        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-3">
                <div class="flex items-center gap-3">
                    <a href="{{ $isReadOnly ? route('subdirektorat-inovasi.tendik.inovchalenge.team.show', $submission) : route('subdirektorat-inovasi.tendik.inovchalenge.submissions.show', $submission) }}"
            ...
            <div class="flex gap-6">
                ...
                <div class="flex-1 min-w-0">
                    <form id="tahapForm"
                        action="{{ route('subdirektorat-inovasi.tendik.inovchalenge.submissions.tahap.save', [$submission, $tahap->id]) }}"
                                        ...
                                        <div class="divide-y divide-gray-50">
                                            ...
                                            @else
                                                @foreach ($section->fields as $field)
                                                    <div class="p-5">
                                                        @include('subdirektorat-inovasi.tendik.inovchalenge.submissions._field_input')
                                                    </div>
                                                @endforeach
                                            @endif
                                        </div>
                    ...
                    {{-- Hidden submit form --}}
                    <form id="submitForm"
                        action="{{ route('subdirektorat-inovasi.tendik.inovchalenge.submissions.tahap.submit', [$submission, $tahap->id]) }}"
