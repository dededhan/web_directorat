        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            @if (!$submission->identitasIsComplete())
                <div
                    ...
                    <a href="{{ route('subdirektorat-inovasi.tendik.inovchalenge.submissions.identitas', $submission) }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                @foreach ($submission->submissionTahap->sortBy(fn($st) => $st->tahap->tahap_ke) as $st)
                    ...
                    @endphp
                    <div
                        class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition {{ $timingStatus === 'belum_dibuka' || !$isPrevLolos ? 'opacity-60' : '' }}">
                        {{-- Tahap Header --}}
                        ...
                        <div class="p-5 space-y-3">
                            ...
                            <div class="pt-2">
                                ...
                                @elseif (!$isPrevLolos && $tahap->tahap_ke > 1)
                                    <button disabled
                                        ...
                                        <i class="fas fa-lock mr-1.5"></i> Lolos Tahap {{ $tahap->tahap_ke - 1 }} Dulu
                                    </button>
                                    <p class="text-[10px] text-gray-400 text-center mt-1">Harus dinyatakan lolos tahap
                                        sebelumnya</p>
                                ...
                                @elseif ($isEditable)
                                    <a href="{{ route('subdirektorat-inovasi.tendik.inovchalenge.submissions.tahap', [$submission, $tahap->id]) }}"
