        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <nav class="mb-6">
                <ol class="flex items-center space-x-2 text-sm">
                    <li><a href="{{ route('subdirektorat-inovasi.tendik.inovchalenge.sessions.index') }}"
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
                        ...
                        <div class="flex-shrink-0">
                            @if ($existingSubmission)
                                <a href="{{ route('subdirektorat-inovasi.tendik.inovchalenge.submissions.show', $existingSubmission) }}"
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 text-center">
                ...
                @else
                    <div class="flex flex-col items-center gap-3">
                        ...
                        <form action="{{ route('subdirektorat-inovasi.tendik.inovchalenge.submissions.store', $session) }}"
                            method="POST">
                            @csrf
                            <button type="submit"
