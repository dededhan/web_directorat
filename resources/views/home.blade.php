...
<body>
  ...
  <div class="content">
    ...
    <div class="news">
      <div class="news-item">
        <img alt="News Image 1" height="400" src="https://storage.googleapis.com/a1aa/image/DpPYZVf7AExXa6MH6uVzDQInKn2EkYFy8kLWafEU27ze7JNoA.jpg" width="600"/>
        <div class="news-item-content">
          <p>2023-01-10 08:27:01</p>
          <h3>UNJ-UiTM: Sinergi Dua Negara untuk Kepemimpinan Global</h3>
          <p>Jakarta, Humas UNJ – Universitas Negeri Jakarta (UNJ) sukses menggelar diskusi kolaborasi bertajuk "The Leadership Literacy Program LEAD 2024: Malaysia-Indonesia Nextgen Leadership Vanguard" bersama Universiti Teknologi MARA (UiTM) Malaysia. Acara yang berlangsung di Gedung M. Syafei, lantai 4 pada 10 Januari 2025 ini dihadiri oleh Direktur Kemahasiswaan dan Alumni, Sekretaris Kantor Urusan Internasional, Kepala Bidang [...]</p>
          <a class="read-more" href="#">Baca Selengkapnya</a>
        </div>
      </div>
      <div class="news-sidebar">
        <div class="news-item">
          <img alt="News Image 2" height="400" src="https://storage.googleapis.com/a1aa/image/jdOUqj0qYey5N6DodX1hhb398f2xXSj11L7kHc3gUVGCeJNoA.jpg" width="600"/>
          <div class="news-item-content">
            <p>2023-01-07 13:39:08</p>
            <h3>UNJ Gelar Seminar Penguatan Ekosistem Moderasi Beragama Serta Luncurkan Griya Moderasi Beragama dan Bela Negara</h3>
            <p>Jakarta – Universitas Negeri Jakarta (UNJ) mengadakan seminar bertajuk "Penguatan Ekosistem Moderasi Beragama"...</p>
            <a class="read-more" href="#">Baca Selengkapnya</a>
          </div>
        </div>
        <div class="news-item">
          <img alt="News Image 3" height="400" src="https://storage.googleapis.com/a1aa/image/nC9H1CxRnNa5IhTZoocDnV4m3pmWP2OfuiYeoXeIfbZE4TaQB.jpg" width="600"/>
          <div class="news-item-content">
            <p>2023-01-07 13:39:08</p>
            <h3>Sebanyak 108 Pejabat di Lingkungan UNJ Dilantik, Rektor Beri 5 Pesan Penting</h3>
            <p>Humas UNJ, Jakarta – Sebanyak 108 pejabat di lingkungan Universitas Negeri Jakarta (UNJ) dilantik untuk periode 2024-2029...</p>
            <a class="read-more" href="#">Baca Selengkapnya</a>
          </div>
        </div>
        <div class="news-item">
          <img alt="News Image 4" height="400" src="https://storage.googleapis.com/a1aa/image/MK0fRdgo4cyaLK2zEThybR9kWIP1Ms2wHlQPeCWUGMaAeJNoA.jpg" width="600"/>
          <div class="news-item-content">
            <p>2023-01-07 13:39:08</p>
            <h3>UNJ Gelar Seminar Penguatan Ekosistem Moderasi Beragama Serta Luncurkan Griya Moderasi Beragama dan Bela Negara</h3>
            <p>Jakarta – Universitas Negeri Jakarta (UNJ) mengadakan seminar bertajuk "Penguatan Ekosistem Moderasi Beragama"...</p>
  ...
  <div class="program-container">
    <div class="left-section">
      <div class="header">
        <img alt="Program Dan Layanan Icon" height="30" src="https://storage.googleapis.com/a1aa/image/bUjsvzHgLYKqIlWzBurjLPFj9iDpEZmkYvc5h0Vlz01eekGUA.jpg" width="30"/>
