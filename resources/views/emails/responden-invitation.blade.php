...
<body>
    <div class="container">
        ...
        @if($normalizedCategory == 'academic')
            ...
            <p>If we do not receive a response from you by November 28, 2025, we will assume that consent is not given for your contact details to be shared.</p>
            <p>
            ...
            <p>Apabila kami tidak menerima tanggapan dari Anda sebelum 28 November 2025, kami akan menganggap Anda tidak memberikan persetujuan untuk membagikan data kontak Anda.</p>
            <p>
