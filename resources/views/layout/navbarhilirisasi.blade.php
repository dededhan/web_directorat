    ...
    <div class="container mx-auto flex justify-between items-center py-4 px-6">
        <div class="flex items-center">
            <a href="{{ route('home') }}" class="flex items-center">
                ...
                <img alt="DITISIP Logo" class="h-12 w-auto mx-2" src="{{ asset('images/logoditisip.png') }}" />
        ...
        <ul class="flex space-x-6">
            ...
            <li class="relative group">
                ...
                <ul
                    ...
                    <li><a class="hover:text-yellow-400"
                            href="{{ route('subdirektorat-inovasi.inkubator.inkubator_bisnis_pendidikan') }}">Inkubator
                            Bisnis dan Pendidikan</a></li>
                    <li><a class="hover:text-yellow-400"
                            href="{{ route('subdirektorat-inovasi.inkubator.ekosisteminovasi') }}">Ekosistem Inovasi
                            UNJ</a></li>
                    <li><a class="hover:text-yellow-400"
            ...
            <li class="relative group">
                ...
                <ul
                    class="absolute hidden group-hover:block bg-white text-black py-2 px-4 space-y-2 rounded-lg shadow-lg">
                    <li><a href="#" class="login hover:text-yellow-400" data-bs-toggle="modal"
            ...
            <li class="relative group">
                ...
                <ul
                    class="absolute hidden group-hover:block bg-white text-black py-2 px-4 space-y-2 rounded-lg shadow-lg">
                    <a href="{{ route('subdirektorat-inovasi.riset.unj') }}" class="hover:text-yellow-400">Riset
                        UNJ</a>
    ...
    <div class="flex justify-between items-center py-4 px-4">
        <a href="{{ route('home') }}" class="flex items-center">
            <img alt="University logo" class="h-10 w-10"
                src="https://upload.wikimedia.org/wikipedia/commons/4/46/Lambang_baru_UNJ.png" />
            <img alt="DITISIP Logo" class="h-10 w-auto mx-2" src="{{ asset('images/logoditisip.png') }}" />
...
<div id="mobile-sidebar"
    class="fixed top-0 right-0 w-80 h-full bg-[#186862] z-50 transform translate-x-full transition-transform duration-300 ease-in-out shadow-lg overflow-y-auto">
    ...
    <div class="py-4">
        <ul class="flex flex-col">
            <li><a href="{{ route('home') }}"
                    class="block text-white py-3 px-6 text-lg hover:bg-[#125a54] transition-colors duration-200">Beranda</a>
            </li>

            <li class="sidebar-dropdown">
                <button
                    class="sidebar-dropdown-toggle flex justify-between items-center w-full text-white py-3 px-6 text-lg hover:bg-[#125a54] transition-colors duration-200">
                    <span>Tentang</span>
                    <i class="fas fa-chevron-down transition-transform duration-300"></i>
                </button>
                <ul class="dropdown-content hidden bg-[#135a54] overflow-hidden">
                    <li><a href="{{ route('pimpinan.pimpinan') }}"
                            class="block text-white py-3 px-8 hover:bg-[#0e4c46] transition-colors duration-200 border-l-2 border-transparent hover:border-yellow-400">Pimpinan
                            Direktorat</a></li>
                    <li><a href="{{ route('strukturorganisasi') }}"
                            class="block text-white py-3 px-8 hover:bg-[#0e4c46] transition-colors duration-200 border-l-2 border-transparent hover:border-yellow-400">Struktur
                            Organisasi</a></li>
                    <li><a href="{{ route('tupoksi.tupoksi') }}"
                            class="block text-white py-3 px-8 hover:bg-[#0e4c46] transition-colors duration-200 border-l-2 border-transparent hover:border-yellow-400">Tugas
                            Pokok dan Fungsi</a></li>
                    <li><a href="{{ route('subdirektorat-inovasi.sejarah.sejarah') }}"
                            class="block text-white py-3 px-8 hover:bg-[#0e4c46] transition-colors duration-200 border-l-2 border-transparent hover:border-yellow-400">Profil</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="sidebar-dropdown">
                ...
                <ul class="dropdown-content hidden bg-[#135a54] overflow-hidden">
                    <li><a href="{{ route('sdgscenter') }}"
                            class="block text-white py-3 px-8 hover:bg-[#0e4c46] transition-colors duration-200 border-l-2 border-transparent hover:border-yellow-400">SDGs
                            Activity</a></li>
                    <li><a href="{{ route('subdirektorat-inovasi.inkubator.inkubator_bisnis_pendidikan') }}"
                            class="block text-white py-3 px-8 hover:bg-[#0e4c46] transition-colors duration-200 border-l-2 border-transparent hover:border-yellow-400">Inkubator
                            Bisnis dan Pendidikan</a></li>
                    <li><a href="{{ route('subdirektorat-inovasi.inkubator.ekosisteminovasi') }}"
                            class="block text-white py-3 px-8 hover:bg-[#0e4c46] transition-colors duration-200 border-l-2 border-transparent hover:border-yellow-400">Ekosistem
                            Inovasi UNJ</a></li>
            ...
            <li class="sidebar-dropdown">
                ...
                <ul class="dropdown-content hidden bg-[#135a54] overflow-hidden">
                    <li><a href="#"
                            class="login block text-white py-3 px-8 hover:bg-[#0e4c46] transition-colors duration-200 border-l-2 border-transparent hover:border-yellow-400"
                            data-bs-toggle="modal" data-bs-target="#loginModal">Pengujian Katsinov</a></li>
                    <li><a href="#"
                            class="login block text-white py-3 px-8 hover:bg-[#0e4c46] transition-colors duration-200 border-l-2 border-transparent hover:border-yellow-400"
                            data-bs-toggle="modal" data-bs-target="#loginModal">Pendaftaran Inkubator Bisnis</a></li>
                    <li><a href="#"
                            class="login block text-white py-3 px-8 hover:bg-[#0e4c46] transition-colors duration-200 border-l-2 border-transparent hover:border-yellow-400"
                            data-bs-toggle="modal" data-bs-target="#loginModal">Pengujian/Sertifikasi Produk
                            Inovasi</a></li>
                    <li><a href="#"
                            class="login block text-white py-3 px-8 hover:bg-[#0e4c46] transition-colors duration-200 border-l-2 border-transparent hover:border-yellow-400"
                            data-bs-toggle="modal" data-bs-target="#loginModal">Join Mitra Inovasi UNJ</a></li>
                </ul>
            </li>

            <li><a href="{{ route('Berita.beritahome') }}"
                    class="block text-white py-3 px-6 text-lg hover:bg-[#125a54] transition-colors duration-200">Berita</a>
            </li>
            ...
            <li class="sidebar-dropdown">
                ...
                <ul class="dropdown-content hidden bg-[#135a54] overflow-hidden">
                    <li><a href="https://lppm.unj.ac.id/" target="_blank" rel="noopener noreferrer"
                            class="block text-white py-3 px-8 hover:bg-[#0e4c46] transition-colors duration-200 border-l-2 border-transparent hover:border-yellow-400">Riset
                            UNJ</a></li>
            ...
            <li class="px-6 my-4">
                <button
                    class="login block w-full text-center bg-white text-[#186862] py-2 rounded-md font-medium hover:bg-yellow-400 hover:text-[#186862] transition-colors duration-200"
...
<div id="sidebar-overlay"
    class="fixed inset-0 bg-black/50 z-40 opacity-0 pointer-events-none transition-opacity duration-300 ease-in-out">
</div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        dropdownToggles.forEach(toggle => {
            toggle.addEventListener('click', function(e) {
                ...
                const allDropdownContents = this.closest('ul').querySelectorAll(
                    '.dropdown-content');

                // Close other dropdowns
                allDropdownContents.forEach(content => {
                    if (content !== dropdownContent && !content.classList.contains(
                            'hidden')) {
