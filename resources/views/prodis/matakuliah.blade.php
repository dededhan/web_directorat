...
@section('contentprodis')
    ...
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a class="active" href="{{ route('prodis.matakuliah.index') }}">Input Mata Kuliah</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="table-data">
        <div class="order">
            ...
            <form id="matakuliah-form" action="{{ route('prodis.matakuliah.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="fakultas_display" value="{{ strtoupper($user_info['faculty_code'] ?? '') }}" disabled>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="prodi_display" value="{{ $user_info['prodi_name'] ?? '' }}" disabled>
            ...
            <div class="table-responsive">
                <table class="table table-striped" id="matakuliah-table">
                    ...
                    <tbody id="matakuliah-list">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center">Belum ada data mata kuliah untuk prodi Anda.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="edit_fakultas_display" value="{{ strtoupper($user_info['faculty_code'] ?? '') }}" disabled>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="edit_prodi_display" value="{{ $user_info['prodi_name'] ?? '' }}" disabled>
                                <input type="hidden" name="prodi" id="edit_prodi" value="{{ $user_info['prodi_name'] ?? '' }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="form-text text-muted">Biarkan kosong jika tidak ingin mengubah file RPS. <span id="current_rps_info_edit_prodi"></span></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 mb-3">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.edit-matakuliah').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    editForm.action = `{{ url('prodis/matakuliah') }}/${matkulId}`;
                    ...
                    fetch(`{{ url('prodi/matakuliah') }}/${matkulId}/detail`, {
                        headers: {
                    ...
                    .then(data => {
                        ...
                        const currentRpsInfoEditProdi = document.getElementById('current_rps_info_edit_prodi');
                        if (data.rps_path) {
                            currentRpsInfoEditProdi.innerHTML = `File saat ini: <a href="/storage/${data.rps_path}" target="_blank">${data.rps_path.split('/').pop()}</a>`;
                        } else {
                            currentRpsInfoEditProdi.innerHTML = '<em>Tidak ada file RPS terunggah.</em>';
                        }
            ...
            document.querySelectorAll('.delete-matakuliah').forEach(button => {
                button.addEventListener('click', function(e) {
                    ...
                    deleteForm.action = `{{ url('prodi/matakuliah') }}/${matkulId}`;
