...
@section('contentprodi')
            ...
            <form id="sustainability-form" method="POST" action="{{ route('prodi.sustainability.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ strtoupper($user_info['faculty_code'] ?? '') }}" disabled>
                        <input type="hidden" name="fakultas" value="{{ $user_info['faculty_code'] ?? '' }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Program Studi</label>
                        <input type="text" class="form-control" value="{{ $user_info['prodi_name'] ?? '' }}" disabled>
                        <input type="hidden" name="prodi" value="{{ $user_info['prodi_name'] ?? '' }}">
                    </div>
                </div>
                <div class="row">
    ...
    <div class="table-data mt-4">
        <div class="order">
            <div class="head"><h3>Daftar Kegiatan Sustainability Anda</h3></div>
            <div class="table-responsive">
                <table class="table table-striped" id="sustainability-table">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr><td colspan="7" class="text-center">Belum ada data kegiatan.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
