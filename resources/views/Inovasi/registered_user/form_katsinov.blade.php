...
<body x-data="aspectLegend()" x-init="init()">
    ...
    <button type="button" style="background-color: #176369; color: white; padding: 10px 20px; border: none; cursor: pointer;">Lampiran</button>
            ...
            {{-- @dd($indicator) --}}
            @include('Inovasi.registered_user.indikator1')
            @include('Inovasi.registered_user.indikator2')
            @include('Inovasi.registered_user.indikator3')
            @include('Inovasi.registered_user.indikator4')
            @include('Inovasi.registered_user.indikator5')
            @include('Inovasi.registered_user.indikator6')
            @include('Inovasi.registered_user.jumlahindikator')
            <!-- Submit All Button -->
            @if (!$katsinov)    
