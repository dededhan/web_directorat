<footer class="text-white" style="background-color: #004d40;">
    <div class="container mx-auto p-6">
        <div class="flex flex-wrap justify-between">
            <!-- University Info Section -->
            <div class="w-full md:w-1/3 mb-8 md:mb-0 flex flex-col items-center md:items-start">
                <div class="flex items-center mb-4">
                    <div class="bg-white rounded-full p-2 mr-3" style="width: 60px; height: 60px;">
                    ...
                    <h3 class="text-xl font-bold">Universitas Negeri Jakarta</h3>
                </div>
                
                <p class="mb-6 text-sm opacity-80">
                    Pusat Inovasi dan Teknologi Universitas Negeri Jakarta
                </p>
            ...
            <div class="w-full md:w-1/3">
                ...
                <div class="h-64 w-full rounded-lg overflow-hidden shadow-lg">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.507858284444!2d106.87609567499013!3d-6.19652469379116!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f492ebd4c571%3A0x1300caf054b25550!2sGedung%20M.Syafe&#39;i%20Universitas%20Negeri%20Jakarta!5e0!3m2!1sid!2sid!4v1742964176588!5m2!1sid!2sid" 
