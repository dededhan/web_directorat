...
<nav class="navbar hidden md:block sticky top-0 z-50 bg-[#186862] shadow-md" style="font-family: 'Arial', sans-serif;">
...
<nav class="navbar md:hidden fixed top-0 w-full z-20 bg-[#186862] shadow-md" id="mobile-navbar" style="font-family: 'Arial', sans-serif;">
    <div class="relative">
        <!-- Content -->
...
<div id="mobile-sidebar"
    class="fixed top-0 right-0 w-64 h-full bg-[#186862] z-40 transform translate-x-full transition-transform duration-300 ease-in-out shadow-lg overflow-y-auto" style="font-family: 'Arial', sans-serif;">
    <!-- Sidebar Header -->
