    ...
    <div class="mb-6 md:mb-8">
        <div class="bg-gradient-to-r from-[#11A697] to-[#0e8a7c] rounded-xl shadow-lg p-6 md:p-8 text-white">
            <div class="flex items-start space-x-4">
                ...
                <div class="flex-1">
                    <h1 class="text-2xl md:text-3xl lg:text-4xl font-bold mb-2">Manajemen Proposal Hibah Modul</h1>
                    <p class="text-white/90 text-sm md:text-base">Daftar proposal hibah modul ajar yang ditugaskan untuk Anda review</p>
                </div>
            </div>
        </div>
    </div>
            ...
            @if($proposals->isEmpty())
                <div class="bg-gray-50 rounded-xl border-2 border-dashed border-gray-300 p-8 md:p-12 text-center">
                    <div class="flex flex-col items-center">
                        ...
                        <p class="text-sm md:text-base text-gray-500 max-w-md">Belum ada proposal hibah modul yang ditugaskan kepada Anda saat ini.</p>
                    </div>
                </div>
            @else
                {{-- Desktop Table View --}}
                <div class="hidden lg:block overflow-x-auto">
                    <table class="min-w-full bg-white">
                        <thead class="bg-gradient-to-r from-gray-100 to-gray-50">
                            <tr>
                                <th class="py-4 px-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Judul Modul</th>
                                <th class="py-4 px-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Dosen Pengaju</th>
                                <th class="py-4 px-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Mata Kuliah</th>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="py-4 px-4">
                                    <div class="flex items-start">
                                        <i class='bx bxs-book text-purple-500 text-xl mr-2 mt-1'></i>
                                        <div>
                                            <p class="font-semibold text-gray-800 line-clamp-2">{{ $proposal->judul_modul }}</p>
                                ...
                                <td class="py-4 px-4">
                                    <div class="flex items-center">
                                        <div class="w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center mr-2">
                                            <i class='bx bxs-user text-purple-600'></i>
                                        </div>
                                        <div>
                                ...
                                <td class="py-4 px-4">
                                    <p class="text-sm text-gray-800 font-medium">{{ $proposal->mata_kuliah }}</p>
                                    <p class="text-xs text-gray-500">{{ $proposal->kode_mk ?? '-' }}</p>
                                </td>
                                <td class="py-4 px-4">
                        ...
                        <div class="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                            <div class="p-4 space-y-3">
                                ...
                                <div class="flex items-start space-x-2">
                                    <i class='bx bxs-book text-purple-500 text-xl mt-1'></i>
                                    <div class="flex-1">
                                        <h4 class="font-semibold text-gray-800 line-clamp-2">{{ $proposal->judul_modul }}</h4>
                                        <p class="text-xs text-gray-500 mt-1">
                                            <i class='bx bx-calendar text-xs'></i>
                                            {{ $proposal->created_at->format('d M Y') }}
                                        </p>
                                ...
                                <div class="pt-2 border-t border-gray-100">
                                    ...
                                    <p class="text-sm font-medium text-gray-800">{{ $proposal->mata_kuliah }}</p>
                                </div>
