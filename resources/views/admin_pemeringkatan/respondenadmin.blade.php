...
@section('contentadmin_pemeringkatan')
    ...
    <div class="table-data">
        <div class="order">
            ...
            <form id="survey-form" method="POST" action="{{ route('admin_pemeringkatan.responden.store') }}">
                @csrf
                <div class="row">
        ...
        <div class="table-data mt-4">
            <div class="order">
                <div class="head">
                    <h3>Daftar Respondennn</h3>
                    <div class="d-flex justify-content-end align-items-center">
                        <form method="GET" action="{{ route('admin_pemeringkatan.responden.index') }}" class="me-3 w-100">
                            <div class="row g-2 align-items-center">
                                ...
                                <div class="col-auto">
                                    ...
                                    <a href="{{ route('admin_pemeringkatan.responden.index') }}" class="btn btn-secondary">Reset</a>
                                </div>
                            </div>
    ...
    <div class="modal fade pt-3" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
        <div class="modal-dialog pt-3">
            <div class="modal-content">
                ...
                <form id="importForm" action="{{ route('admin_pemeringkatan.responden.import') }}" method="POST"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.edit-btn').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    const baseUrl = '{{ route('admin_pemeringkatan.responden.edit', ['responden' => ':id']) }}';
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('exportFilteredExcel').addEventListener('click', function() {
                ...
                let url = '{{ route('admin_pemeringkatan.responden.export.excel') }}?';
                const params = [];
            ...
            document.getElementById('exportFilteredCSV').addEventListener('click', function() {
                ...
                let url = '{{ route('admin_pemeringkatan.responden.export.csv') }}?';
                const params = [];
                if (category) params.push(`kategori=${encodeURIComponent(category)}`);
                if (fakultas) params.push(`fakultas=${encodeURIComponent(fakultas)}`);
                if (status) params.push(`status=${encodeURIComponent(status)}`);
