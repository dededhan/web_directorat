...
<div class="p-6 max-w-4xl mx-auto space-y-6">
    ...
    <div>
        <nav class="flex text-sm text-gray-500 mb-2" aria-label="Breadcrumb">
            ...
            <span class="text-gray-800 font-medium">Edit Responden</span>
        </nav>
        <h1 class="text-2xl font-bold text-gray-800 flex items-center gap-2">
            <i class="fas fa-user-edit text-teal-600"></i>
            Edit Responden: {{ $respondent->first_name }} {{ $respondent->last_name }}
        </h1>
        <p class="text-sm text-gray-500 mt-1">
            Perbarui data identitas responden di Bank Pusat.
        </p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-8">
        ...
        <form action="{{ route('admin_pemeringkatan.responden-bank.update', $respondent) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
                    ...
                    <div class="md:col-span-1">
                        ...
                        <select name="title" id="title" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-teal-500">
                            ...
                            @foreach(['Mr.', 'Mrs.', 'Ms.', 'Dr.', 'Prof.'] as $t)
                                <option value="{{ $t }}" {{ old('title', $respondent->title) === $t ? 'selected' : '' }}>{{ $t }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="md:col-span-3">
                        ...
                        <input type="text" name="first_name" id="first_name" required
                               value="{{ old('first_name', $respondent->first_name) }}"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="last_name" id="last_name"
                               value="{{ old('last_name', $respondent->last_name) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" required
                               value="{{ old('email', $respondent->email) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="phone" id="phone"
                               value="{{ old('phone', $respondent->phone) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500">
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="category" id="category" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-teal-500">
                            ...
                            <option value="academic" {{ old('category', $respondent->category) === 'academic' ? 'selected' : '' }}>Academic (Akademisi / Peneliti)</option>
                            <option value="employee" {{ old('category', $respondent->category) === 'employee' ? 'selected' : '' }}>Employer (Pengguna Lulusan / Industri)</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="country" id="country"
                               value="{{ old('country', $respondent->country) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="institution" id="institution"
                               value="{{ old('institution', $respondent->institution) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="company_name" id="company_name"
                               value="{{ old('company_name', $respondent->company_name) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="department" id="department"
                               value="{{ old('department', $respondent->department) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="job_title" id="job_title"
                               value="{{ old('job_title', $respondent->job_title) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500">
                    </div>
                </div>
            </div>
