        ...
        <nav class="hidden sm:flex" aria-label="Breadcrumb">
            <ol role="list" class="flex items-center space-x-4">
                ...
                <li>
                 ...
                 <li>
                    <i class="fas fa-chevron-right flex-shrink-0 h-5 w-5 text-gray-400"></i>
                    <a href="{{ route('admin_pemeringkatan.sulitest_question_banks.show', $question->question_bank_id) }}" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Kelola: {{ $question->questionBank->name }}</a>
                </li>
            </ol>
        </nav>
