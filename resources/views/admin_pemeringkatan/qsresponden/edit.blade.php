...
@section('contentadmin_pemeringkatan')
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{{ route('admin_pemeringkatan.qsresponden.index') }}">QS Responden Table</a>
                </li>
                <li><i class='bx bx-chevron-right'></i></li>
                <li>
    ...
    <div class="table-data">
        <div class="order">
            ...
            <form action="{{ route('admin_pemeringkatan.qsresponden.update', $responden->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('admin_pemeringkatan.qsresponden.index') }}" class="btn btn-secondary me-2">Batal</a>
