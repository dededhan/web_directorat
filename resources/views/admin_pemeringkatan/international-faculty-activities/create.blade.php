...
@section('contentadmin_pemeringkatan')
    <div class="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8 xl:p-10 2xl:p-12">
        <div class="max-w-[1920px] mx-auto">
            <!-- Header -->
            <div class="mb-6">
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">Add New Activity</h1>
                <p class="text-sm text-gray-600 mt-1">Create a new activity or news article about international faculty</p>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
                    ...
                    <p class="text-sm text-blue-100 mt-1">Fill in the details below</p>
                </div>

                <!-- Form -->
                <form action="{{ route('admin_pemeringkatan.international-faculty-activities.store') }}" 
                      method="POST" 
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <textarea name="isi" 
                                          id="isi" 
                                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('isi') border-red-500 @enderror">{{ old('isi') }}</textarea>
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500">
                                    Accepted formats: JPG, PNG, JPEG | Maximum size: 2MB
                                </p>
                                @error('gambar')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                    ...
                    <div class="flex items-center justify-end space-x-4 mt-8 pt-6 border-t border-gray-200">
                        ...
                        <button type="submit" 
                                class="inline-flex items-center px-6 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors shadow-sm">
