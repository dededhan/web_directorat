...
@section('contentadmin_pemeringkatan')
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-2xl font-bold text-white mb-1">Tambah Indikator Pemeringkatan</h1>
                            <p class="text-blue-100 text-sm">Isi formulir untuk menambahkan indikator penilaian baru</p>
                        </div>
                        <i class='bx bx-chart-line text-5xl text-blue-100 opacity-50'></i>
                    </div>
                </div>

                <!-- Form -->
                <form action="{{ route('admin_pemeringkatan.indikator.store') }}" method="POST" class="p-6 sm:p-8" id="createIndikatorForm">
                    @csrf
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea 
                                    ...
                                    placeholder="Tuliskan deskripsi indikator secara lengkap dan detail">{{ old('deskripsi') }}</textarea>
                    ...
                    <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-200">
                        ...
                        <button type="submit" 
                                class="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200 flex items-center shadow-md hover:shadow-lg">
    ...
    <script>
        ...
        document.getElementById('createIndikatorForm').addEventListener('submit', function(e) {
            if (editorInstance) {
