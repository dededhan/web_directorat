...
@section('contentadmin_pemeringkatan')
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-amber-600 to-amber-700 px-6 py-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-2xl font-bold text-white mb-1">Edit Alumni Berdampak</h1>
                            <p class="text-amber-100 text-sm">Perbarui informasi alumni berdampak</p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <input type="text" 
                                       name="judul_berita" 
                                       id="judul_berita" 
                                       value="{{ old('judul_berita', $alumniBerdampak->judul_berita) }}"
                            ...
                            <div>
                                ...
                                <input type="date" 
                                       name="tanggal_berita" 
                                       id="tanggal_berita" 
                                       value="{{ old('tanggal_berita', $alumniBerdampak->tanggal_berita) }}"
                            ...
                            <div>
                                ...
                                <input type="url" 
                                       name="link_berita" 
                                       id="link_berita" 
                                       value="{{ old('link_berita', $alumniBerdampak->link_berita) }}"
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">Biarkan kosong jika tidak ingin mengubah gambar (JPG, PNG, max 2MB)</p>
                                @error('image')
                                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <select name="fakultas" 
                                    ...
                                    @foreach ($faculties as $key => $faculty)
                                        <option value="{{ strtolower($key) }}" {{ old('fakultas', $alumniBerdampak->fakultas) == strtolower($key) ? 'selected' : '' }}>
                                            {{ $faculty['name'] }}
                                        </option>
                                    @endforeach
                                </select>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const currentProdi = "{{ old('prodi', $alumniBerdampak->prodi) }}";
