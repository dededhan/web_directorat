    ...
    <div class="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8 xl:p-10 2xl:p-12">
        <div class="max-w-[1920px] mx-auto">
            ...
            <div class="mb-6 sm:mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">Alumni Berdampak</h1>
                    <p class="text-sm sm:text-base text-gray-600">Kelola berita dan informasi alumni yang berdampak</p>
                </div>
                <a href="{{ route('admin_pemeringkatan.alumni-berdampak.create') }}" 
            ...
            <div class="bg-white rounded-xl shadow-md p-4 sm:p-6 mb-6">
                ...
                <form method="GET" action="{{ route('admin_pemeringkatan.alumni-berdampak.index') }}" class="space-y-4">
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                ...
                                <td class="px-4 py-4 whitespace-nowrap">
                                    <span class="text-sm text-gray-900">{{ \Carbon\Carbon::parse($alumni->tanggal_berita)->format('d M Y') }}</span>
                                </td>
                                <td class="px-4 py-4 whitespace-nowrap">
                            ...
                            <tr>
                                <td colspan="7" class="px-4 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center text-gray-400">
                                        ...
                                        <p class="text-lg font-medium">Belum ada data alumni berdampak</p>
                ...
                <!-- Pagination -->
                @if($alumniBerdampak->hasPages())
                <div class="bg-gray-50 px-6 py-4 border-t border-gray-200">
                    {{ $alumniBerdampak->links() }}
                </div>
                @endif
            </div>
        </div>
