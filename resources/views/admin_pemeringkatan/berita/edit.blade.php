            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-amber-600 to-amber-700 px-6 py-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-2xl font-bold text-white mb-1">Edit Berita</h1>
                            <p class="text-amber-100 text-sm">Perbarui informasi berita</p>
                        </div>
                ...
                <!-- Form -->
                <form action="{{ route('admin_pemeringkatan.berita.update', $berita->id) }}" method="POST" enctype="multipart/form-data" class="p-6 sm:p-8">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="kategori" 
                                    ...
                                    <option value="pemeringkatan" {{ old('kategori', $berita->kategori) == 'pemeringkatan' ? 'selected' : '' }}>Pemeringkatan</option>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea name="isi_berita" 
                                          id="isi_berita" 
                                          rows="10"
                                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('isi_berita') border-red-500 @enderror">{{ old('isi_berita', $berita->isi_berita) }}</textarea>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">Upload gambar cover baru (JPG, PNG, JPEG, max 2MB). Biarkan kosong jika tidak ingin mengubah</p>
                                @error('gambar')
                                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                                ...
                                <div class="mt-4">
                                    ...
                                    <img src="{{ asset('storage/' . $berita->gambar) }}" alt="Current Cover" class="w-48 h-32 object-cover rounded-lg border border-gray-300">
                                </div>
                                @endif
                            </div>
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">Upload gambar tambahan baru (JPG, PNG, JPEG, max 2MB per file)</p>
