            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-2xl font-bold text-white mb-1">Tambah Mahasiswa International</h1>
                            <p class="text-blue-100 text-sm">Isi formulir untuk menambahkan data mahasiswa internasional</p>
                        </div>
                        <i class='bx bx-world text-5xl text-blue-100 opacity-50'></i>
                    </div>
                </div>

                <!-- Form -->
                <form action="{{ route('admin_pemeringkatan.mahasiswa-international.store') }}" method="POST" class="p-6 sm:p-8">
                    @csrf
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="kategori" 
                                    ...
                                    <option value="inbound" {{ old('kategori') == 'inbound' ? 'selected' : '' }}>Inbound (Masuk ke UNP)</option>
                                    <option value="outbound" {{ old('kategori') == 'outbound' ? 'selected' : '' }}>Outbound (Keluar dari UNP)</option>
                                </select>
