...
@section('contentadmin_pemeringkatan')
    ...
    <div class="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8 xl:p-10 2xl:p-12">
        <div class="max-w-[1920px] mx-auto">
            ...
            <!-- Header -->
            <div class="mb-6">
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">Add New Faculty Staff</h1>
                <p class="mt-1 text-sm text-gray-600">Fill in the information below to add new international faculty staff</p>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
                    <h2 class="text-xl font-semibold text-white">Faculty Staff Information</h2>
                    <p class="text-blue-100 text-sm mt-1">Enter complete information about the international faculty member</p>
                </div>

                <!-- Form -->
                <form action="{{ route('admin_pemeringkatan.international-faculty-staff.store') }}" 
                      method="POST" 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                <label for="foto" class="block text-sm font-medium text-gray-700 mb-1">
                                    Photo <span class="text-gray-500 text-xs">(Optional, max 2MB)</span>
                                </label>
                                <input type="file" 
                                       name="foto" 
                                       id="foto" 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="category" 
                                    ...
                                    <option value="fulltime" {{ old('category') == 'fulltime' ? 'selected' : '' }}>Full Time</option>
                                    <option value="adjunct" {{ old('category') == 'adjunct' ? 'selected' : '' }}>Adjunct</option>
                                </select>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 pt-6 border-t border-gray-200">
                        <button type="submit" 
                                class="inline-flex items-center justify-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow-sm transition-colors duration-150 w-full sm:w-auto">
