...
<header class="bg-white shadow-sm">
    <div class="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
        <h1 class="text-lg font-semibold leading-6 text-gray-900">Hasil Tes: {{ $results['test_title'] }}</h1>
    ...
    <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
        <div class="overflow-hidden rounded-lg bg-white shadow">
            <div class="p-6 text-center">
                ...
                <p class="mt-2 text-6xl font-bold tracking-tight text-gray-900">{{ $results['score'] }}</p>
                <p class="mt-3 text-base text-gray-500">
                    Anda menjawab dengan benar <strong>{{ $results['correct_answers'] }}</strong> dari <strong>{{ $results['total_questions'] }}</strong> soal.
                </p>
            </div>
