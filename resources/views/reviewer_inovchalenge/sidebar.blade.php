<div x-data="{
    ...
    <div x-show="mobileOpen || window.innerWidth >= 1024"
        ...
        <div class="flex h-16 flex-shrink-0 items-center justify-between border-b border-gray-700 px-6">
            <a href="{{ route('reviewer_inovchalenge.dashboard') }}" class="flex items-center space-x-3 overflow-hidden" x-show="open || mobileOpen">
                <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-cyan-400 to-cyan-600 flex items-center justify-center flex-shrink-0">
            ...
            <a href="{{ route('reviewer_inovchalenge.dashboard') }}" x-show="!open && !mobileOpen" class="mx-auto">
                <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-cyan-400 to-cyan-600 flex items-center justify-center">
                    <i class='bx bxs-star text-white text-lg'></i>
                </div>
            </a>
        ...
        <nav class="flex-1 space-y-2 py-6 px-4 overflow-y-auto">
            <h3 x-show="open || mobileOpen" class="px-3 pb-2 text-[10px] font-semibold uppercase tracking-wider text-gray-500">Menu Utama</h3>
            ...
            <h3 x-show="open || mobileOpen" class="px-3 pb-2 text-[10px] font-semibold uppercase tracking-wider text-gray-500">Navigasi</h3>
