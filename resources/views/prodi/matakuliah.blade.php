...
@section('contentprodi')
    ...
    <div class="table-data">
        <div class="order">
            ...
            <form id="matakuliah-form" action="{{ route('prodi.matakuliah.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                ...
                <div class="table-responsive">
                    <table class="table table-striped" id="matakuliah-table">
                        ...
                        <tbody id="matakuliah-list">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center">Belum ada data mata kuliah untuk prodi Anda.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.edit-matakuliah').forEach(button => {
            button.addEventListener('click', function() {
                ...
                editForm.action = `{{ url('prodi/matakuliah') }}/${matkulId}`; // Correct route for prodi
        ...
        document.querySelectorAll('.delete-matakuliah').forEach(button => {
            button.addEventListener('click', function(e) {
                ...
                deleteForm.action = `{{ url('prodi/matakuliah') }}/${matkulId}`; // Correct route for prodi
