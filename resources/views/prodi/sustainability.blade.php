@extends('prodi.index') {{-- Assuming 'prodi.index' is the correct layout for prodi users --}}

{{-- Include necessary CSS, ensure this path is correct --}}
                ...
                <div class="table-responsive">
                    <table class="table table-striped" id="sustainability-table">
                        ...
                        <tbody id="sustainability-list">
                            ...
                            @empty
                            <tr>
                                <td colspan="6" class="text-center">Belum ada data kegiatan sustainability yang Anda input.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.edit-activity').forEach(button => {
            button.addEventListener('click', function() {
                ...
                editForm.action = `{{ url('prodi/sustainability') }}/${activityId}`; // Correct route for prodi update
        ...
        document.querySelectorAll('.delete-activity').forEach(button => {
            button.addEventListener('click', function() {
                ...
                deleteForm.action = `{{ url('prodi/sustainability') }}/${activityId}`; // Correct route for prodi delete
