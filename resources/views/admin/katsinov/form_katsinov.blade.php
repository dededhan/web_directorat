                ...
                <form id="katsinovForm" method="POST" action="{{ route('katsinov.store') }}" class="mb-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group mb-3">
                                ...
                                <li class="list-group-item">Membantu mengimplementasikan inovasi diatas siklus-hidup yang
                                    lebih efektif</li>
                                <li class="list-group-item">Mengantisipasi persaingan pasar yang semakin sengit</li>
                                <li class="list-group-item">Mengantisipasi tingkat inovasi atau siklus hidup teknologi yang
                                    lebih cepat</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="title"
                                        placeholder="Masukkan nama/judul" value="{{ $katsinov['title'] ?? '' }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="focus_area"
                                        placeholder="Masukkan fokus bidang" value="{{ $katsinov['focus_area'] ?? '' }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="project_name"
                                        placeholder="Masukkan nama proyek" value="{{ $katsinov['project_name'] ?? '' }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="contact"
                                        placeholder="Telp / Fax / email" value="{{ $katsinov['contact'] ?? '' }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="date" id="assessment_date" name="assessment_date"
                                        ...
                                        value="{{ old('assessment_date', isset($katsinov['assessment_date']) ? \Carbon\Carbon::parse($katsinov['assessment_date'])->format('Y-m-d') : date('Y-m-d')) }}"
                                        required>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="aspect-dropdown" x-data="{ isOpen: false, aspectCode: 'P' }">
                                    <div class="card h-100 cursor-pointer">
                                        <div class="card-body d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                <div class="legend-box me-2"
                                                    style="background: linear-gradient(135deg, #ffd1ff 0%, #fab2ff 100%);">
                                                </div>
                    ...
                    <div class="card mb-4">
                        <div class="indicators-wrapper">
                            <div class="indicator-card" data-indicator="1" style="display: block;">
                                <h4
                                        style="
                            ...
                            <div class="indicator-card" data-indicator="2" style="display: none;">
                            ...
                            <div class="indicator-card" data-indicator="3" style="display: none;">
                            ...
                            <div class="indicator-card" data-indicator="4" style="display: none;">
                            ...
                            <div class="indicator-card" data-indicator="5" style="display: none;">
                            ...
                            <div class="indicator-card" data-indicator="6" style="display: none;">
