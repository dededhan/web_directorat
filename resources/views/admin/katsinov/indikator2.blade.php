        ...
        <div class="content position-relative">
            <table class="katsinov-table">
                ...
                <tr class="row-t">
                    ...
                    <td class="aspect-cell">T</td>
                    <td><input type="radio" name="indikator2_row2" class="radio-input" value="0"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[1]->score == 0)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator2_row2" class="radio-input" value="1"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[1]->score == 1)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator2_row2" class="radio-input" value="2"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[1]->score == 2)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator2_row2" class="radio-input" value="3"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[1]->score == 3)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator2_row2" class="radio-input" value="4"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[1]->score == 4)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator2_row2" class="radio-input" value="5"
                ...
                <tr class="row-i"> {{-- This was old row 17, now 16 --}}
                    <td class="row-number">16</td>
                    <td class="aspect-cell">I</td>
                    <td><input type="radio" name="indikator2_row16" class="radio-input"
                            value="0"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[15]->score == 0)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td><input type="radio" name="indikator2_row16" class="radio-input"
                            value="1"
                ...
                <tr class="row-i"> {{-- This was old row 18, now 17 --}}
                    ...
                    <td class="aspect-cell">I</td>
                    <td><input type="radio" name="indikator2_row17" class="radio-input"
                            value="0"
                ...
                <tr class="row-p"> {{-- This was old row 19, now 18 --}}
                    ...
                    <td><input type="radio" name="indikator2_row18" class="radio-input"
                            value="0"
                ...
                <tr class="row-p"> {{-- This was old row 20, now 19 --}}
                    ...
                    <td class="aspect-cell">P</td>
                    <td><input type="radio" name="indikator2_row19" class="radio-input"
                            value="0"
                ...
                <tr class="row-r"> {{-- This was old row 21, now 20 --}}
                    ...
                    <td><input type="radio" name="indikator2_row20" class="radio-input"
                            value="0"
                ...
                <tr class="row-r"> {{-- This was old row 22, now 21 --}}
                    ...
                    <td class="aspect-cell">R</td>
                    <td><input type="radio" name="indikator2_row21" class="radio-input"
                            value="0"
