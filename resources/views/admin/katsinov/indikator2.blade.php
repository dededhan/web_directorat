            ...
            <table class="katsinov-table">
                ...
                <tr class="row-t">
                    ...
                    <td class="aspect-cell">T</td>
                     ...
                     <td data-description="Persiapan pelaksanaan validasi dan uji komponen individu dari teknologi secara terpisah.">
                        <input type="radio" name="indikator2_row1" class="radio-input" value="1"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[0]->score == 1)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Mulai dilakukan validasi dan uji komponen individu dari teknologi secara terpisah di lingkungan laboratorium.">
                        <input type="radio" name="indikator2_row1" class="radio-input" value="2"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[0]->score == 2)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Telah selesai dan lolos validasi dan uji komponen individu dari teknologi secara terpisah di lingkungan laboratorium.">
                        <input type="radio" name="indikator2_row1" class="radio-input" value="3"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[0]->score == 3)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    ...
                    <td data-description="Telah selesai dan lolos validasi dan uji di lingkungan laboratorium dan simulasi.">
                        <input type="radio" name="indikator2_row1" class="radio-input" value="5"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[0]->score == 5)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                ...
                <tr class="row-t">
                    ...
                    <td class="aspect-cell">T</td>
                        <td data-description="Belum dilakukan demonstrasi purnarupa (Prototype) a (alpha) pada lingkungan yang relevan.">
                                <input type="radio" name="indikator2_row2" class="radio-input" value="0"
                                @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[1]->score == 0)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                        ...
                        <td data-description="Telah diperoleh purnarupa (Prototype) a (alpha), diketahui kondisi lingkungan operasi, serta keberhasilan modeling & simulasi untuk kinerja sistem.">
                                ...
                                @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[1]->score == 3)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                        <td data-description="Telah dilakukan pengujian Prototype) a (alpha) pada kondisi lingkungan operasi sesungguhnya.">
                                <input type="radio" name="indikator2_row2" class="radio-input" value="4"
                                @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[1]->score == 4)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                        <td data-description="Telah dilakukan pengujian Prototype) a (alpha) dengan diketahui: kondisi lingkungan, kebutuhan investasi, proses fabrikasi, keberhasilan modeling & simulasi, serta hasil uji layak secara teknis (engineering feasibility).">
                                <input type="radio" name="indikator2_row2" class="radio-input" value="5"
                                @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[1]->score == 5)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                ...
                <tr class="row-t">
                    ...
                    <td class="aspect-cell">T</td>
                        ...
                        <td data-description="Tahap persiapan pembuatan purnarupa (Prototype) a (alpha) untuk pengujian teknis.">
                                <input type="radio" name="indikator2_row3" class="radio-input" value="1"
                                @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[2]->score == 1)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                ...
                <tr class="row-t">
                    ...
                    <td class="aspect-cell">T</td>
                  <td data-description="Secara teknis belum memberikan solusi terhadap permasalahan yang dihadapi masyarakat.">
                        <input type="radio" name="indikator2_row5" class="radio-input" value="0"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[4]->score == 0)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Tahap identifikasi kebutuhan solusi terhadap permasalahan yang dihadapi masyarakat.">
                        <input type="radio" name="indikator2_row5" class="radio-input" value="1"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[4]->score == 1)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Sistem yang diajukan cukup praktis karena teknologi yang tersedia cukup untuk diaplikasikan.">
                        <input type="radio" name="indikator2_row5" class="radio-input" value="2"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[4]->score == 2)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                ...
                <tr class="row-m">
                    ...
                    <td data-description="Garis besar materi rencana strategi peluncuran produk ke pasar telah disusun.">
                        <input type="radio" name="indikator2_row7" class="radio-input" value="2"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[6]->score == 2)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    ...
                    <td data-description="Tahap analisi dan finalisasi penyusunan dokumen strategi peluncuran produk ke pasar.">
                        <input type="radio" name="indikator2_row7" class="radio-input" value="4"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[6]->score == 4)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Dokumen strategi peluncuran produk (business plan) yang lengkap mencakup STP dan 4P telah selesai.">
                        <input type="radio" name="indikator2_row7" class="radio-input" value="5"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[6]->score == 5)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                ...
                <tr class="row-m">
                    ...
                    <td data-description="Mulai disiapkan penyusunan rincian modal intelektual."><input
                            type="radio" name="indikator2_row8" class="radio-input" value="2"
                    ...
                    <td data-description="Rincian modal intelektual telah disiapkan dan diuraikan tidak secara lengkap.">
                        <input type="radio" name="indikator2_row8" class="radio-input" value="4"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[7]->score == 4)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Rincian modal intelektual telah disiapkan dan diuraikan secara lengkap.">
                        <input type="radio" name="indikator2_row8" class="radio-input" value="5"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[7]->score == 5)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                   ...
                   <td data-description="Belum disusun analisis dan rencana bisnis."><input type="radio"
                    ...
                    <td data-description="Telah diselesaikan analisis bisnis, dan tahap penyelesaian rencana bisnis">
                        <input type="radio" name="indikator2_row9" class="radio-input" value="4"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[8]->score == 4)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                ...
                <tr class="row-o">
                   ...
                   <td data-description="Tidak memiliki dan melibatkan individu-individu kunci."><input
                    ...
                    <td data-description="Memiliki beberapa individu kunci yang memiliki keahlian unik, tetapi tidak dilibatkan secara aktif.">
                        <input type="radio" name="indikator2_row10" class="radio-input" value="1"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[9]->score == 1)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Memiliki beberapa individu kunci dengan keahlian uniknya, tetapi kurang diberikan tanggung jawab pada posisi strategis.">
                        <input type="radio" name="indikator2_row10" class="radio-input" value="2"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[9]->score == 2)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Memiliki beberapa individu kunci dengan keahlian uniknya dan diberikan tanggung jawab pada posisi yang strategis.">
                        <input type="radio" name="indikator2_row10" class="radio-input" value="3"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[9]->score == 3)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Memiliki individu-individu kunci dengan keahlian uniknya yang sulit digantikan (berkaitan dengan jumlah), tetapi belum secara optimal diberikan tanggung jawab pada posisi yang strategis.">
                        <input type="radio" name="indikator2_row10" class="radio-input" value="4"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[9]->score == 4)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Memiliki individu-individu kunci dengani keahlian uniknya yang sulit digantikan (berkaitan dengan jumlah) dan diberikan tanggung jawab pada posisi yang strategis.">
                        <input type="radio" name="indikator2_row10" class="radio-input" value="5"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[9]->score == 5)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                ...
                <tr class="row-o">
                    ...
                    <td class="aspect-cell">O</td>
                     <td data-description="Belum ada persyaratan proyek dan daftar mitra proyek."><input
                            type="radio" name="indikator2_row11" class="radio-input" value="0"
                    ...
                    <td data-description="Dalam proses identifikasi persyaratan proyek dan daftar mitra proyek."><input type="radio"
                            name="indikator2_row11" class="radio-input" value="1"
                    ...
                    <td data-description="Sudah ada persyaratan proyek, tetapi belum ada mitra, atau sebaliknya."><input
                            type="radio" name="indikator2_row11" class="radio-input" value="2"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[10]->score == 2)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Sudah ada persyaratan proyek dan daftar mitra proyek, tetapi belum disetujui."><input type="radio"
                            name="indikator2_row11" class="radio-input" value="3"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[10]->score == 3)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Sudah ada persyaratan proyek dan daftar mitra proyek, dan dalam proses persetujuan."><input
                            type="radio" name="indikator2_row11" class="radio-input" value="4"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[10]->score == 4)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Sudah ada persyaratan proyek dan daftar mitra proyek yang telah disetujui.">
                        <input type="radio" name="indikator2_row11" class="radio-input" value="5"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[10]->score == 5)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                ...
                <tr class="row-o">
                   ...
                   <td data-description="Belum ada tanggung jawab dan persetujuan batas waktu proyek."><input type="radio"
                            name="indikator2_row12" class="radio-input" value="0"
                    ...
                    <td data-description="Dalam proses identifikasi beban dan tanggung jawab dalam pelaksanaan proyek, dan proses penyusunan jadwal."><input type="radio"
                            name="indikator2_row12" class="radio-input" value="1"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[11]->score == 1)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Sudah ada tanggungjawab proyek, tetapi belum ada batas waktu proyek, atau sebaliknya."><input
                            type="radio" name="indikator2_row12" class="radio-input" value="2"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[11]->score == 2)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Sudah ada tanggung jawab dan persetujuan batas waktu proyek, tetapi belum disetujui."><input type="radio"
                            name="indikator2_row12" class="radio-input" value="3"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[11]->score == 3)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Sudah ada penanggungjawab dan batas waktu proyek, dan dalam proses persetujuan."><input
                            type="radio" name="indikator2_row12" class="radio-input" value="4"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[11]->score == 4)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
...
">
                        <input type="radio" name="indikator2_row12" class="radio-input" value="5"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[11]->score == 5)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                ...
                <tr class="row-mf">
                    ...
                    <td class="aspect-cell">Mf</td>
                     <td data-description="Belum diidentifikasi teknologi dan komponen kritikal."><input
                            type="radio" name="indikator2_row13" class="radio-input" value="0"
                    ...
                    <td data-description="Mulai dilakukan identifikasi awal teknologi & komponen kritikal dengan capaian 40%."><input
                            type="radio" name="indikator2_row13" class="radio-input" value="2"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[12]->score == 2)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Identifikasi teknologi dan komponen kritikal dalam penyelesaian dengan capaian 60%."><input
                            type="radio" name="indikator2_row13" class="radio-input" value="3"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[12]->score == 3)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Identifikasi teknologi dan komponen kritikal dalam penyelesaian dengan capaian 80%."><input
                            type="radio" name="indikator2_row13" class="radio-input" value="4"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[12]->score == 4)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Telah secara komplit (capaian 100%) diidentifikasi teknologi dan komponen kritikal."><input
                            type="radio" name="indikator2_row13" class="radio-input" value="5"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[12]->score == 5)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                ...
                <tr class="row-mf">
                   ...
                   <td data-description="Belum dapat diperlihatkan kesiapan sub system/system dalam suatu lingkungan produksi yang relevan."><input type="radio"
                            name="indikator2_row14" class="radio-input" value="0"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[13]->score == 0)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Tahap persiapan awal membangun kesiapan sub system/system dalam suatu lingkungan produksi yang relevan"><input type="radio"
                            name="indikator2_row14" class="radio-input" value="1"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[13]->score == 1)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Telah diperlihatkan kesiapan sub system/system dalam suatu lingkungan produksi yang relevan yang mencakup kesiapan material."><input type="radio"
                            name="indikator2_row14" class="radio-input" value="2"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[13]->score == 2)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Telah diperlihatkan kesiapan sub system/system dalam suatu lingkungan produksi yang relevan yang mencakup kesiapan material dan perkakas "><input
                            type="radio" name="indikator2_row14" class="radio-input" value="3"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[13]->score == 3)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Telah diperlihatkan kesiapan sub system/system dalam suatu lingkungan produksi yang relevan yang mencakup kesiapan material, perkakas dan alat uji prototype."><input
                            type="radio" name="indikator2_row14" class="radio-input" value="4"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[13]->score == 4)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Telah diperlihatkan kesiapan sub system/system dalam suatu lingkungan produksi yang relevan yang mencakup kesiapan material, perkakas, alat uji prototype, dan keahlian personel."><input
                            type="radio" name="indikator2_row14" class="radio-input" value="5"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[13]->score == 5)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                ...
                <tr class="row-i">
                    ...
                    <td class="aspect-cell">I</td>
                     <td data-description="Tidak ada bukti bahwa solusi yang ditawarkan kepada pelanggan memunculkan daya tarik yang menguntungkan di pasar."><input type="radio"
                            name="indikator2_row15" class="radio-input" value="0"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[14]->score == 0)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Memiliki keunggulan nilai jual namun belum melakukan survey pasar."><input type="radio"
                            name="indikator2_row15" class="radio-input" value="1"
                    ...
                    <td data-description="Keunggulan nilai jual (value proposition) sedang di uji terap melalui survey pasar."><input type="radio"
                            name="indikator2_row15" class="radio-input" value="2"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[14]->score == 2)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Memiliki keunggulan nilai jual dibanding dengan kompetitor untuk pasar yang terbatas."><input type="radio"
                            name="indikator2_row15" class="radio-input" value="3"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[14]->score == 3)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Keunggulan nilai jual (value proposition) sedang diverifikasi dan divalidasi melalui uji terap untuk pasar yang lebih luas."><input type="radio"
                            name="indikator2_row15" class="radio-input" value="4"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[14]->score == 4)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Memiliki keunggulan dibanding kompetitor dan teruji dalam survey pasar yang lebih luas."><input
                            type="radio" name="indikator2_row15" class="radio-input" value="5"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[14]->score == 5)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                ...
                <tr class="row-i"> {{-- This was old row 17, now 16 --}}
                    ...
                    <td class="aspect-cell">I</td>
                     <td data-description="Tidak ada bukti bahwa solusi yang ditawarkan kepada pelanggan memunculkan daya tarik yang menguntungkan di pasar."><input type="radio"
                            name="indikator2_row16" class="radio-input" value="0"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[15]->score == 0)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Ide yang dikembangkan menjadi prototype sesuai dengan kebutuhan pelanggan."><input type="radio"
                            name="indikator2_row16" class="radio-input" value="1"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[15]->score == 1)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Prototype yang dikembangkan memiliki nilai lebih dibanding kompetitor."><input
                            type="radio" name="indikator2_row16" class="radio-input" value="2"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[15]->score == 2)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Prototype yang dikembangkan dilakukan uji pasar"><input
                            type="radio" name="indikator2_row16" class="radio-input" value="3"
                    ...
                    <td data-description="Diperoleh proyeksi keuntungan dari prototype yang dikembangkan."><input type="radio"
                            name="indikator2_row16" class="radio-input" value="5"
                ...
                <tr class="row-i"> {{-- This was old row 18, now 17 --}}
                    ...
                    <td class="aspect-cell">I</td>
                     <td data-description="Tidak ada bukti dilakukannya: validasi value proposition, channel, segmen pelanggan, model hubungan dengan pelanggan yang ada, dan aliran revenue."><input
                            type="radio" name="indikator2_row17" class="radio-input" value="0"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[16]->score == 0)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    ...
                    <td data-description="Telah ditetapkan channel dan model hubungan dengan pelanggan yang ada."><input type="radio"
                            name="indikator2_row17" class="radio-input" value="2"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[16]->score == 2)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    ...
                    <td data-description="Telah dilakukan validasi antara MPV, segmen pelanggan, channel, hubungan dengan pelanggan yang ada dan aliran revenue."><input
                            type="radio" name="indikator2_row17" class="radio-input" value="4"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[16]->score == 4)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Bukti-bukti yang ada saling berkaitan dalam menentukan aliran revenue."><input
                            type="radio" name="indikator2_row17" class="radio-input" value="5"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[16]->score == 5)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                ...
                <tr class="row-p"> {{-- This was old row 19, now 18 --}}
                    ...
                    <td data-description="Belum dilakukan penggalian informasi dan seleksi mitra."><input type="radio"
                            name="indikator2_row18" class="radio-input" value="0"
                    ...
                    <td data-description="Diperoleh database mitra, dan penyusunan kriteria untuk seleksi mitra."><input
                            type="radio" name="indikator2_row18" class="radio-input" value="2"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[17]->score == 2)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    ...
                    <td data-description="Diperoleh database mitra dan kriteria seleksi mitra, serta mulai dilakukan seleksi mitra.">
                        <input type="radio" name="indikator2_row18" class="radio-input" value="4"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[17]->score == 4)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                    <td data-description="Telah dilakukan penggalian informasi dan seleksi mitra, dan telah diperoleh database mitra, kriteria seleksi mitra dan calon mitra potensial hasil seleksi.">
                        <input type="radio" name="indikator2_row18" class="radio-input" value="5"
                            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[17]->score == 5)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                ...
                <tr class="row-p"> {{-- This was old row 20, now 19 --}}
                    ...
                    <td class="aspect-cell">P</td>
                     <td data-description="Belum terbangun pola kemitraan yang tepat."><input type="radio" name="indikator2_row19" class="radio-input"
            value="0"
            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[18]->score == 0)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
        <td data-description="Mengkaji konsep pola kemitraan."><input type="radio" name="indikator2_row19" class="radio-input"
            value="1"
            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[18]->score == 1)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
        <td data-description="Telah diperoleh konsep pola kemitraan yang lebih tepat."><input type="radio" name="indikator2_row19" class="radio-input"
            value="2"
            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[18]->score == 2)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
        <td data-description="Validasi konsep pola kemitraan yang lebih tepat."><input type="radio" name="indikator2_row19" class="radio-input"
            value="3"
            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[18]->score == 3)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
        <td data-description="Upaya pembangunan pola kemitraan berdasar konsep yang disusun."><input type="radio" name="indikator2_row19" class="radio-input"
            value="4"
            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[18]->score == 4)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
        <td data-description="Telah dibangun pola kemitraan yang lebih tepat dalam pengembangan usaha untuk mencapai tujuan bisnis bersama."><input type="radio" name="indikator2_row19" class="radio-input"
            value="5"
            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[18]->score == 5)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
...
<td data-description="Tidak ada kajian risiko teknologi dan tidak menjadi pertimbangan dalam setiap tahap pengembangan teknologi."><input type="radio" name="indikator2_row20" class="radio-input"
            value="0"
            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[19]->score == 0)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
        <td data-description="Sedang disusun materi penelitian atau kajian risiko teknologi dalam setiap tahap pengembangan teknologi."><input type="radio" name="indikator2_row20" class="radio-input"
            value="1"
            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[19]->score == 1)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
        <td data-description="Kajian risiko teknologi pada setiap tahap pengembangan teknologi telah selesai (belum menjadi pertimbangan)."><input type="radio" name="indikator2_row20" class="radio-input"
            value="2"
            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[19]->score == 2)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
        <td data-description="Kajian risiko telah menjadi pertimbangan dalam beberapa tahap pengembangan teknologi."><input type="radio" name="indikator2_row20" class="radio-input"
            value="3"
            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[19]->score == 3)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
        <td data-description="Kajian risiko telah menjadi pertimbangan dalam hampir setiap tahap pengembangan teknologi."><input type="radio" name="indikator2_row20" class="radio-input"
            value="4"
            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[19]->score == 4)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
        <td data-description="Kajian risiko telah menjadi pertimbangan dalam setiap tahap pengembangan teknologi."><input type="radio" name="indikator2_row20" class="radio-input"
            value="5"
            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[19]->score == 5)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                ...
                <tr class="row-r"> {{-- This was old row 22, now 21 --}}
                    ...
                    <td class="aspect-cell">R</td>
                            <td data-description="Tidak disusun rencana pengendalian risiko teknologi pada tahap pengembangan teknologi."><input type="radio" name="indikator2_row21" class="radio-input"
            value="0"
            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[20]->score == 0)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
        <td data-description="Memiki ide/gagasan pengendalian risiko teknologi pada tahap pengembangan teknologi."><input type="radio" name="indikator2_row21" class="radio-input"
            value="1"
            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[20]->score == 1)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
        <td data-description="Garis besar materi rencana pengendalian risiko teknologi pada tahap tahap pengembangan teknologi telah disusun."><input type="radio" name="indikator2_row21" class="radio-input"
            value="2"
            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[20]->score == 2)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
        <td data-description="Mulai menyusun rencana pengendalian risiko teknologi pada tahap pengembangan teknologi."><input type="radio" name="indikator2_row21" class="radio-input"
            value="3"
            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[20]->score == 3)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
        <td data-description="Tahap penyelesaian penyusunan rencana pengendalian risiko teknologi pada tahap pengembangan teknologi."><input type="radio" name="indikator2_row21" class="radio-input"
            value="4"
            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[20]->score == 4)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
        <td data-description="Tersusun rencana pengendalian risiko teknologi pada tahap tahap pengembangan teknologi."><input type="radio" name="indikator2_row21" class="radio-input"
            value="5"
            @checked($indicatorTwo->isNotEmpty() && $indicatorTwo[20]->score == 5)@if (request()->routeIs('admin.katsinov.show')) disabled @endif></td>
                ...
                <tr class="total-row">
                    ...
                    <td colspan="1" style="text-align: left; padding-left: 10px;">
                        <a
                            href="{{ route('admin.katsinov.lampiran.index', ['katsinov_id' => $katsinov['id'] ?? null]) }}"
