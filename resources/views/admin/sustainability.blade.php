                                ...
                                <td>
                                    <div class="btn-group">
                                        <button class="btn btn-sm btn-warning edit-activity" 
                                                data-id="{{ $activity->id }}"
                                                {{-- data-judul, data-tanggal etc. will be fetched via AJAX now for consistency --}}
        ...
        document.querySelectorAll('.edit-activity').forEach(button => {
            button.addEventListener('click', function() {
                ...
                .then(data => {
                    ...
                    // Trigger change on fakultas to populate prodi in edit modal via sustainability_dashboard.js
                    // Ensure sustainability_dashboard.js listens to change on #edit_fakultas and populates #edit_prodi
                    const event = new Event('change');
                    editFakultasSelect.dispatchEvent(event);
                    
                    // Set prodi after a short delay to allow population
                    setTimeout(() => {
