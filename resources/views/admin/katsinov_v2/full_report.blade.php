...
<div class="container-fluid p-6">
            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.katsinov-v2.show', $katsinov->id) }}">Detail</a></li>
    ...
    <div class="card shadow-sm">
        <div class="card-body text-center">
            ...
            <a href="{{ route('admin.katsinov-v2.show', $katsinov->id) }}" class="btn btn-secondary btn-lg">
