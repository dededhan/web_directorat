...
<div class="container-fluid p-6">
            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.katsinov-v2.index') }}">KATSINOV V2</a></li>
                        <li class="breadcrumb-item active">Summary</li>
                    </ol>
                </nav>
            </div>
            <div>
                <a href="{{ route('admin.katsinov-v2.show', $katsinov->id) }}" class="btn btn-secondary">
    ...
    <div class="card mb-4 shadow-sm">
        <div class="card-body text-center">
            ...
            <a href="{{ route('admin.katsinov-v2.print', $katsinov->id) }}" target="_blank" class="btn btn-primary me-2">
                <i class='bx bx-printer'></i> Print Proposal
            </a>
            @if($katsinov->status === 'completed')
                <a href="{{ route('admin.katsinov-v2.certificate', $katsinov->id) }}" target="_blank" class="btn btn-success">
