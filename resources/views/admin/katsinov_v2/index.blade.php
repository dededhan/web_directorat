                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center gap-2">
                                    ...
                                    @if($katsinov->status === 'draft')
                                        <a href="{{ route('admin.katsinov-v2.edit', $katsinov->id) }}" 
                                    ...
                                    {{-- Laporan Form Katsinov button (Admin/Validator only, submitted or higher status) --}}
                                    ...
                                    @if($katsinov->status === 'completed')
                                        ...
                                        <a href="{{ route('admin.katsinov-v2.download-report', $katsinov->id) }}" 
...
function deleteKatsinov(katsinovId) {
    if (confirm('Apakah Anda yakin ingin menghapus proposal ini? Data tidak dapat dikembalikan!')) {
        fetch(`/admin/katsinov-v2/${katsinovId}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '{{ csrf_token() }}'
