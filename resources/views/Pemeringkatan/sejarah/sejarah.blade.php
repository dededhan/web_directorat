...
<div class="main-content">
    <div class="sidebar">
        ...
        <div class="sidebar-item" data-section="visi-misi">Lorem Ipsum</div>
        <div class="sidebar-item" data-section="struktur-organisasi">Lorem Ipsum</div>
        <div class="sidebar-item" data-section="tujuan">Lorem Ipsum</div>
        <div class="sidebar-item" data-section="dokumen">Lorem Ipsum</div>
        <div class="sidebar-item" data-section="rencana">Lorem Ipsum</div>
    </div>
    
    <div class="content">
        <div id="sejarah" class="content-section active">
            <h1 class="main-title">SEJARAH UNIT PERINGKAT INTERNASIONAL</h1>
