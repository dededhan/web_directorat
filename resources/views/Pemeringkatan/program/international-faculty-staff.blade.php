    ...
    <div class="faculty-page pt-16">
        <div class="faculty-hero">
            <div class="faculty-hero-content">
                <h2 class="text-4xl font-bold mb-4 text-center">International Faculty Staff</h2>
                <p class="text-xl">Program pertukaran dan kolaborasi staf pengajar internasional untuk meningkatkan
                    kualitas pendidikan dan memperkuat budaya internasional di lingkungan Universitas Negeri Jakarta.
                </p>
            </div>
        </div>
        ...
        <div class="container mx-auto px-6 py-8">
            <section class="faculty-section">
                ...
                <p class="mb-4">Program International Faculty Staff merupakan inisiatif strategis UNJ untuk memperkaya
                    lingkungan akademik melalui kehadiran tenaga pengajar internasional. Program ini memberikan
                    kesempatan bagi UNJ untuk mendatangkan pengajar berkualitas dari berbagai negara sekaligus
                    mengembangkan kapasitas staf pengajar lokal melalui pertukaran pengetahuan dan budaya.</p>
                <p>Melalui program ini, UNJ berupaya menciptakan lingkungan akademik yang lebih global, meningkatkan
                    kemampuan bahasa asing civitas akademika, dan memperkenalkan perspektif internasional dalam proses
                    pembelajaran dan penelitian.</p>
            </section>
                ...
                <div class="faculty-cards">
                    <div class="faculty-card">
                        ...
                        <div class="faculty-card-content">
                            ...
                            <p>Program yang mendatangkan profesor dari universitas mitra luar negeri untuk memberikan
                                kuliah, melakukan penelitian bersama, dan membangun kerja sama akademik selama 1-3
                                bulan.</p>
                    ...
                    <div class="faculty-card">
                        ...
                        <div class="faculty-card-content">
                            ...
                            <p>Rekrutmen dosen tetap dari berbagai negara untuk memperkuat kurikulum internasional dan
                                menciptakan lingkungan pembelajaran multikultural di kampus UNJ.</p>
                            <a href="#" class="faculty-btn">Pelajari Lebih Lanjut</a>
                        </div>
                    </div>
                    <div class="faculty-card">
                        ...
                        <div class="faculty-card-content">
                            ...
                            <p>Program pertukaran staf akademik dengan universitas mitra luar negeri, memberikan
                                kesempatan bagi dosen UNJ untuk mengajar di luar negeri dan menerima dosen dari
                                universitas mitra.</p>
                            <a href="#" class="faculty-btn">Pelajari Lebih Lanjut</a>
                        </div>
                    </div>
                ...
                <div class="faculty-grid">
                    ...
                    <div class="faculty-profile">
                        <div class="faculty-profile-header">
                            ...
                            <div class="faculty-profile-info">
                                <div class="faculty-profile-name">Prof. Madya Dr. Norba'yah binti Abdul Kadir</div>
                                ...
                                <div class="faculty-profile-origin">
                                    <img src="https://cdn.countryflags.com/thumbs/malaysia/flag-400.png"
                                        alt="Malaysia Flag">
                                    <span>Pusat Kajian Psikologi & Kesejahteraan Manusia, Universiti Kebangsaan
                                        Malaysia</span>
                                </div>
                            </div>
                        </div>
                        <div class="faculty-profile-body">
                            <div class="faculty-profile-section">
                                ...
                                <p>Health Psychology dan Kesehatan Mental</p>
                            </div>
                            <div class="faculty-tag">QS WUR: 138</div>
                            <div class="faculty-tag">QS Subject: 301-350 (Psychology)</div>
                    ...
                    <div class="faculty-profile">
                        ...
                        <div class="faculty-profile-body">
                            ...
                            <div class="faculty-tag">QS Subject: 102 (Engineering)</div>
                    ...
                    <div class="faculty-profile">
                        ...
                        <div class="faculty-profile-body">
                            ...
                            <div class="faculty-tag">QS WUR: 181</div>
                            <div class="faculty-tag">QS Subject: 249 (Social Sciences)</div>
                    ...
                    <div class="faculty-profile">
                        ...
                        <div class="faculty-profile-body">
                            ...
                            <div class="faculty-tag">QS Subject: 201-250 (Business)</div>
                            <div class="faculty-tag">Scopus: 13</div>
                        </div>
                    </div>

                    <!-- Assoc. Prof. Dr. Abdul Rahim bin Zumrah -->
                    <div class="faculty-profile">
                        <div class="faculty-profile-header">
                            <div class="faculty-profile-avatar">
                                <i class="fas fa-user-tie"></i>
                            ...
                            <div class="faculty-profile-info">
                                <div class="faculty-profile-name">Assoc. Prof. Dr. Abdul Rahim bin Zumrah</div>
                                <div class="faculty-profile-position">Fakultas Ekonomi dan Bisnis (FEB)</div>
                                <div class="faculty-profile-origin">
                                    <img src="https://cdn.countryflags.com/thumbs/malaysia/flag-400.png"
                                        alt="Malaysia Flag">
                    ...
                    <div class="faculty-profile">
                        ...
                        <div class="faculty-profile-body">
                            ...
                            <div class="faculty-tag">QS Subject: 401-450 (Business)</div>
                            <div class="faculty-tag">Scopus: 3</div>
                        </div>
                    </div>

                    <!-- Prof. Ditte Winther Lindqvist -->
                    <div class="faculty-profile">
                        <div class="faculty-profile-header">
                            <div class="faculty-profile-avatar">
                                <i class="fas fa-user-tie"></i>
                            ...
                            <div class="faculty-profile-info">
                                <div class="faculty-profile-name">Prof. Ditte Winther Lindqvist</div>
                                <div class="faculty-profile-position">Pascasarjana</div>
                                <div class="faculty-profile-origin">
                                    <img src="https://cdn.countryflags.com/thumbs/denmark/flag-400.png"
                                        alt="Denmark Flag">
                        ...
                        <div class="faculty-profile-body">
                            ...
                            <div class="faculty-tag">QS WUR: 144</div>
                            <div class="faculty-tag">QS Subject: 19 (Arts)</div>
                            <div class="faculty-tag">Scopus: 7</div>
                        </div>
                    </div>
                        ...
                        <div class="faculty-profile-header">
                            ...
                            <div class="faculty-profile-info">
                                ...
                                <div class="faculty-profile-origin">
                                    ...
                                    <span>California State Polytechnic University</span>
                                </div>
                            </div>
                        </div>
                        <div class="faculty-profile-body">
                    ...
                    <div class="faculty-profile">
                        <div class="faculty-profile-header">
                            ...
                            <div class="faculty-profile-info">
                                ...
                                <div class="faculty-profile-position">Pascasarjana</div>
                                <div class="faculty-profile-origin">
                                    <img src="https://cdn.countryflags.com/thumbs/china/flag-400.png"
                                        alt="China Flag">
                                    <span>Central China Normal University (CCNU)</span>
                                </div>
                            </div>
                        </div>
                        <div class="faculty-profile-body">
                    ...
                    <div class="faculty-profile">
                        <div class="faculty-profile-header">
                            ...
                            <div class="faculty-profile-info">
                                <div class="faculty-profile-name">Prof. Liv Torunn Grindheim</div>
                                <div class="faculty-profile-position">Pascasarjana</div>
                                <div class="faculty-profile-origin">
                                    <img src="https://cdn.countryflags.com/thumbs/norway/flag-400.png"
                                        alt="Norway Flag">
                                    <span>Western Norway University of Applied Sciences</span>
                                </div>
                            </div>
                        </div>
                        <div class="faculty-profile-body">
                    ...
                    <div class="faculty-profile">
                        <div class="faculty-profile-header">
                            ...
                            <div class="faculty-profile-info">
                                ...
                                <div class="faculty-profile-position">FMIPA</div>
                                <div class="faculty-profile-origin">
                        ...
                        <div class="faculty-profile-body">
                            ...
                            <div class="faculty-tag">Scopus: 26</div>
                        </div>
                    </div>

                    <!-- Assoc. Prof. Mohd Hafiz Bin Arzmi -->
                    <div class="faculty-profile">
                        <div class="faculty-profile-header">
                            <div class="faculty-profile-avatar">
                                <i class="fas fa-user-tie"></i>
                            ...
                            <div class="faculty-profile-info">
                                <div class="faculty-profile-name">Assoc. Prof. Mohd Hafiz Bin Arzmi</div>
                                <div class="faculty-profile-position">FMIPA</div>
                                <div class="faculty-profile-origin">
                                    <img src="https://cdn.countryflags.com/thumbs/malaysia/flag-400.png"
                                        alt="Malaysia Flag">
                        ...
                        <div class="faculty-profile-body">
                            ...
                            <div class="faculty-tag">QS WUR: 661-670</div>
                            <div class="faculty-tag">QS Subject: 551-600 (Medicine)</div>
                        </div>
                    </div>
                    ...
                    <div class="faculty-profile">
                        <div class="faculty-profile-header">
                            ...
                            <div class="faculty-profile-info">
                                <div class="faculty-profile-name">Prof. Jungshan Chang</div>
                                <div class="faculty-profile-position">FMIPA</div>
                                <div class="faculty-profile-origin">
                        ...
                        <div class="faculty-profile-body">
                            ...
                            <div class="faculty-tag">QS Subject: 201-250 (Medicine)</div>
                        </div>
                    </div>
            </section>
                ...
                <div class="faculty-benefits">
                    <div class="faculty-benefit">
                        ...
                        <div class="faculty-benefit-content">
                            ...
                            <p>Menciptakan suasana belajar multikultural yang memperluas wawasan dan perspektif
                                mahasiswa serta dosen UNJ dalam memahami isu-isu global.</p>
                        </div>
                    </div>
                    <div class="faculty-benefit">
                        <div class="faculty-benefit-icon">
                        ...
                        <div class="faculty-benefit-content">
                            ...
                            <p>Memberikan kesempatan praktik komunikasi dalam bahasa asing (terutama Bahasa Inggris)
                                secara langsung dalam konteks akademik.</p>
                        </div>
                    </div>
                    <div class="faculty-benefit">
                        <div class="faculty-benefit-icon">
                        ...
                        <div class="faculty-benefit-content">
                            ...
                            <p>Membuka akses untuk melakukan penelitian bersama dengan institusi bergengsi dunia,
                                meningkatkan kualitas dan visibilitas publikasi ilmiah UNJ.</p>
                        </div>
                    </div>
                    <div class="faculty-benefit">
                        <div class="faculty-benefit-icon">
                        ...
                        <div class="faculty-benefit-content">
                            ...
                            <p>Memfasilitasi pertukaran metode pengajaran, pendekatan penelitian, dan pengetahuan
                                terkini dari universitas terkemuka dunia.</p>
                        </div>
                    </div>
                    <div class="faculty-benefit">
                        <div class="faculty-benefit-icon">
                        ...
                        <div class="faculty-benefit-content">
                            ...
                            <p>Meningkatkan parameter internasionalisasi yang menjadi indikator penting dalam
                                pemeringkatan universitas global.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="faculty-section">
                ...
                <div class="faculty-process">
                    <div class="faculty-process-step">
                        ...
                        <p>Analisis kebutuhan pengajar internasional berdasarkan program studi, kurikulum, dan rencana
                            strategis pengembangan UNJ.</p>
                    </div>
                    <div class="faculty-process-step">
                        <div class="faculty-process-step-number">2</div>
                        <div class="faculty-process-step-title">Publikasi Lowongan</div>
                        <p>Pengumuman rekrutmen melalui jaringan universitas mitra, portal akademik internasional, dan
                            asosiasi profesional global.</p>
                    </div>
                    <div class="faculty-process-step">
                        <div class="faculty-process-step-number">3</div>
                        <div class="faculty-process-step-title">Seleksi Kandidat</div>
                        <p>Proses evaluasi kandidat berdasarkan kualifikasi akademik, pengalaman mengajar, publikasi
                            ilmiah, dan profil penelitian.</p>
                    </div>
                    <div class="faculty-process-step">
                        <div class="faculty-process-step-number">4</div>
                        <div class="faculty-process-step-title">Wawancara & Demo Mengajar</div>
                        <p>Asesmen kemampuan pengajaran dan komunikasi kandidat melalui wawancara dan demonstrasi
                            mengajar virtual/tatap muka.</p>
                    </div>
                    <div class="faculty-process-step">
                        <div class="faculty-process-step-number">5</div>
                        <div class="faculty-process-step-title">Onboarding & Orientasi</div>
                        <p>Program pengenalan UNJ, sistem akademik, budaya Indonesia, dan dukungan adaptasi kehidupan di
                            Jakarta.</p>
                    </div>
                </div>
            </section>
                ...
                <div class="mt-8">
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start">
                            ...
                            <p>Peningkatan parameter internasionalisasi dalam pemeringkatan QS World University Rankings
                            </p>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-teal-600 mt-1 mr-3"></i>
                            <p>Peningkatan jumlah matakuliah yang disampaikan dalam Bahasa Inggris dari 15 menjadi 47
                                matakuliah</p>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-teal-600 mt-1 mr-3"></i>
                            <p>Bertambahnya jumlah mahasiswa internasional sebesar 35% berkat ketersediaan program
                                dengan pengajar internasional</p>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-check-circle text-teal-600 mt-1 mr-3"></i>
                            <p>Pengembangan 8 program kerja sama double degree dan joint degree dengan universitas mitra
                            </p>
                        </li>
                    </ul>
                </div>
            ...
            <section
                ...
                <p class="mb-6 max-w-3xl mx-auto">UNJ selalu terbuka untuk menjalin kerja sama dengan akademisi dan
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    <a href="#"
                        class="bg-white text-teal-800 px-6 py-3 rounded-lg font-medium transition-all duration-300 hover:bg-yellow-400 hover:text-teal-900">Informasi
                        Rekrutmen</a>
                    <a href="#"
                        class="bg-white text-teal-800 px-6 py-3 rounded-lg font-medium transition-all duration-300 hover:bg-yellow-400 hover:text-teal-900">Institutional
                        Partnership</a>
                    <a href="#"
                        class="bg-white text-teal-800 px-6 py-3 rounded-lg font-medium transition-all duration-300 hover:bg-yellow-400 hover:text-teal-900">Hubungi
                        Kami</a>
                </div>
            </section>
        </div>
