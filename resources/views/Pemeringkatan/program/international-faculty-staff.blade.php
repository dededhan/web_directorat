...
<body class="min-h-screen">
        ...
        <section class="faculty-hero flex items-center justify-center text-center text-white">
            <div class="container mx-auto px-6 py-20">
                <div>
                    ...
                    <p class="text-xl max-w-3xl mx-auto opacity-90">Program pertukaran dan kolaborasi staf pengajar internasional untuk meningkatkan kualitas pendidikan dan memperkuat budaya internasional di lingkungan Universitas Negeri Jakarta.</p>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="card group">
                        <div class="h-48 overflow-hidden relative">
                            <img src="https://i.ibb.co/TqLnQZp/visiting-professor.jpg" alt="Visiting Professor mengajar di kelas" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                        ...
                        <div class="p-6">
                            ...
                            <p class="mb-4 text-gray-600">Program yang mendatangkan profesor dari universitas mitra luar negeri untuk memberikan kuliah, melakukan penelitian bersama, dan membangun kerja sama akademik selama 1-3 bulan.</p>
                            <a href="#" class="inline-flex items-center text-teal-700 font-medium hover:text-teal-800 transition-colors">
                                <span>Pelajari Lebih Lanjut</span>
                    ...
                    <div class="card group">
                        <div class="h-48 overflow-hidden relative">
                            <img src="https://i.ibb.co/hFw71Sp/international-lecturer.jpg" alt="International Lecturer berdiskusi dengan mahasiswa" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
                                <div class="p-4 text-white">
                        ...
                        <div class="p-6">
                            ...
                            <p class="mb-4 text-gray-600">Rekrutmen dosen tetap dari berbagai negara untuk memperkuat kurikulum internasional dan menciptakan lingkungan pembelajaran multikultural di kampus UNJ.</p>
                            <a href="#" class="inline-flex items-center text-teal-700 font-medium hover:text-teal-800 transition-colors">
                                <span>Pelajari Lebih Lanjut</span>
                                <i class="fas fa-arrow-right ml-2 text-sm"></i>
                            </a>
                    ...
                    <div class="card group">
                        <div class="h-48 overflow-hidden relative">
                            <img src="https://i.ibb.co/3YHdggL/expert-exchange.jpg" alt="Expert Exchange Program dengan dosen luar negeri" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
                                <div class="p-4 text-white">
                        ...
                        <div class="p-6">
                            ...
                            <p class="mb-4 text-gray-600">Program pertukaran staf akademik dengan universitas mitra luar negeri, memberikan kesempatan bagi dosen UNJ untuk mengajar di luar negeri dan menerima dosen dari universitas mitra.</p>
                            <a href="#" class="inline-flex items-center text-teal-700 font-medium hover:text-teal-800 transition-colors">
                                <span>Pelajari Lebih Lanjut</span>
                                <i class="fas fa-arrow-right ml-2 text-sm"></i>
                            </a>
    ...
    <div class="relative mb-8">
        <input type="text" placeholder="Cari profesor berdasarkan nama atau bidang keahlian..." class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent">
...
<div class="faculty-profile bg-white rounded-xl overflow-hidden shadow-sm" data-faculty="FPsi">
    <div class="p-6 border-b border-gray-100">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <h3 class="font-semibold text-lg text-teal-700">Prof. Madya Dr. Norba'yah binti Abdul Kadir</h3>
                <div class="text-sm text-gray-600 mt-1">Fakultas Psikologi (FPsi)</div>
                <div class="flex items-center mt-2">
                    <img src="https://cdn.countryflags.com/thumbs/malaysia/flag-400.png" alt="Malaysia Flag" class="country-flag">
...
<div class="faculty-profile bg-white rounded-xl overflow-hidden shadow-sm" data-faculty="FT">
    <div class="p-6 border-b border-gray-100">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <h3 class="font-semibold text-lg text-teal-700">Prof. Ir. Dr. Sitti Asmah Binti Hassan</h3>
    ...
    <div class="p-6 border-b border-gray-100">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <div class="flex items-center mt-2">
                    <img src="https://cdn.countryflags.com/thumbs/bangladesh/flag-400.png" alt="Bangladesh Flag" class="country-flag">
...
<div class="faculty-profile bg-white rounded-xl overflow-hidden shadow-sm" data-faculty="FEB">
    <div class="p-6 border-b border-gray-100">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <h3 class="font-semibold text-lg text-teal-700">Assoc. Prof. Dr. Abdul Rahim bin Zumrah</h3>
                <div class="text-sm text-gray-600 mt-1">Fakultas Ekonomi dan Bisnis (FEB)</div>
                <div class="flex items-center mt-2">
                    <img src="https://cdn.countryflags.com/thumbs/malaysia/flag-400.png" alt="Malaysia Flag" class="country-flag">
    ...
    <div class="p-6 border-b border-gray-100">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <div class="text-sm text-gray-600 mt-1">Fakultas Ekonomi dan Bisnis (FEB)</div>
                <div class="flex items-center mt-2">
                    <img src="https://cdn.countryflags.com/thumbs/jordan/flag-400.png" alt="Jordan Flag" class="country-flag">
    ...
    <div class="p-6 border-b border-gray-100">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <div class="flex items-center mt-2">
                    <img src="https://cdn.countryflags.com/thumbs/malaysia/flag-400.png" alt="Malaysia Flag" class="country-flag">
                    <span class="text-sm text-gray-600">Graduate Business School, Universiti Teknologi Mara (UiTM)</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="p-6 border-b border-gray-100">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <div class="text-sm text-gray-600 mt-1">Fakultas Matematika dan Ilmu Pengetahuan Alam (FMIPA)</div>
                <div class="flex items-center mt-2">
                    <img src="https://cdn.countryflags.com/thumbs/taiwan/flag-400.png" alt="Taiwan Flag" class="country-flag">
...
<div class="faculty-profile bg-white rounded-xl overflow-hidden shadow-sm" data-faculty="FMIPA">
    <div class="p-6 border-b border-gray-100">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <h3 class="font-semibold text-lg text-teal-700">Assoc. Prof. Dr. Muhammad Irfan Ashraf</h3>
                <div class="text-sm text-gray-600 mt-1">Fakultas Matematika dan Ilmu Pengetahuan Alam (FMIPA)</div>
                <div class="flex items-center mt-2">
                    <img src="https://cdn.countryflags.com/thumbs/pakistan/flag-400.png" alt="Pakistan Flag" class="country-flag">
    ...
    <div class="p-6 border-b border-gray-100">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <div class="text-sm text-gray-600 mt-1">Fakultas Ilmu Sosial dan Humaniora (FISH)</div>
                <div class="flex items-center mt-2">
                    <img src="https://cdn.countryflags.com/thumbs/united-states/flag-400.png" alt="USA Flag" class="country-flag">
...
<!-- Faculty Profile 11 -->
<div class="faculty-profile bg-white rounded-xl overflow-hidden shadow-sm" data-faculty="Pascasarjana">
    <div class="p-6 border-b border-gray-100">
        <div class="flex items-center">
            <div class="faculty-profile-avatar">
                <i class="fas fa-user-tie"></i>
            ...
            <div class="ml-4">
                ...
                <div class="flex items-center mt-2">
                    <img src="https://cdn.countryflags.com/thumbs/china/flag-400.png" alt="China Flag" class="country-flag">
...
<div class="faculty-profile bg-white rounded-xl overflow-hidden shadow-sm" data-faculty="UNJ">
    <div class="p-6 border-b border-gray-100">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <h3 class="font-semibold text-lg text-teal-700">Prof. Dr. rer. Nat. Hesham A. El Enshasy</h3>
                <div class="text-sm text-gray-600 mt-1">Universitas Negeri Jakarta (UNJ)</div>
                <div class="flex items-center mt-2">
                    <img src="https://cdn.countryflags.com/thumbs/egypt/flag-400.png" alt="Egypt Flag" class="country-flag">
                    <span class="text-sm text-gray-600">Universiti Teknologi Malaysia</span>
                </div>
            </div>
        </div>
    ...
    <div class="p-6">
        ...
        <div class="flex flex-wrap mt-3">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="benefit-card">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Menciptakan suasana belajar multikultural yang memperluas wawasan dan perspektif mahasiswa serta dosen UNJ dalam memahami isu-isu global.</p>
                        </div>
                    </div>
                    ...
                    <div class="benefit-card">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Memberikan kesempatan praktik komunikasi dalam bahasa asing (terutama Bahasa Inggris) secara langsung dalam konteks akademik.</p>
                        </div>
                    </div>
                    ...
                    <div class="benefit-card">
                        ...
                        <div>
                            <h3 class="font-semibold text-lg text-teal-700 mb-2">Kolaborasi Penelitian Internasional</h3>
                            <p class="text-gray-600">Membuka akses untuk melakukan penelitian bersama dengan institusi bergengsi dunia, meningkatkan kualitas dan visibilitas publikasi ilmiah UNJ.</p>
                        </div>
                    </div>
                    ...
                    <div class="benefit-card">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Memfasilitasi pertukaran metode pengajaran, pendekatan penelitian, dan pengetahuan terkini dari universitas terkemuka dunia.</p>
                        </div>
                    </div>
                    ...
                    <div class="benefit-card md:col-span-2">
                        ...
                        <div>
                            <h3 class="font-semibold text-lg text-teal-700 mb-2">Peningkatan Reputasi & Peringkat UNJ</h3>
                            <p class="text-gray-600">Meningkatkan parameter internasionalisasi yang menjadi indikator penting dalam pemeringkatan universitas global.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="process" class="mb-20">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="process-card">
                        ...
                        <p class="text-gray-600">Analisis kebutuhan pengajar internasional berdasarkan program studi, kurikulum, dan rencana strategis pengembangan UNJ.</p>
                    </div>
                    ...
                    <div class="process-card">
                        ...
                        <p class="text-gray-600">Pengumuman rekrutmen melalui jaringan universitas mitra, portal akademik internasional, dan asosiasi profesional global.</p>
                    </div>
                    ...
                    <div class="process-card">
                        ...
                        <p class="text-gray-600">Proses evaluasi kandidat berdasarkan kualifikasi akademik, pengalaman mengajar, publikasi ilmiah, dan profil penelitian.</p>
                    </div>
                    ...
                    <div class="process-card">
                        ...
                        <p class="text-gray-600">Asesmen kemampuan pengajaran dan komunikasi kandidat melalui wawancara dan demonstrasi mengajar virtual/tatap muka.</p>
                    </div>
                    ...
                    <div class="process-card">
                        ...
                        <p class="text-gray-600">Program pengenalan UNJ, sistem akademik, budaya Indonesia, dan dukungan adaptasi kehidupan di Jakarta.</p>
                    </div>
                </div>
            </section>
                ...
                <div class="bg-white p-8 rounded-2xl shadow-sm">
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        <div class="flex items-start">
                            <div class="h-10 w-10 rounded-full bg-teal-100 flex items-center justify-center flex-shrink-0 mr-4">
                                <i class="fas fa-chart-bar text-teal-600"></i>
                            </div>
                            <p class="text-gray-700">Peningkatan parameter internasionalisasi dalam pemeringkatan QS World University Rankings</p>
                        </div>
                        <div class="flex items-start">
                            <div class="h-10 w-10 rounded-full bg-teal-100 flex items-center justify-center flex-shrink-0 mr-4">
                                <i class="fas fa-language text-teal-600"></i>
                            </div>
                            <p class="text-gray-700">Peningkatan jumlah matakuliah yang disampaikan dalam Bahasa Inggris dari 15 menjadi 47 matakuliah</p>
                        </div>
                        <div class="flex items-start">
                            <div class="h-10 w-10 rounded-full bg-teal-100 flex items-center justify-center flex-shrink-0 mr-4">
                                <i class="fas fa-users text-teal-600"></i>
                            </div>
                            <p class="text-gray-700">Bertambahnya jumlah mahasiswa internasional sebesar 35% berkat ketersediaan program dengan pengajar internasional</p>
                        </div>
                        <div class="flex items-start">
                            <div class="h-10 w-10 rounded-full bg-teal-100 flex items-center justify-center flex-shrink-0 mr-4">
                                <i class="fas fa-handshake text-teal-600"></i>
                            </div>
                            <p class="text-gray-700">Pengembangan 8 program kerja sama double degree dan joint degree dengan universitas mitra</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <!-- CTA Section -->
            <section class="relative overflow-hidden bg-gradient-to-r from-teal-700 to-teal-800 text-white p-10 rounded-3xl shadow-lg text-center mb-10">
                <div class="absolute top-0 right-0 w-64 h-64 opacity-10">
                    <i class="fas fa-globe-asia text-9xl"></i>
                </div>
                <div class="relative z-10">
                    <h2 class="text-3xl font-bold mb-4">Tertarik untuk Berkolaborasi?</h2>
                    <p class="mb-8 max-w-3xl mx-auto">UNJ selalu terbuka untuk menjalin kerja sama dengan akademisi dan institusi pendidikan tinggi dari seluruh dunia. Bergabunglah dengan komunitas akademik kami dan jadilah bagian dari perjalanan UNJ menuju world-class university.</p>
                    <div class="flex flex-wrap justify-center gap-4">
                        <a href="#" class="bg-white text-teal-800 px-6 py-3 rounded-lg font-medium transition-all duration-300 hover:bg-yellow-400 hover:text-teal-900 shadow-lg hover:shadow-xl flex items-center">
            ...
            filterButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    facultyProfiles.forEach(profile => {
                        if (filterValue === 'all' || profile.getAttribute('data-faculty') === filterValue) {
