            ...
            <div class="modal-content bg-white rounded-3xl overflow-hidden shadow-2xl">
                <div class="modal-container">
                    <div class="left-panel">
                        <img src="https://spm.unj.ac.id/wp-content/uploads/2024/08/cropped-Logo-UNJ-PTNBH-RGB_Logo_Motto_Transparan.png" alt="UNJ Logo" class="h-16 mb-5"/>
                        <h1 class="text-2xl font-semibold text-teal-800 mb-4">Sign In</h1>
                        <p class="text-gray-600 text-sm mb-6">Welcome to the Admin Portal. Please login with your credentials to access the system.</p>
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <button type="submit" class="btn-primary w-full py-3 rounded-lg text-white font-medium tracking-wide mt-3">SIGN IN</button>
                        </form>
                        <a href="#" class="text-center block mt-5 text-teal-800 text-sm hover:text-teal-900 hover:underline transition-all duration-300">Forgot Your Password?</a>
                    </div>
                    <div class="right-panel">
                        <h2 class="text-3xl font-semibold mb-8 relative">UNJ Dashboard
                            <span class="absolute left-0 bottom-0 w-10 h-0.5 bg-yellow-400" style="bottom: -10px;"></span>
                        </h2>
