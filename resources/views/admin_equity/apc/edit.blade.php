...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <header class="mb-8">
            ...
            <div>
                <h1 class="text-2xl lg:text-3xl font-bold text-gray-800">Edit Sesi APC</h1>
                <p class="mt-2 text-gray-600 text-base">Lakukan perubahan pada detail sesi APC di bawah ini.</p>
            </div>
        </header>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <form method="POST" action="{{ route('admin_equity.apc.update', $session->id) }}">
                @csrf
                @method('PUT')
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="dana_display" class="pl-9 pr-4 py-3 w-full text-gray-800 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition" value="{{ old('dana', number_format($session->dana, 0, ',', '.')) }}" required>
                                    <input type="hidden" name="dana" id="dana" value="{{ old('dana', $session->dana) }}">
                                </div>
