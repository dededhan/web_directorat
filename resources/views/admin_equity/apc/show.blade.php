    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100" x-data="sessionDetail">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <header class="mb-10">
                ...
                <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                    <div>
                        ...
                        <p class="mt-2 text-gray-600 text-base">Kelola semua pengajuan APC yang masuk dalam sesi ini.</p>
                    </div>
                    <div class="flex items-center space-x-4 flex-shrink-0">
                        ...
                        <div
                            class="bg-white bg-opacity-80 backdrop-blur-sm px-4 py-2.5 rounded-xl border-2 border-teal-200">
                            <p class="text-xs font-bold uppercase tracking-wide text-teal-700">Total Pengajuan</p>
                            <p class="text-lg font-bold text-teal-800">{{ $submissions->total() }} Pengajuan</p>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden mb-8">
                ...
                <div class="p-6">
                    <form action="{{ route('admin_equity.apc.show', $session->id) }}" method="GET">
                        ...
                        <div class="mt-8 flex items-center justify-end space-x-4">
                            <a href="{{ route('admin_equity.apc.export') }}" 
                ...
                <div class="bg-gradient-to-r from-teal-500 to-teal-600 px-6 lg:px-8 py-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 text-white">
                        <div>
                            ...
                            <p class="mt-2 text-teal-100">Monitor dan verifikasi semua pengajuan yang masuk</p>
                        </div>
                        <div class="flex-shrink-0">
                            <div
                                class="bg-white bg-opacity-20 backdrop-blur-sm px-4 py-2.5 rounded-xl border-2 border-white border-opacity-30">
                                <p class="text-xs font-bold uppercase tracking-wide text-teal-100">Hasil Filter</p>
                                <p class="text-lg font-bold">{{ $submissions->count() }} dari {{ $submissions->total() }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-full overflow-visible">
                        <table class="w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th scope="col"
                                        class="px-6 py-4 text-left text-xs font-bold text-gray-600 uppercase tracking-wider w-[5%]">
                                        No</th>
                                    <th scope="col"
                                        class="px-6 py-4 text-left text-xs font-bold text-gray-600 uppercase tracking-wider w-[20%]">
                                        Fakultas</th>
                                    <th scope="col"
                                        class="px-6 py-4 text-left text-xs font-bold text-gray-600 uppercase tracking-wider w-[25%]">
                                        Dosen Pengusul</th>
                                    <th scope="col"
                                        class="px-6 py-4 text-left text-xs font-bold text-gray-600 uppercase tracking-wider w-[25%]">
                                        Judul Artikel</th>
                                    <th scope="col"
                                        class="px-6 py-4 text-center text-xs font-bold text-gray-600 uppercase tracking-wider w-[15%]">
                                        Status</th>
                                    <th scope="col"
                                        class="px-6 py-4 text-center text-xs font-bold text-gray-600 uppercase tracking-wider w-[10%]">
                                        Aksi</th>
                                </tr>
                            </thead>
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($submissions as $submission)
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        ...
                                        <td class="px-6 py-5">
                                            <p
                                                class="font-medium text-gray-900 text-sm lg:text-base leading-relaxed break-words">
                                        ...
                                        <td class="px-6 py-5 text-center">
                                            ...
                                            <span
                                                class="inline-flex items-center px-2 py-1 rounded-full text-xs font-semibold bg-{{ $statusInfo['color'] }}-100 text-{{ $statusInfo['color'] }}-800 border-2 border-{{ $statusInfo['color'] }}-200">
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-center py-20">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <h3 class="font-bold text-xl text-gray-800 mb-2">Tidak Ada Pengajuan
                                                    Ditemukan</h3>
                                                <p class="text-gray-500 mb-4 max-w-md">Tidak ada data pengajuan yang cocok
                        ...
                        <div class="border-b border-gray-100 last:border-b-0 p-4 hover:bg-gray-50 transition-colors">
                            <div class="flex items-start justify-between mb-3">
                                ...
                                <div class="flex-shrink-0 ml-2">
                                    @php $statusInfo = getStatusInfoAdmin($submission->status); @endphp
                                    <span
                                        class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium border bg-{{ $statusInfo['color'] }}-100 text-{{ $statusInfo['color'] }}-800 border-{{ $statusInfo['color'] }}-200">
                                        <i class='bx {{ $statusInfo['icon'] }} mr-1 text-xs'></i>
                                        {{ $statusInfo['text'] }}
                                    </span>
                                </div>
                            ...
                            <div class="mb-4">
                                <span class="text-xs font-medium text-gray-500 uppercase tracking-wide">Judul
                                    Artikel</span>
                    ...
                    @empty
                        <div class="text-center py-20 px-6">
                            <div class="flex flex-col items-center">
                                ...
                                <h3 class="font-bold text-xl text-gray-800 mb-2">Tidak Ada Pengajuan Ditemukan</h3>
                                <p class="text-gray-500 max-w-md">Tidak ada data pengajuan yang cocok dengan kriteria
                                    filter Anda.</p>
                            </div>
                        </div>
                    @endforelse
