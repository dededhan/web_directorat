            ...
            <div class="bg-gradient-to-r from-teal-500 to-teal-600 px-6 lg:px-8 py-6">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 text-white">
                    <div>
                        ...
                        <p class="mt-2 text-teal-100">Kelola dan monitor semua sesi pendanaan APC</p>
                    </div>
                    <div class="flex-shrink-0">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-5 text-sm text-gray-900">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <p class="font-semibold text-sm">
                                                    Rp {{ number_format($session->dana, 0, ',', '.') }}
                                                </p>
                                        ...
                                        <div x-data="{ open: false }" class="relative inline-block text-left">
                                            ...
                                            <div x-show="open" @click.away="open = false"
                                                ...
                                                <div class="py-1" role="menu" aria-orientation="vertical">
                                                    ...
                                                    <form method="POST" action="{{ route('admin_equity.apc.destroy', $session->id) }}" x-ref="deleteForm{{$session->id}}" class="hidden">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                    @endif
                ...
                @forelse ($sessions as $session)
                    <div class="border-b border-gray-100 last:border-b-0 p-4 hover:bg-gray-50 transition-colors">
                        ...
                        <div class="mb-4 space-y-3">
                            ...
                            <div>
                                <span class="text-xs font-medium text-gray-500 uppercase tracking-wide">Total Dana</span>
                                <p class="text-gray-900 font-semibold flex items-center text-sm">
                ...
                @empty
                    <div class="text-center py-20 px-6">
                        <div class="flex flex-col items-center">
                            ...
                            <h3 class="font-bold text-xl text-gray-800 mb-2">Belum Ada Sesi APC</h3>
                            <p class="text-gray-500 max-w-md">Buat sesi baru untuk memulai program pendanaan Article Processing Cost.</p>
                        </div>
                    </div>
                @endforelse
            </div>
