...
@section('content')
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100" x-data="matchmaking">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 text-white">
                    <div>
                        <h2 class="text-xl lg:text-2xl font-bold flex items-center">
                            ...
                            Daftar Sesi Matchmaking
                        </h2>
                        <p class="mt-2 text-teal-100">Kelola dan monitor semua sesi matchmaking riset</p>
                    </div>
                    <div class="flex-shrink-0">
                                    ...
                                    <td class="px-6 py-5 text-center">
                                        ...
                                        @else
                                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-semibold bg-red-100 text-red-800 border-2 border-red-200">
                                                <i class='bx bxs-x-circle mr-1 text-xs'></i>
                                                Tutup
                                            </span>
                                        @endif
                                    </td>
                                        ...
                                        <div x-data="{ open: false }" class="relative inline-block text-left">
                                            ...
                                            <div x-show="open" @click.away="open = false"
                                                ...
                                                <div class="py-1" role="menu" aria-orientation="vertical">
                                                    ...
                                                    <button @click="confirmDelete('delete-form-{{ $session->id }}'); open = false"
                                                    ...
                                                    <form method="POST" action="{{ route('admin_equity.matchresearch.destroy', $session->id) }}" id="delete-form-{{ $session->id }}" class="hidden">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </div>
                                ...
                                <tr>
                                    <td colspan="5" class="text-center py-20">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <h3 class="font-bold text-xl text-gray-800 mb-2">Belum Ada Sesi Matchmaking</h3>
                                            <p class="text-gray-500 mb-8 max-w-md">Buat sesi baru untuk memulai program matchmaking riset.</p>
                                            <a href="{{ route('admin_equity.matchresearch.create') }}"
                                                class="inline-flex items-center px-4 py-2.5 bg-gradient-to-r from-teal-500 to-teal-600 text-white font-semibold rounded-xl hover:from-teal-600 hover:to-teal-700 transform hover:scale-105 transition-all duration-200 shadow-md hover:shadow-lg">
                                                <i class='bx bxs-add-to-queue mr-2 text-lg'></i>
                                                Buat Sesi Baru
                            ...
                            <div class="flex items-start space-x-3 flex-1 min-w-0">
                                <div class="flex-shrink-0">
                                    <div class="w-8 h-8 bg-gradient-to-br from-blue-100 to-blue-200 rounded-lg flex items-center justify-center">
                                        <i class='bx bx-group text-blue-500 text-lg'></i>
                                    </div>
                                </div>
                                <div class="min-w-0 flex-1">
                ...
                @empty
                    <div class="text-center py-20 px-6">
                        <div class="flex flex-col items-center">
                            ...
                            <h3 class="font-bold text-xl text-gray-800 mb-2">Belum Ada Sesi Matchmaking</h3>
                            <p class="text-gray-500 max-w-md">Buat sesi baru untuk memulai program matchmaking riset.</p>
                        </div>
                    </div>
                @endforelse
            </div>
