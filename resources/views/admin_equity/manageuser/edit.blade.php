                    ...
                    <div x-show="selectedRole === 'dosen'" x-transition class="pt-6 border-t space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select id="fakultas_id" x-model="selectedFakultas" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                            ...
                            <div>
                                ...
                                <select id="prodi_id" name="prodi_id" x-model="selectedProdi" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" :disabled="loadingProdi || !selectedFakultas">
                                    ...
                                    <template x-if="selectedFakultas && !loadingProdi"><option value="">Pilih Program Studi</option></template>
