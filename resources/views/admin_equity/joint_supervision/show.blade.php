    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <header class="mb-8">
            <nav class="text-sm text-gray-500 mb-3">
                <ol class="list-none p-0 inline-flex items-center space-x-2">
                    ...
                    <li><a href="{{ route('admin_equity.joint-supervision.index') }}" class="hover:text-teal-600">Joint Supervision</a></li>
                    <li><i class='bx bx-chevron-right'></i></li>
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('admin_equity.joint-supervision.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 text-gray-700 font-semibold rounded-xl hover:bg-gray-300">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg border p-6 sm:p-8">
                ...
                <form action="{{ route('admin_equity.joint-supervision.updateStatus', $submission->id) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    <div class="space-y-6">
                        <div>
