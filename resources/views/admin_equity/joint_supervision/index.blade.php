...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100" x-data="submissions">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <header class="mb-10">
            ...
            <div>
                <h1 class="text-2xl lg:text-3xl font-bold text-gray-800">Manajemen Proposal: Joint Supervision</h1>
                <p class="mt-2 text-gray-600 text-base">Kelola semua pengajuan proposal dari fakultas untuk program Joint Supervision.</p>
            </div>
        </header>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 text-white">
                    <div>
                        <h2 class="text-xl lg:text-2xl font-bold flex items-center">
                            <i class='bx bx-sitemap mr-3 text-2xl'></i>
                            Daftar Pengajuan
                        </h2>
                    </div>
                    <div class="flex items-center gap-3">
                        <a href="{{ route('admin_equity.joint-supervision.export') }}" class="inline-flex items-center px-4 py-2.5 bg-white text-teal-600 font-semibold rounded-xl hover:bg-teal-50 transition-all shadow-lg">
