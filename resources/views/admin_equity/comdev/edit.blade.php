...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <header class="mb-8">
            ...
            <div>
                <h1 class="text-2xl lg:text-3xl font-bold text-gray-800">Edit Sesi Proposal</h1>
                <p class="mt-2 text-gray-600 text-base">Lakukan perubahan pada detail sesi Community Development di bawah ini.</p>
            </div>
        </header>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="relative">
                                        ...
                                        <input type="number" name="min_anggota" class="pl-10 pr-4 py-3 w-full text-gray-800 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition" placeholder="Min" value="{{ old('min_anggota', $session->min_anggota) }}" required>
                                    </div>
                                    <div class="relative">
                                        <i class='bx bx-user-plus absolute left-3 top-1/2 -translate-y-1/2 text-gray-400'></i>
                                        <input type="number" name="max_anggota" class="pl-10 pr-4 py-3 w-full text-gray-800 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition" placeholder="Max" value="{{ old('max_anggota', $session->max_anggota) }}" required>
                                    </div>
                                </div>
