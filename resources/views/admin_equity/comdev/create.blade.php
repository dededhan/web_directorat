...
<div class="container mx-auto px-4 py-8">
    ...
    {{-- Breadcrumbs --}}
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Buat Sesi Proposal Baru</h1>
        <nav aria-label="breadcrumb">
            <ol class="flex items-center text-sm text-gray-500">
                ...
                <li class="mx-2"><i class='bx bx-chevron-right text-base'></i></li>
                <li class="font-semibold text-gray-700" aria-current="page">Buat Sesi Baru</li>
            </ol>
        </nav>
    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="nama_sesi" id="nama_sesi" class="bg-gray-100 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500" placeholder="Contoh: Hibah Penelitian Comdev 2025" value="{{ old('nama_sesi') }}" required>
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="8" class="bg-gray-100 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500">{{ old('deskripsi') }}</textarea>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <div class="relative mt-1">
                                ...
                                <input type="number" name="dana_maksimal" id="dana_maksimal" class="bg-gray-100 pl-8 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500" placeholder="50000000" value="{{ old('dana_maksimal') }}" required>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center mt-1 space-x-2">
                                <input type="date" name="periode_awal" class="bg-gray-100 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500" value="{{ old('periode_awal') }}" required>
                                <span class="text-gray-500">s/d</span>
                                <input type="date" name="periode_akhir" class="bg-gray-100 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500" value="{{ old('periode_akhir') }}" required>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center mt-1 space-x-2">
                                <input type="number" name="min_anggota" class="bg-gray-100 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500" placeholder="Min" value="{{ old('min_anggota') }}" required>
                                <span class="text-gray-500">-</span>
                                <input type="number" name="max_anggota" class="bg-gray-100 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500" placeholder="Max" value="{{ old('max_anggota') }}" required>
                            </div>
