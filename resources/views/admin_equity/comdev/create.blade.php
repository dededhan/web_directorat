    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <header class="mb-8">
            ...
            <div>
                ...
                <p class="mt-2 text-gray-600 text-base">Isi formulir di bawah ini untuk menambahkan sesi Community Development baru.</p>
            </div>
        </header>
            ...
            <form method="POST" action="{{ route('admin_equity.comdev.store') }}">
                ...
                <div class="p-6 sm:p-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <div class="space-y-6">
                            <div>
                                <label for="nama_sesi" class="block text-sm font-medium text-gray-700 mb-2">Nama Sesi / Skema</label>
                                <div class="relative">
                                    <i class='bx bx-file-blank absolute left-3 top-1/2 -translate-y-1/2 text-gray-400'></i>
                                    <input type="text" name="nama_sesi" id="nama_sesi" class="pl-10 pr-4 py-3 w-full text-gray-800 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition" placeholder="Contoh: Hibah Comdev 2025" value="{{ old('nama_sesi') }}" required>
                                </div>
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="dana_maksimal" id="dana_maksimal" class="pl-9 pr-4 py-3 w-full text-gray-800 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition" placeholder="50000000" value="{{ old('dana_maksimal') }}" required>
                                </div>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Jumlah Anggota Tim (Min-Max)</label>
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="relative">
                                        <i class='bx bx-user-minus absolute left-3 top-1/2 -translate-y-1/2 text-gray-400'></i>
                                        <input type="number" name="min_anggota" class="pl-10 pr-4 py-3 w-full text-gray-800 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition" placeholder="Min" value="{{ old('min_anggota') }}" required>
                                    </div>
                                    <div class="relative">
                                        <i class='bx bx-user-plus absolute left-3 top-1/2 -translate-y-1/2 text-gray-400'></i>
                                        <input type="number" name="max_anggota" class="pl-10 pr-4 py-3 w-full text-gray-800 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition" placeholder="Max" value="{{ old('max_anggota') }}" required>
                                    </div>
                                </div>
                ...
                <div class="flex items-center justify-end mt-4 p-6 sm:p-8 border-t border-gray-100 bg-gray-50/50 rounded-b-2xl space-x-3">
                    <a href="{{ route('admin_equity.comdev.index') }}" class="px-6 py-2.5 bg-gray-200 text-gray-800 font-semibold rounded-xl hover:bg-gray-300 transition-all duration-200">
                        Batal
                    </a>
