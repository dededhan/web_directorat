...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <header class="mb-8">
            ...
            <div>
                <h1 class="text-2xl lg:text-3xl font-bold text-gray-800">Buat Sesi Fee Reviewer Baru</h1>
                <p class="mt-2 text-gray-600 text-base">Isi formulir di bawah ini untuk menambahkan sesi pembayaran insentif reviewer baru.</p>
            </div>
        </header>
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="nama_sesi" id="nama_sesi" class="pl-10 pr-4 py-3 w-full text-gray-800 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition" placeholder="Contoh: Fee Reviewer Q1 2025" required>
                                </div>
                            ...
                            <div>
                                ...
                                <textarea name="deskripsi" id="deskripsi" rows="8" class="p-4 w-full text-gray-800 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition" placeholder="Jelaskan tujuan dan ruang lingkup sesi ini..."></textarea>
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="dana" id="dana_display" class="pl-9 pr-4 py-3 w-full text-gray-800 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition" placeholder="50.000.000" required>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="relative">
                                        ...
                                        <input type="date" name="periode_awal" class="pl-10 pr-4 py-3 w-full text-gray-800 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition" required>
                                    </div>
                                    <div class="relative">
                                        <i class='bx bx-calendar-check absolute left-3 top-1/2 -translate-y-1/2 text-gray-400'></i>
                                        <input type="date" name="periode_akhir" class="pl-10 pr-4 py-3 w-full text-gray-800 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition" required>
                                    </div>
                                </div>
