...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
            ...
            <nav class="mb-4" aria-label="Breadcrumb">
                <ol class="flex items-center space-x-2 text-sm">
                    ...
                    <li class="flex items-center">
                        ...
                        <a href="{{ route('admin_equity.manageprodi.index') }}" class="text-gray-500 hover:text-teal-600 transition-colors duration-200">
                            Manajemen Prodi
                        </a>
                    </li>
                    <li class="flex items-center">
                        <i class='bx bx-chevron-right text-gray-400 mx-2'></i>
                        <span class="font-medium text-gray-800">Tambah Prodi</span>
                    </li>
                </ol>
            </nav>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 lg:p-8">
                <div class="flex items-start space-x-4">
                    <div class="flex-shrink-0 p-3 bg-gradient-to-br from-teal-100 to-teal-100 rounded-xl">
                        <i class='bx bx-plus-circle text-2xl text-teal-600'></i>
                    </div>
                    <div>
                        <h1 class="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">Tambah Prodi Baru</h1>
                        <p class="text-gray-600 text-base lg:text-lg">Tambahkan program studi pada fakultas tertentu</p>
                    </div>
                </div>
            </div>
        </header>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <form method="POST" action="{{ route('admin_equity.manageprodi.store') }}">
                @csrf
                <div class="p-6 lg:p-8 space-y-6">
                    <div>
                        ...
                        <select id="fakultas_id" name="fakultas_id"
                            ...
                            @foreach($fakultas as $fak)
                                <option value="{{ $fak->id }}" @if(old('fakultas_id') == $fak->id) selected @endif>
                                    {{ $fak->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        @enderror
                        <p class="text-xs text-gray-500 mt-2">Nama prodi harus unik di dalam fakultas yang sama.</p>
                    </div>
                </div>
