...
@section('content')
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100" x-data="feeEditor">
                                        ...
                                        <div x-data="{ open: false }" class="relative inline-block text-left">
                                            ...
                                            <div x-show="open" @click.away="open = false"
                                                ...
                                                <div class="py-1" role="menu" aria-orientation="vertical">
                                                    ...
                                                    @if(auth()->user()->role !== 'sub_admin_equity')
                                                    <a href="{{ route('admin_equity.fee_editor.edit', $session->id) }}"
                                                    ...
                                                    <form method="POST" action="{{ route('admin_equity.fee_editor.destroy', $session->id) }}" x-ref="deleteForm{{$session->id}}" class="hidden">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                    @endif
