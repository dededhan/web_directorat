...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <header class="mb-10">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="mt-2 text-gray-600 text-base">Kelola semua laporan Insentif Editor dalam sesi ini.</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden mb-8">
            ...
            <div class="p-6">
                <form action="{{ route('admin_equity.fee_editor.show', $session->id) }}" method="GET">
                    ...
                    <div class="mt-8 flex items-center justify-end space-x-4">
                        <a href="{{ route('admin_equity.fee_editor.export') }}" 
                        ...
                        <a href="{{ route('admin_equity.fee_editor.show', $session->id) }}" 
            ...
            <div class="hidden lg:block overflow-x-auto">
                <table class="w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th scope="col" class="px-6 py-4 text-left text-xs font-bold text-gray-600 uppercase tracking-wider w-[35%]">Jurnal & Peran</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($reports as $report)
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-5 text-center align-top">
                                    <a href="{{ route('admin_equity.fee_editor.report.show', $report->id) }}" 
                ...
                @forelse ($reports as $report)
                    <div class="border-b border-gray-100 last:border-b-0 p-4 hover:bg-gray-50 transition-colors">
                        ...
                        <div class="mb-4 space-y-3">
                            <div>
                                <span class="text-xs font-medium text-gray-500 uppercase tracking-wide">Jurnal & Peran</span>
                                <p class="text-gray-900 font-medium text-sm leading-relaxed mt-1">
                                    {{ $report->nama_jurnal }} ({{ $report->peran }})
                                </p>
                            </div>
                        </div>
