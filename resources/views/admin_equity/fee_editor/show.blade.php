        ...
        <header class="mb-10">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="mt-2 text-gray-600 text-base">Kelola semua fee_editor Dalam Sesi ini</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-teal-500 to-teal-600 px-6 lg:px-8 py-6">
                <div class="flex flex-col gap-4 text-white">
                    ...
                    {{-- Filter Form --}}
                    <form method="GET" action="{{ route('admin_equity.fee_editor.show', $session->id) }}" class="bg-white bg-opacity-20 backdrop-blur-sm rounded-xl p-4">
                        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
                            <div class="lg:col-span-7">
                                ...
                                <input type="text" name="search" id="search" 
                                       ...
                                       placeholder="Nama dosen, nama jurnal, peran editor..." 
