        ...
        <header class="mb-8">
            <nav class="text-sm text-gray-500 mb-3" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex items-center space-x-2">
                    ...
                    <li><a href="{{ route('admin_equity.fee_editor.index') }}" class="hover:text-teal-600 transition-colors duration-200">Manajemen Sesi Fee Editor</a></li>
                    <li><i class='bx bx-chevron-right text-base text-gray-400'></i></li>
                    <li class="font-medium text-gray-800" aria-current="page">Buat Sesi Baru</li>
                </ol>
            </nav>
            <div>
                <h1 class="text-2xl lg:text-3xl font-bold text-gray-800">Buat Sesi Fee Editor Baru</h1>
                <p class="mt-2 text-gray-600 text-base">Isi formulir di bawah ini untuk menambahkan sesi program Fee Editor baru.</p>
            </div>
        </header>
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="nama_sesi" id="nama_sesi" class="pl-10 pr-4 py-3 w-full text-gray-800 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition" placeholder="Contoh: Fee Editor Gelombang 1 2025" value="{{ old('nama_sesi') }}" required>
                                </div>
