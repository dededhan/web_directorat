        ...
        <header class="mb-8">
            <nav class="text-sm text-gray-500 mb-3" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex items-center space-x-2">
                    ...
                    <li><a href="{{ route('admin_equity.fee_editor.index') }}" class="hover:text-teal-600 transition-colors duration-200">Manajemen Sesi Insentif Editor</a></li>
                    <li><i class='bx bx-chevron-right text-base text-gray-400'></i></li>
                    <li class="font-medium text-gray-800" aria-current="page">Buat Sesi Baru</li>
                </ol>
            </nav>
            <div>
                <h1 class="text-2xl lg:text-3xl font-bold text-gray-800">Buat Sesi Insentif Editor Baru</h1>
                <p class="mt-2 text-gray-600 text-base">Isi formulir di bawah ini untuk menambahkan sesi program Insentif Editor baru.</p>
            </div>
        </header>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            <div class="bg-gradient-to-r from-teal-500 to-teal-600 px-6 sm:px-8 py-5">
                <h2 class="text-xl font-bold text-white flex items-center">
                    ...
                    Formulir Sesi Insentif Editor Baru
                </h2>
            </div>

            <form method="POST" action="{{ route('admin_equity.fee_editor.store') }}">
                @csrf
                <div class="p-6 sm:p-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="nama_sesi" id="nama_sesi" class="pl-10 pr-4 py-3 w-full text-gray-800 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition" placeholder="Contoh: Insentif Editor Gelombang 1 2025" value="{{ old('nama_sesi') }}" required>
                                </div>
                        ...
                        <div class="space-y-6">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Periode Pelaporan</label>
                ...
                <div class="flex items-center justify-end mt-4 p-6 sm:p-8 border-t border-gray-100 bg-gray-50/50 rounded-b-2xl space-x-3">
                    <a href="{{ route('admin_equity.fee_editor.index') }}" class="px-6 py-2.5 bg-gray-200 text-gray-800 font-semibold rounded-xl hover:bg-gray-300 transition-all duration-200">
                        Batal
                    </a>
