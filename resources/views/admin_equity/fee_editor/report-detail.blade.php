    ...
    @endif
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 text-sm">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <a href="{{ $report->link_laman_resmi }}" 
                           target="_blank"
                           class="text-teal-600 hover:text-teal-800 hover:underline break-all text-sm">{{ $report->link_laman_resmi }}</a>
                    </div>
                </div>
                ...
                <div class="border-t-2 border-gray-100 pt-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <a href="{{ asset('storage/' . $report->bukti_aktivitas_path) }}" 
                           target="_blank"
        ...
        <div x-show="showStatusModal" 
            ...
            <div @click.away="showStatusModal = false" 
                ...
                {{-- Modal Content --}}
                <div class="p-6">
                    <form action="{{ route('admin_equity.fee_editor.report.updateStatus', $report->id) }}" method="POST" class="space-y-4">
                        @csrf
                        <div>
