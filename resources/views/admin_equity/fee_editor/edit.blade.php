...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <header class="mb-8">
            ...
            <div>
                <h1 class="text-2xl lg:text-3xl font-bold text-gray-800">Edit Sesi Insentif Editor</h1>
                <p class="mt-2 text-gray-600 text-base">Lakukan perubahan pada detail sesi Insentif Editor di bawah ini.</p>
            </div>
        </header>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <form method="POST" action="{{ route('admin_equity.fee_editor.update', $session->id) }}">
                @csrf
                @method('PUT')
