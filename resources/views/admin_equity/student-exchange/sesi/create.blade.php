...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <header class="mb-10">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-800">Buat Sesi Student Exchange</h1>
                <p class="mt-2 text-gray-600">Tambahkan sesi baru untuk pertukaran mahasiswa</p>
            </div>
        </header>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            <div class="bg-gradient-to-r from-teal-500 to-teal-600 px-6 py-4">
                <h2 class="text-xl font-bold text-white flex items-center">
                    <i class='bx bx-plus-circle mr-3 text-2xl'></i>
                    Form Sesi Baru
                </h2>
            </div>

            <form action="{{ route('admin_equity.student_exchange.sesi.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
                ...
                <div class="space-y-2">
                    ...
                    <textarea id="deskripsi" 
                              ...
                              placeholder="Deskripsi singkat tentang sesi student exchange ini...">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <p class="text-red-500 text-sm mt-1 flex items-center">
                            <i class='bx bx-error-circle mr-1'></i>
                            {{ $message }}
