...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <header class="mb-8">
            ...
            <div>
                <h1 class="text-2xl lg:text-3xl font-bold text-gray-800">Buat Sesi Insentif Reviewer Baru</h1>
                <p class="mt-2 text-gray-600 text-base">Isi formulir di bawah ini untuk menambahkan sesi program Insentif Reviewer baru.</p>
            </div>
        </header>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            <div class="bg-gradient-to-r from-teal-500 to-teal-600 px-6 sm:px-8 py-5">
                <h2 class="text-xl font-bold text-white flex items-center">
                    ...
                    Formulir Sesi Insentif Reviewer Baru
                </h2>
            </div>
