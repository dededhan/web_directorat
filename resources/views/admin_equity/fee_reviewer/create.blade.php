    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <header class="mb-8">
            ...
            <div>
                ...
                <p class="mt-2 text-gray-600 text-base">Isi formulir di bawah ini untuk menambahkan sesi program Fee Reviewer baru.</p>
            </div>
        </header>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            <div class="bg-gradient-to-r from-teal-500 to-teal-600 px-6 sm:px-8 py-5">
                <h2 class="text-xl font-bold text-white flex items-center">
                    ...
                    Formulir Sesi Fee Reviewer Baru
                </h2>
            </div>

            <form method="POST" action="{{ route('admin_equity.fee_reviewer.store') }}">
                @csrf
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="nama_sesi" id="nama_sesi" class="pl-10 pr-4 py-3 w-full text-gray-800 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition" placeholder="Contoh: Fee Reviewer Gelombang 1 2025" value="{{ old('nama_sesi') }}" required>
                                </div>
                ...
                <div class="flex items-center justify-end mt-4 p-6 sm:p-8 border-t border-gray-100 bg-gray-50/50 rounded-b-2xl space-x-3">
                    <a href="{{ route('admin_equity.fee_reviewer.index') }}" class="px-6 py-2.5 bg-gray-200 text-gray-800 font-semibold rounded-xl hover:bg-gray-300 transition-all duration-200">
                        Batal
                    </a>
