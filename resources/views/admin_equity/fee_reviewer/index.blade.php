    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <header class="mb-10">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 class="text-2xl lg:text-3xl font-bold text-gray-800">Manajemen Sesi Insentif Reviewer</h1>
                    <p class="mt-2 text-gray-600 text-base">Kelola semua sesi program Insentif Reviewer yang tersedia.</p>
                </div>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 text-white">
                    <div>
                        <h2 class="text-xl lg:text-2xl font-bold flex items-center">
                            ...
                            Daftar Sesi Insentif Reviewer
                        </h2>
                        <p class="mt-2 text-teal-100">Kelola dan monitor semua sesi program Insentif Reviewer</p>
                    </div>
                    <div class="flex-shrink-0">
                                        ...
                                        <div class="flex items-start space-x-3">
                                            ...
                                            <div class="min-w-0 flex-1">
                                                ...
                                                <p class="text-xs lg:text-sm text-gray-500 mt-1">
                                                    Sesi Program Insentif Reviewer
                                                </p>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="6" class="text-center py-20">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <h3 class="font-bold text-xl text-gray-800 mb-2">Belum Ada Sesi Insentif Reviewer</h3>
