                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 text-white">
                    <div>
                        <h2 class="text-xl lg:text-2xl font-bold flex items-center">
                            <i class='bx bx-briefcase-alt mr-3 text-2xl'></i>
                            Daftar Pengajuan
                        </h2>
                    </div>
                    <div class="flex items-center gap-3">
                        <a href="{{ route('admin_equity.employer-meetings.export') }}" class="inline-flex items-center px-4 py-2.5 bg-white text-teal-600 font-semibold rounded-xl hover:bg-teal-50 transition-all shadow-lg">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-5 text-center">
                                    <div class="flex items-center justify-center space-x-2">
                                        <a href="{{ route('admin_equity.employer-meetings.show', $submission->id) }}" class="p-2 text-teal-600 bg-teal-100 rounded-lg hover:bg-teal-200 transition-colors" title="Lihat Detail">
