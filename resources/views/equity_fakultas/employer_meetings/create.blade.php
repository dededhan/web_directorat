...
@section('content')
<h3 class="text-3xl font-medium text-gray-700">Form Pengajuan: Employer Meeting</h3>

<div class="mt-8">
    <div class="p-6 bg-white rounded-lg shadow-md">
        {{-- Ganti route ke joint-supervision.store --}}
        <form action="{{ route('equity_fakultas.employer-meetings.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
