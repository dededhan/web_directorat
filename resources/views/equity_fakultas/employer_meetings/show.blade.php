...
<div class="mb-6">
    <div class="flex justify-between items-center">
        <h3 class="text-3xl font-medium text-gray-700">Detail Proposal: Employer Meeting</h3>
        <a href="{{ route('equity_fakultas.employer-meetings.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white font-bold rounded-lg shadow-md transition-colors duration-200">
...
<div class="bg-white rounded-lg shadow-md overflow-hidden">
    <div class="p-6">
        ...
        <div class="mb-6 pb-6 border-b border-gray-200">
            ...
            <div class="mb-4">
                <p class="text-sm text-gray-600 mb-2">Data QS (Excel)</p>
                <div class="flex items-center gap-3">
                    <i class='bx bx-spreadsheet text-3xl text-green-600'></i>
                    <div>
                        <p class="text-base font-medium text-gray-900">{{ basename($submission->nama_qs_path) }}</p>
