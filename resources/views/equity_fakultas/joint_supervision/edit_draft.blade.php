...
@section('content')
<h3 class="text-3xl font-medium text-gray-700">Edit Proposal: Joint Supervision</h3>

<div class="mt-8">
    <div class="p-6 bg-white rounded-lg shadow-md">
        <form action="{{ route('equity_fakultas.joint-supervision.update-draft', $submission->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
