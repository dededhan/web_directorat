...
<div class="mb-6">
    <div class="flex justify-between items-center">
        <h3 class="text-3xl font-medium text-gray-700">Detail Proposal: Visiting Top Professor</h3>
        <a href="{{ route('equity_fakultas.visiting-professors.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white font-bold rounded-lg shadow-md transition-colors duration-200">
