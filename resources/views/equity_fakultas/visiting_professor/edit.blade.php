...
@section('content')
<h3 class="text-3xl font-medium text-gray-700">Lengkapi Data: Visiting Top Professor</h3>

<div class="mt-8">
    <div class="p-6 bg-white rounded-lg shadow-md">
        <form action="{{ route('equity_fakultas.visiting-professors.update', $submission->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
