...
class AdminRespondenController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->filled('sumber_data') && in_array($user->role, ['admin_direktorat', 'admin_pemeringkatan'])) {
            $dataSource = $request->sumber_data;
