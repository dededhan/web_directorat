...
class KatsinovController extends Controller
{
    ...
    public function showPrivacyPage(Katsinov $katsinov)
    {
        // Kita hanya perlu mengirimkan objek $katsinov ke view
        // agar kita tahu ID-nya untuk tautan selanjutnya.
        return view('admin.katsinov.privacy', compact('katsinov'));
    }
}
